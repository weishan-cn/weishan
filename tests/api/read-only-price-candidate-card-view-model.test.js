...
function main() {
  ...
  const publicBetaTrialOperationsConsoleSummary = { status:"ready", userFacingSummary:{ title:"Public Beta Trial Operations Console", resultLabel:"Public Beta Trial Operations Console 已准备", redacted:true }, redacted:true };
  const manualQaScenarioRunnerSummary = { status:"ready", userFacingSummary:{ title:"Manual QA Scenario Runner", resultLabel:"Manual QA Scenario Runner 已准备", redacted:true }, redacted:true };
  const offlineFeedbackReviewBoardSummary = { status:"ready", userFacingSummary:{ title:"Offline Feedback Review Board", resultLabel:"Offline Feedback Review Board 已准备", redacted:true }, redacted:true };
  const publicBetaTrialOperationsViewModelSummary = { status:"ready", title:"Public Beta Trial Operations Console", userFacingSummary:{ title:"Public Beta Trial Operations View Model", resultLabel:"Public Beta Trial Operations View Model 已准备", redacted:true }, safeToProceedWithManualTrialOperationsReview:true, redacted:true };
  const publicBetaFreezeEvidenceSummary = { status:"ready", userFacingSummary:{ title:"Public Beta Freeze Evidence Summary", resultLabel:"Public Beta Freeze Evidence Summary 已准备", redacted:true }, redacted:true };
  const manualTrialIssueReviewBoardSummary = { status:"ready", userFacingSummary:{ title:"Manual Trial Issue Review Board", resultLabel:"Manual Trial Issue Review Board 已准备", redacted:true }, redacted:true };
  const offlineAcceptanceSnapshotSummary = { status:"needs_review", userFacingSummary:{ title:"Offline Acceptance Snapshot", resultLabel:"Offline Acceptance Snapshot 仍需复核", redacted:true }, redacted:true };
  const publicBetaAcceptanceSnapshotViewModelSummary = { status:"needs_review", title:"Public Beta Acceptance Snapshot View Model", userFacingSummary:{ title:"Public Beta Acceptance Snapshot View Model", resultLabel:"Public Beta Acceptance Snapshot View Model 仍需复核", redacted:true }, safeToProceedWithManualAcceptanceSnapshotReview:false, redacted:true };
  const publicBetaAcceptanceReviewConsoleSummary = { status:"manual_review_required", acceptanceReviewStatus:"manual_review_required", userFacingSummary:{ title:"Public Beta Acceptance Review Console", resultLabel:"Public Beta Acceptance Review Console 需人工复核", redacted:true }, redacted:true };
  const offlineTrialClosureBoardSummary = { status:"manual_review_required", closureStatus:"manual_review_required", userFacingSummary:{ title:"Offline Trial Closure Board", resultLabel:"Offline Trial Closure Board 需人工复核", redacted:true }, redacted:true };
  const noLaunchAssuranceGateSummary = { status:"ready", userFacingSummary:{ title:"No-Launch Assurance Gate", resultLabel:"No-Launch Assurance Gate 已准备", redacted:true }, redacted:true };
  const publicBetaClosureReviewViewModelSummary = { status:"ready", title:"Public Beta Closure Review View Model", userFacingSummary:{ title:"Public Beta Closure Review View Model", resultLabel:"Public Beta Acceptance Review Console / Offline Trial Closure Board / No-Launch Assurance Gate 已准备", redacted:true }, safeToProceedWithManualClosureReview:true, redacted:true };
  const publicBetaOfflineAcceptanceEvidenceCenterSummary = { status:"manual_review_required", userFacingSummary:{ title:"Public Beta Offline Acceptance Evidence Center", resultLabel:"Public Beta Offline Acceptance Evidence Center 需人工复核", redacted:true }, redacted:true };
  const manualScenarioReviewBoardSummary = { status:"manual_review_required", userFacingSummary:{ title:"Manual Scenario Review Board", resultLabel:"Manual Scenario Review Board 需人工复核", redacted:true }, redacted:true };
  const zeroPersistenceRegressionGateSummary = { status:"manual_review_required", userFacingSummary:{ title:"Zero-Persistence Regression Gate", resultLabel:"Zero-Persistence Regression Gate 需人工复核", redacted:true }, redacted:true };
  const publicBetaOfflineAcceptanceViewModelSummary = { status:"needs_review", title:"Public Beta Offline Acceptance ViewModel", userFacingSummary:{ title:"Public Beta Offline Acceptance ViewModel", resultLabel:"Public Beta Offline Acceptance ViewModel 仍需复核", redacted:true }, safeToProceedWithManualOfflineAcceptanceReview:false, redacted:true };
  const publicBetaFinalAcceptanceLockSummary = { status:"manual_review_required", userFacingSummary:{ title:"Public Beta Final Acceptance Lock", resultLabel:"Public Beta Final Acceptance Lock 需人工复核", redacted:true }, redacted:true };
  const offlineReleaseCandidateAuditSummary = { status:"manual_review_required", userFacingSummary:{ title:"Offline Release Candidate Audit", resultLabel:"Offline Release Candidate Audit 需人工复核", redacted:true }, redacted:true };
  const zeroActionSafetyConsoleSummary = { status:"manual_review_required", userFacingSummary:{ title:"Zero-Action Safety Console", resultLabel:"Zero-Action Safety Console 需人工复核", redacted:true }, redacted:true };
  const publicBetaFinalAcceptanceViewModelSummary = { status:"needs_review", title:"Public Beta Final Acceptance ViewModel", userFacingSummary:{ title:"Public Beta Final Acceptance ViewModel", resultLabel:"Public Beta Final Acceptance ViewModel 仍需复核", redacted:true }, safeToProceedWithManualFinalAcceptanceReview:false, redacted:true };
  const publicBetaFinalReadinessCommandCenterSummary = { status:"manual_review_required", finalReadinessStatus:"manual_review_required", userFacingSummary:{ title:"Public Beta Final Readiness Command Center", resultLabel:"Public Beta Final Readiness Command Center 需人工复核", redacted:true }, redacted:true };
  const offlineLaunchBlockerMatrixSummary = { status:"blocked", blockerMatrixStatus:"blocked", userFacingSummary:{ title:"Offline Launch Blocker Matrix", resultLabel:"Offline Launch Blocker Matrix 已保持阻断", redacted:true }, redacted:true };
  const manualNextPhaseDossierSummary = { status:"manual_review_required", dossierStatus:"manual_review_required", userFacingSummary:{ title:"Manual Next-Phase Dossier", resultLabel:"Manual Next-Phase Dossier 需人工复核", redacted:true }, redacted:true };
  const publicBetaFinalReadinessViewModelSummary = { status:"ready", title:"Public Beta Final Readiness ViewModel", userFacingSummary:{ title:"Public Beta Final Readiness ViewModel", resultLabel:"Public Beta Final Readiness Command Center / Offline Launch Blocker Matrix / Manual Next-Phase Dossier 已准备", redacted:true }, safeToProceedWithManualFinalReadinessReview:true, redacted:true };
  const publicBetaCandidateLockSummary = { status:"manual_review_required", candidateLockStatus:"manual_review_required", userFacingSummary:{ title:"Public Beta Candidate Lock", resultLabel:"Public Beta Candidate Lock 需人工复核", redacted:true }, redacted:true };
  const finalTrialHandoffConsoleSummary = { status:"manual_review_required", handoffStatus:"manual_review_required", userFacingSummary:{ title:"Final Trial Handoff Console", resultLabel:"Final Trial Handoff Console 需人工复核", redacted:true }, redacted:true };
  const noProviderProductionBoundarySummary = { status:"manual_review_required", boundaryStatus:"manual_review_required", userFacingSummary:{ title:"No-Provider Production Boundary", resultLabel:"No-Provider Production Boundary 需人工复核", redacted:true }, redacted:true };
  const publicBetaCandidateViewModelSummary = { status:"ready", title:"Public Beta Candidate ViewModel", userFacingSummary:{ title:"Public Beta Candidate ViewModel", resultLabel:"Public Beta Candidate Lock / Final Trial Handoff Console / No-Provider Production Boundary 已准备", redacted:true }, safeToProceedWithManualCandidateReview:true, redacted:true };
  const publicBetaCandidateEvidenceReviewSummary = { status:"manual_review_required", evidenceReviewStatus:"manual_review_required", userFacingSummary:{ title:"Public Beta Candidate Evidence Review", resultLabel:"Public Beta Candidate Evidence Review 需人工复核", redacted:true }, redacted:true };
  const trialOperatorNotesPanelSummary = { status:"manual_review_required", notesStatus:"manual_review_required", userFacingSummary:{ title:"Trial Operator Notes Panel", resultLabel:"Trial Operator Notes Panel 需人工复核", redacted:true }, redacted:true };
  const offlineSafetyDeltaBoardSummary = { status:"manual_review_required", deltaStatus:"manual_review_required", userFacingSummary:{ title:"Offline Safety Delta Board", resultLabel:"Offline Safety Delta Board 需人工复核", redacted:true }, redacted:true };
  const publicBetaCandidateReviewViewModelSummary = { status:"ready", title:"Public Beta Candidate Review ViewModel", userFacingSummary:{ title:"Public Beta Candidate Review ViewModel", resultLabel:"Public Beta Candidate Evidence Review / Trial Operator Notes Panel / Offline Safety Delta Board 已准备", redacted:true }, safeToProceedWithManualCandidateEvidenceReview:true, redacted:true };
  const publicBetaCandidateQaFreezeSummary = { status:"manual_review_required", qaFreezeStatus:"manual_review_required", userFacingSummary:{ title:"Public Beta Candidate QA Freeze", resultLabel:"Public Beta Candidate QA Freeze 需人工复核", redacted:true }, redacted:true };
  const trialFeedbackIntakeMockSummary = { status:"manual_review_required", intakeStatus:"manual_review_required", userFacingSummary:{ title:"Trial Feedback Intake Mock", resultLabel:"Trial Feedback Intake Mock 需人工复核", redacted:true }, redacted:true };
  const offlineRegressionEvidenceBoardSummary = { status:"manual_review_required", regressionEvidenceStatus:"manual_review_required", userFacingSummary:{ title:"Offline Regression Evidence Board", resultLabel:"Offline Regression Evidence Board 需人工复核", redacted:true }, redacted:true };
  const publicBetaQaFreezeViewModelSummary = { status:"ready", title:"Public Beta QA Freeze ViewModel", userFacingSummary:{ title:"Public Beta QA Freeze ViewModel", resultLabel:"Public Beta Candidate QA Freeze / Trial Feedback Intake Mock / Offline Regression Evidence Board 已准备", redacted:true }, safeToProceedWithManualQaFreezeReview:true, redacted:true };
  ...
  card.publicBetaReadinessSnapshotSummary = { status:"manual_review_required", userFacingSummary:{ title:"Public Beta Readiness Snapshot", resultLabel:"Public Beta Readiness Snapshot 需人工复核", redacted:true }, redacted:true };
  card.manualFeedbackReviewQueueMockSummary = { status:"manual_review_required", userFacingSummary:{ title:"Manual Feedback Review Queue Mock", resultLabel:"Manual Feedback Review Queue Mock 需人工复核", redacted:true }, redacted:true };
  card.offlineIssueTriageBoardSummary = { status:"manual_review_required", userFacingSummary:{ title:"Offline Issue Triage Board", resultLabel:"Offline Issue Triage Board 需人工复核", redacted:true }, redacted:true };
  card.publicBetaReadinessReviewViewModelSummary = { status:"ready", userFacingSummary:{ title:"Public Beta Readiness Review ViewModel", resultLabel:"Public Beta Readiness Snapshot / Manual Feedback Review Queue Mock / Offline Issue Triage Board 已准备", redacted:true }, safeToProceedWithManualReadinessReview:true, redacted:true };
  card.publicBetaReadinessSnapshotStatus = "manual_review_required";
  card.manualFeedbackReviewQueueStatus = "manual_review_required";
  card.offlineIssueTriageStatus = "manual_review_required";
  card.publicBetaReadinessReviewViewModelStatus = "ready";
  card.safeToProceedWithManualReadinessReview = true;
  ...
  assert.equal(renderedCardHtml.includes("Public Beta Stability Audit"), true);
  assert.equal(renderedCardHtml.includes("Manual Launch Handoff Pack"), true);
  assert.equal(renderedCardHtml.includes("Public Beta Trial Operations Console"), true);
  assert.equal(renderedCardHtml.includes("Manual QA Scenario Runner"), true);
  assert.equal(renderedCardHtml.includes("Offline Feedback Review Board"), true);
  assert.equal(renderedCardHtml.includes("Public Beta Freeze Evidence Summary"), true);
  assert.equal(renderedCardHtml.includes("Manual Trial Issue Review Board"), true);
  assert.equal(renderedCardHtml.includes("Offline Acceptance Snapshot"), true);
  assert.equal(renderedCardHtml.includes("Freeze Evidence"), true);
  assert.equal(renderedCardHtml.includes("Issue Review"), true);
  assert.equal(renderedCardHtml.includes("Acceptance Snapshot"), true);
  assert.equal(renderedCardHtml.includes("Flight / Hotel / Product / Restricted / Feedback / No-Transaction / No-Provider 场景已覆盖"), true);
  assert.equal(renderedCardHtml.includes("反馈仍保持关闭，不发送、不上传、不保存用户原文"), true);
  assert.equal(renderedCardHtml.includes("下一步只能人工复核或继续测试"), true);
  assert.equal(renderedCardHtml.includes("Manual Review Required"), true);
  assert.equal(renderedCardHtml.includes("冻结证据仅为只读摘要，不修改配置"), true);
  assert.equal(renderedCardHtml.includes("问题复核仅为离线视图，不创建真实 issue"), true);
  assert.equal(renderedCardHtml.includes("验收快照不写文件、不导出"), true);
  assert.equal(renderedCardHtml.includes("仍需人工复核后再决定下一阶段"), true);
  assert.equal(renderedCardHtml.includes("Public Beta Readiness Snapshot"), true);
  assert.equal(renderedCardHtml.includes("Manual Feedback Review Queue Mock"), true);
  assert.equal(renderedCardHtml.includes("Offline Issue Triage Board"), true);
  assert.equal(renderedCardHtml.includes("Readiness Snapshot"), true);
  assert.equal(renderedCardHtml.includes("Feedback Review Queue"), true);
  assert.equal(renderedCardHtml.includes("Issue Triage"), true);
  assert.equal(renderedCardHtml.includes("准备快照仅为只读展示，不生成文件"), true);
  assert.equal(renderedCardHtml.includes("反馈复核队列仅为 Mock，不保存、不上传、不创建 issue/task"), true);
  assert.equal(renderedCardHtml.includes("问题分级仅为离线展示，不创建真实任务"), true);
  assert.equal(renderedCardHtml.includes("publicBetaReadinessSnapshotStatus:manual_review_required"), true);
  assert.equal(renderedCardHtml.includes("manualFeedbackReviewQueueStatus:manual_review_required"), true);
  assert.equal(renderedCardHtml.includes("offlineIssueTriageStatus:manual_review_required"), true);
  assert.equal(renderedCardHtml.includes("publicBetaReadinessReviewViewModelStatus:ready"), true);
  assert.equal(renderedCardHtml.includes("safeToProceedWithManualReadinessReview:true"), true);
  assert.equal(renderedCardHtml.includes("feedbackSubmitEnabled:false"), true);
  assert.equal(renderedCardHtml.includes("uploadEnabled:false"), true);
  assert.equal(renderedCardHtml.includes("issueCreateEnabled:false"), true);
  assert.equal(renderedCardHtml.includes("taskCreateEnabled:false"), true);
  assert.equal(renderedCardHtml.includes("Public Beta Acceptance Review Console"), true);
  assert.equal(renderedCardHtml.includes("Offline Trial Closure Board"), true);
  assert.equal(renderedCardHtml.includes("No-Launch Assurance Gate"), true);
  assert.equal(renderedCardHtml.includes("Acceptance Review"), true);
  assert.equal(renderedCardHtml.includes("Trial Closure"), true);
  assert.equal(renderedCardHtml.includes("No Launch"), true);
  assert.equal(renderedCardHtml.includes("当前不发布、不创建 release、不 push"), true);
  assert.equal(renderedCardHtml.includes("试用闭环仅为离线视图，不关闭真实任务"), true);
  assert.equal(renderedCardHtml.includes("验收复核后仍需人工决定下一阶段"), true);
  assert.equal(renderedCardHtml.includes("仍不允许启用 provider、付款、下单或发布"), true);
  assert.equal(renderedCardHtml.includes("Public Beta Offline Acceptance Evidence Center"), true);
  assert.equal(renderedCardHtml.includes("Manual Scenario Review Board"), true);
  assert.equal(renderedCardHtml.includes("Zero-Persistence Regression Gate"), true);
  assert.equal(renderedCardHtml.includes("Offline Acceptance Evidence"), true);
  assert.equal(renderedCardHtml.includes("Scenario Review"), true);
  assert.equal(renderedCardHtml.includes("Zero Persistence"), true);
  assert.equal(renderedCardHtml.includes("离线验收证据中心仅为只读展示，不生成证据文件"), true);
  assert.equal(renderedCardHtml.includes("人工场景复核板仅为样例复核，不保存场景输入或复核结果"), true);
  assert.equal(renderedCardHtml.includes("零持久化回归门确认不保存反馈、用户原文、场景输入、验收记录或证据文件"), true);
  assert.equal(renderedCardHtml.includes("safeToProceedWithManualOfflineAcceptanceReview:false"), true);
  assert.equal(renderedCardHtml.includes("Public Beta Final Acceptance Lock"), true);
  assert.equal(renderedCardHtml.includes("Offline Release Candidate Audit"), true);
  assert.equal(renderedCardHtml.includes("Zero-Action Safety Console"), true);
  assert.equal(renderedCardHtml.includes("最终人工验收锁定仅为只读展示，不保存验收记录"), true);
  assert.equal(renderedCardHtml.includes("离线 RC 审计不创建 release、不生成审计文件"), true);
  assert.equal(renderedCardHtml.includes("零动作安全控制台确认没有任何真实动作执行入口"), true);
  assert.equal(renderedCardHtml.includes("safeToProceedWithManualFinalAcceptanceReview:false"), true);
  assert.equal(renderedCardHtml.includes("Public Beta Closure Evidence Archive"), true);
  assert.equal(renderedCardHtml.includes("Manual Trial Exit Criteria"), true);
  assert.equal(renderedCardHtml.includes("Offline Next-Step Planning Board"), true);
  assert.equal(renderedCardHtml.includes("Closure Evidence"), true);
  assert.equal(renderedCardHtml.includes("Exit Criteria"), true);
  assert.equal(renderedCardHtml.includes("Next-Step Planning"), true);
  assert.equal(renderedCardHtml.includes("闭环证据仅为只读归档视图，不写文件"), true);
  assert.equal(renderedCardHtml.includes("退出标准不自动通过，不创建 release"), true);
  assert.equal(renderedCardHtml.includes("下一步只能继续测试、优化文案、扩展离线场景、人工复核或阻断"), true);
  assert.equal(renderedCardHtml.includes("Public Beta Final Readiness Command Center"), true);
  assert.equal(renderedCardHtml.includes("Offline Launch Blocker Matrix"), true);
  assert.equal(renderedCardHtml.includes("Manual Next-Phase Dossier"), true);
  assert.equal(renderedCardHtml.includes("Public Beta Candidate Lock"), true);
  assert.equal(renderedCardHtml.includes("Final Trial Handoff Console"), true);
  assert.equal(renderedCardHtml.includes("No-Provider Production Boundary"), true);
  assert.equal(renderedCardHtml.includes("Final Readiness"), true);
  assert.equal(renderedCardHtml.includes("Launch Blockers"), true);
  assert.equal(renderedCardHtml.includes("Next-Phase Dossier"), true);
  assert.equal(renderedCardHtml.includes("Candidate Scope"), true);
  assert.equal(renderedCardHtml.includes("Trial Handoff"), true);
  assert.equal(renderedCardHtml.includes("Production Boundary"), true);
  assert.equal(renderedCardHtml.includes("当前仍是只读 Public Beta 候选"), true);
  assert.equal(renderedCardHtml.includes("发布、provider、联网、付款、下单、出票全部保持阻断"), true);
  assert.equal(renderedCardHtml.includes("不创建 release、不 push、不启用交易"), true);
  assert.equal(renderedCardHtml.includes("当前锁定的是只读 Public Beta 候选范围，不修改配置"), true);
  assert.equal(renderedCardHtml.includes("最终试用交接仅为只读摘要，不生成文件"), true);
  assert.equal(renderedCardHtml.includes("当前不是 production provider 版本"), true);
  assert.equal(renderedCardHtml.includes("provider、联网、外部打开、付款、下单、出票、release、push 全部保持关闭"), true);
  assert.equal(renderedCardHtml.includes("Public Beta Candidate Evidence Review"), true);
  assert.equal(renderedCardHtml.includes("Public Beta Candidate QA Freeze"), true);
  assert.equal(renderedCardHtml.includes("Trial Feedback Intake Mock"), true);
  assert.equal(renderedCardHtml.includes("Offline Regression Evidence Board"), true);
  assert.equal(renderedCardHtml.includes("QA Freeze"), true);
  assert.equal(renderedCardHtml.includes("Feedback Intake"), true);
  assert.equal(renderedCardHtml.includes("Regression Evidence"), true);
  assert.equal(renderedCardHtml.includes("QA 冻结仅为只读范围，不修改配置"), true);
  assert.equal(renderedCardHtml.includes("反馈入口仅为 Mock，不保存、不上传、不创建任务"), true);
  assert.equal(renderedCardHtml.includes("回归证据仅为只读展示，不生成文件"), true);
  assert.equal(renderedCardHtml.includes("provider、联网、外部打开、付款、下单、出票、release、push、launch、反馈提交、上传、issue/task 创建仍保持关闭"), true);
  assert.equal(renderedCardHtml.includes("Trial Operator Notes Panel"), true);
  assert.equal(renderedCardHtml.includes("Offline Safety Delta Board"), true);
  assert.equal(renderedCardHtml.includes("Candidate Evidence"), true);
  assert.equal(renderedCardHtml.includes("Operator Notes"), true);
  assert.equal(renderedCardHtml.includes("Safety Delta"), true);
  assert.equal(renderedCardHtml.includes("候选证据仅为只读复核，不写文件"), true);
  assert.equal(renderedCardHtml.includes("运营备注不保存、不上传、不创建任务"), true);
  assert.equal(renderedCardHtml.includes("安全边界未扩大"), true);
  assert.equal(renderedCardHtml.includes("provider、联网、外部打开、付款、下单、出票、release、push、launch 仍保持关闭"), true);
  assert.equal(card.safeToProceedWithManualAcceptanceSnapshotReview, false);
  assert.equal(card.safeToProceedWithManualClosureReview, true);
  assert.equal(card.safeToProceedWithManualFinalReadinessReview, true);
  assert.equal(card.safeToProceedWithManualCandidateReview, true);
  assert.equal(card.safeToProceedWithManualCandidateEvidenceReview, true);
  assert.equal(card.safeToProceedWithManualQaFreezeReview, true);
  assert.equal(card.safeToProceedWithManualOfflineAcceptanceReview, false);
  assert.equal(card.safeToProceedWithManualFinalAcceptanceReview, false);
