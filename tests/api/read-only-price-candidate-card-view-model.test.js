...
function main() {
  const windowRef = load([
    ...
    "apps/desktop/src/renderer/core/globalShoppingOfflineLaunchDecisionSimulator.js",
    "apps/desktop/src/renderer/core/globalShoppingSandboxActivationReceiptLedger.js",
    "apps/desktop/src/renderer/core/globalShoppingAdapterSecurityRegressionGuard.js",
    "apps/desktop/src/renderer/core/globalShoppingProviderOfflineLaunchChecklist.js",
    "apps/desktop/src/renderer/core/globalShoppingProviderOfflineLaunchViewModel.js",
    "apps/desktop/src/renderer/core/globalShoppingOfflineProviderLaunchControlTower.js",
    "apps/desktop/src/renderer/core/globalShoppingAdapterPolicyEngine.js",
    "apps/desktop/src/renderer/core/globalShoppingHumanReleaseEvidenceTimeline.js",
    "apps/desktop/src/renderer/core/globalShoppingSandboxActivationFinalReviewBoard.js",
    "apps/desktop/src/renderer/core/globalShoppingProviderLaunchControlViewModel.js",
    "apps/desktop/src/renderer/core/globalShoppingProviderLaunchAuditSnapshot.js",
    "apps/desktop/src/renderer/core/globalShoppingOfflinePolicyReplayCenter.js",
    "apps/desktop/src/renderer/core/globalShoppingHumanActivationFinalDossier.js",
    "apps/desktop/src/renderer/core/globalShoppingAdapterLaunchBoundaryVerifier.js",
    "apps/desktop/src/renderer/core/globalShoppingProviderFinalLaunchReviewViewModel.js",
    "apps/desktop/src/renderer/core/globalShoppingFinalOfflineLaunchReviewConsole.js",
    "apps/desktop/src/renderer/core/globalShoppingProviderActivationBlockerSentinel.js",
    "apps/desktop/src/renderer/core/globalShoppingReadOnlyReleaseEvidenceSummary.js",
    "apps/desktop/src/renderer/core/globalShoppingOfflineProviderReadinessDecisionMatrix.js",
    "apps/desktop/src/renderer/core/globalShoppingProviderFinalReviewConsoleViewModel.js",
    ...
    "apps/desktop/src/renderer/core/globalShoppingPublicBetaOperatorConsole.js",
    "apps/desktop/src/renderer/core/globalShoppingCategoryExpansionShell.js",
    "apps/desktop/src/renderer/core/globalShoppingFinalOfflineBetaAudit.js",
    "apps/desktop/src/renderer/core/globalShoppingPublicBetaAcceptanceBoard.js",
    "apps/desktop/src/renderer/core/globalShoppingPublicBetaOperatorViewModel.js",
  ...
  assert.equal(card.providerSandboxReadinessWorkbenchSummary.userFacingSummary.title, "Provider Sandbox Readiness Workbench");
  assert.equal(card.offlineProviderScenarioLabSummary.userFacingSummary.title, "Offline Provider Scenario Lab");
  assert.equal(card.readOnlyProviderAdapterSdkSkeletonSummary.userFacingSummary.title, "Read-Only Provider Adapter SDK Skeleton");
  assert.equal(card.manualActivationCommandCenterSummary.userFacingSummary.title, "Manual Activation Command Center");
  assert.equal(card.providerSandboxMilestoneViewModelSummary.title, "Provider Sandbox 里程碑工作台");
  assert.equal(card.offlineDistributionReadinessCenterSummary.userFacingSummary.title, "Offline Distribution Readiness Center");
  assert.equal(card.noActivationEnforcementLedgerSummary.userFacingSummary.title, "No-Activation Enforcement Ledger");
  assert.equal(card.finalUserTrustSummarySummary.userFacingSummary.title, "Final User Trust Summary");
  assert.equal(card.providerSafetyDistributionMatrixSummary.userFacingSummary.title, "Provider Safety Distribution Matrix");
  assert.equal(card.providerDistributionReadinessViewModelSummary.title, "Provider Distribution Readiness Review");
  assert.equal(typeof card.safeToProceedWithHumanDistributionReadinessReview, "boolean");
  assert.equal(card.offlineProviderCertificationCenterSummary.userFacingSummary.title, "Offline Provider Certification Center");
  assert.equal(card.mockIntegrationRegressionLabSummary.userFacingSummary.title, "Mock Integration Regression Lab");
  assert.equal(card.humanApprovalEvidenceBinderSummary.userFacingSummary.title, "Human Approval Evidence Binder");
  assert.equal(card.adapterBoundaryLockSummary.userFacingSummary.title, "Adapter Boundary Lock");
  assert.equal(card.providerCertificationViewModelSummary.title, "Provider 离线认证与边界锁");
  assert.equal(card.offlineLaunchDecisionSimulatorSummary.userFacingSummary.title, "Offline Launch Decision Simulator");
  assert.equal(card.sandboxActivationReceiptLedgerSummary.userFacingSummary.title, "Sandbox Activation Receipt Ledger");
  assert.equal(card.adapterSecurityRegressionGuardSummary.userFacingSummary.title, "Adapter Security Regression Guard");
  assert.equal(card.providerOfflineLaunchChecklistSummary.userFacingSummary.title, "Provider Offline Launch Checklist");
  assert.equal(card.providerOfflineLaunchViewModelSummary.title, "Provider 离线 Launch 决策与安全守卫");
  assert.equal(card.offlineLaunchDecisionSimulatorStatus, "ready");
  assert.equal(card.sandboxActivationReceiptLedgerStatus, "ready");
  assert.equal(card.adapterSecurityRegressionGuardStatus, "ready");
  assert.equal(card.providerOfflineLaunchChecklistStatus, "ready");
  assert.equal(card.providerOfflineLaunchViewModelStatus, "ready");
  assert.equal(card.safeToProceedWithManualOfflineLaunchDecisionReview, true);
  assert.equal(card.providerPublicTrustClosureCenterSummary.userFacingSummary.title, "Provider Public Trust Closure Center");
  assert.equal(card.offlineReleaseMemorySnapshotSummary.userFacingSummary.title, "Offline Release Memory Snapshot");
  assert.equal(card.noProviderExecutionFinalGuardSummary.userFacingSummary.title, "No-Provider-Execution Final Guard");
  assert.equal(card.userVisibleSafetyBoundaryExplainerSummary.userFacingSummary.title, "User-Visible Safety Boundary Explainer");
  assert.equal(card.providerTrustClosureViewModelSummary.title, "Provider Trust Closure Review");
  assert.equal(card.publicReleaseEvidenceConsoleSummary.userFacingSummary.title, "Public Release Evidence Console");
  assert.equal(card.noProviderUserAssurancePanelSummary.userFacingSummary.title, "No-Provider User Assurance Panel");
  assert.equal(card.offlineLaunchReadinessFinalizerSummary.userFacingSummary.title, "Offline Launch Readiness Finalizer");
  assert.equal(card.userSafePublicClaimVerifierSummary.userFacingSummary.title, "User-Safe Public Claim Verifier");
  assert.equal(card.providerLaunchReadinessFinalViewModelSummary.title, "Provider Launch Readiness Final Review");
  assert.equal(card.globalShoppingReadOnlyPublicBetaShellSummary.userFacingSummary.title, "Global Shopping Read-Only Public Beta Shell");
  assert.equal(card.providerZeroRuntimeLockSummary.userFacingSummary.title, "Provider-Zero Runtime Lock");
  assert.equal(card.globalShoppingProviderZeroStatusPanelSummary.userFacingSummary.title, "Provider-Zero Status Panel");
  assert.equal(card.userTrustLaunchBoardSummary.userFacingSummary.title, "User Trust Launch Board");
  assert.equal(card.publicBetaSafetyCopyCenterSummary.userFacingSummary.title, "Public Beta Safety Copy Center");
  assert.equal(card.globalShoppingPublicBetaUserFacingCopyPolishSummary.userFacingSummary.title, "全球购 Public Beta");
  assert.equal(card.globalShoppingPublicBetaViewModelSummary.title, "Global Shopping Public Beta Review");
  assert.equal(card.publicBetaUserJourneyShellSummary.userFacingSummary.title, "Public Beta User Journey");
  assert.equal(card.safeSearchIntentMatrixSummary.userFacingSummary.title, "Safe Search Intent Matrix");
  assert.equal(card.publicBetaUserBoundaryPanelSummary.userFacingSummary.title, "User Boundary Panel");
  assert.equal(card.publicBetaUserJourneyShellStatus, "ready");
  assert.equal(card.safeSearchIntentMatrixStatus, "ready");
  assert.equal(card.publicBetaUserBoundaryPanelStatus, "ready");
  assert.equal(card.categoryResultSimulatorSummary.userFacingSummary.title, "Category Result Simulator");
  assert.equal(card.readOnlyComparisonBoardSummary.userFacingSummary.title, "Read-Only Comparison Board");
  assert.equal(card.resultTrustBadgePanelSummary.userFacingSummary.title, "Result Trust Badge");
  assert.equal(card.categoryResultSimulatorStatus, "ready");
  assert.equal(card.readOnlyComparisonBoardStatus, "needs_review");
  assert.equal(card.resultTrustBadgePanelStatus, "needs_review");
  assert.equal(card.safeToProceedWithManualComparisonReview, false);
  assert.equal(card.providerPublicTrustClosureCenterStatus, "ready");
  assert.equal(card.offlineReleaseMemorySnapshotStatus, "ready");
  assert.equal(card.noProviderExecutionFinalGuardStatus, "ready");
  assert.equal(card.userVisibleSafetyBoundaryExplainerStatus, "ready");
  assert.equal(card.providerTrustClosureViewModelStatus, "ready");
  assert.equal(card.safeToProceedWithHumanTrustClosureReview, true);
  assert.equal(card.publicReleaseEvidenceConsoleStatus, "ready");
  assert.equal(card.noProviderUserAssurancePanelStatus, "ready");
  assert.equal(card.offlineLaunchReadinessFinalizerStatus, "ready");
  assert.equal(card.userSafePublicClaimVerifierStatus, "ready");
  assert.equal(card.providerLaunchReadinessFinalViewModelStatus, "ready");
  assert.equal(card.safeToProceedWithHumanLaunchReadinessFinalReview, true);
  assert.equal(card.globalShoppingReadOnlyPublicBetaShellStatus, "ready");
  assert.equal(card.providerZeroRuntimeLockStatus, "ready");
  assert.equal(card.userTrustLaunchBoardStatus, "ready");
  assert.equal(card.publicBetaSafetyCopyCenterStatus, "ready");
  assert.equal(card.globalShoppingPublicBetaViewModelStatus, "ready");
  assert.equal(card.publicBetaFinalGateStatus, "ready");
  assert.equal(card.releaseCandidateConfidenceBoardStatus, "ready");
  assert.equal(card.publicBetaFinalViewModelStatus, "ready");
  assert.equal(card.safeToProceedWithHumanPublicBetaReview, true);
  assert.equal(card.safeToProceedWithManualPublicBetaReview, true);
  const renderedCardHtml = api.renderReadOnlyPriceCandidateCardHtml(card);
  assert.ok(renderedCardHtml.includes("Public Beta Final Gate"));
  assert.ok(renderedCardHtml.includes("RC Confidence Board"));
  assert.ok(renderedCardHtml.includes("Provider-Zero 已锁定"));
  assert.ok(renderedCardHtml.includes("Category Result Simulator"));
  assert.ok(renderedCardHtml.includes("Read-Only Comparison Board"));
  assert.ok(renderedCardHtml.includes("Result Trust Badge"));
  assert.equal(card.offlineProviderLaunchControlTowerSummary.userFacingSummary.title, "Offline Provider Launch Control Tower");
  assert.equal(card.adapterPolicyEngineSummary.userFacingSummary.title, "Adapter Policy Engine");
  assert.equal(card.humanReleaseEvidenceTimelineSummary.userFacingSummary.title, "Human Release Evidence Timeline");
  assert.equal(card.sandboxActivationFinalReviewBoardSummary.userFacingSummary.title, "Sandbox Activation Final Review Board");
  assert.equal(card.providerLaunchControlViewModelSummary.title, "Provider Launch Control Tower");
  assert.equal(card.offlineProviderLaunchControlTowerStatus, "ready");
  assert.equal(card.adapterPolicyEngineStatus, "ready");
  assert.equal(card.humanReleaseEvidenceTimelineStatus, "ready");
  assert.equal(card.sandboxActivationFinalReviewBoardStatus, "ready");
  assert.equal(card.providerLaunchControlViewModelStatus, "ready");
  assert.equal(card.safeToProceedWithHumanLaunchControlReview, true);
  assert.equal(card.providerLaunchAuditSnapshotSummary.userFacingSummary.title, "Provider Launch Audit Snapshot");
  assert.equal(card.offlinePolicyReplayCenterSummary.userFacingSummary.title, "Offline Policy Replay Center");
  assert.equal(card.humanActivationFinalDossierSummary.userFacingSummary.title, "Human Activation Final Dossier");
  assert.equal(card.adapterLaunchBoundaryVerifierSummary.userFacingSummary.title, "Adapter Launch Boundary Verifier");
  assert.equal(card.providerFinalLaunchReviewViewModelSummary.title, "Provider Final Launch Review");
  assert.equal(card.finalOfflineLaunchReviewConsoleSummary.userFacingSummary.title, "Final Offline Launch Review Console");
  assert.equal(card.providerActivationBlockerSentinelSummary.userFacingSummary.title, "Provider Activation Blocker Sentinel");
  assert.equal(card.readOnlyReleaseEvidenceSummary.userFacingSummary.title, "Read-Only Release Evidence Summary");
  assert.equal(card.offlineProviderReadinessDecisionMatrixSummary.userFacingSummary.title, "Offline Provider Readiness Decision Matrix");
  assert.equal(card.providerFinalReviewConsoleViewModelSummary.title, "Provider Final Review Console");
  assert.equal(card.offlineProviderGovernanceClosureBoardSummary.userFacingSummary.title, "Offline Provider Governance Closure Board");
  assert.equal(card.noActivationComplianceSealSummary.userFacingSummary.title, "No-Activation Compliance Seal");
  assert.equal(card.finalReadinessHandoffSimulatorSummary.userFacingSummary.title, "Final Readiness Handoff Simulator");
  assert.equal(card.providerGovernanceClosureEvidenceLedgerSummary.userFacingSummary.title, "Provider Governance Closure Evidence Ledger");
  assert.equal(card.providerGovernanceClosureViewModelSummary.title, "Provider Governance Closure Review");
  assert.equal(card.providerLaunchAuditSnapshotStatus, "ready");
  assert.equal(card.offlinePolicyReplayCenterStatus, "needs_review");
  assert.equal(card.humanActivationFinalDossierStatus, "needs_review");
  assert.equal(card.adapterLaunchBoundaryVerifierStatus, "needs_review");
  assert.equal(card.providerFinalLaunchReviewViewModelStatus, "needs_review");
  assert.equal(card.finalOfflineLaunchReviewConsoleStatus, "needs_review");
  assert.equal(card.providerActivationBlockerSentinelStatus, "needs_review");
  assert.equal(card.readOnlyReleaseEvidenceSummaryStatus, "needs_review");
  assert.equal(card.offlineProviderReadinessDecisionMatrixStatus, "needs_review");
  assert.equal(card.providerFinalReviewConsoleViewModelStatus, "needs_review");
  assert.equal(card.offlineProviderGovernanceClosureBoardStatus, "needs_review");
  assert.equal(card.noActivationComplianceSealStatus, "blocked");
  assert.equal(card.finalReadinessHandoffSimulatorStatus, "blocked");
  assert.equal(card.providerGovernanceClosureEvidenceLedgerStatus, "blocked");
  assert.equal(card.providerGovernanceClosureViewModelStatus, "blocked");
  assert.equal(card.safeToProceedWithHumanFinalLaunchReview, false);
  assert.equal(card.safeToProceedWithFinalOfflineProviderReview, false);
  assert.equal(card.safeToProceedWithHumanGovernanceClosureReview, false);
  ...
  assert.equal(card.safeToProceedWithHumanCertificationReview, true);
  ...
  assert.equal(html.includes("Provider Sandbox 里程碑工作台"), true);
  assert.equal(html.includes("Provider 离线认证与边界锁"), true);
  assert.equal(html.includes("Provider Final Launch Review"), true);
  assert.equal(html.includes("Provider Launch Audit Snapshot"), true);
  assert.equal(html.includes("Offline Policy Replay Center"), true);
  assert.equal(html.includes("Human Activation Final Dossier"), true);
  assert.equal(html.includes("Adapter Launch Boundary Verifier"), true);
  assert.equal(html.includes("Launch Audit"), true);
  assert.equal(html.includes("Policy Replay"), true);
  assert.equal(html.includes("Final Dossier"), true);
  assert.equal(html.includes("Boundary Verifier"), true);
  assert.equal(html.includes("Launch Audit 不写文件、不保存真实决策"), true);
  assert.equal(html.includes("Policy Replay 不修改配置、不启用 provider"), true);
  assert.equal(html.includes("Final Dossier 不持久化档案"), true);
  assert.equal(html.includes("Boundary Verifier 不生成 endpoint、不读取密钥"), true);
  assert.equal(html.includes("Human final launch review 仍需人工复核"), true);
  assert.equal(html.includes("当前只展示 provider final launch review"), true);
  assert.equal(html.includes("Provider Final Review Console"), true);
  assert.equal(html.includes("Final Offline Launch Review Console"), true);
  assert.equal(html.includes("Provider Activation Blocker Sentinel"), true);
  assert.equal(html.includes("Read-Only Release Evidence Summary"), true);
  assert.equal(html.includes("Offline Provider Readiness Decision Matrix"), true);
  assert.equal(html.includes("Final Review 不保存真实决策"), true);
  assert.equal(html.includes("Activation Blocker 不修改配置、不启用 provider"), true);
  assert.equal(html.includes("Evidence Summary 不写文件、不上传"), true);
  assert.equal(html.includes("Decision Matrix 不创建 release、不 push"), true);
  assert.equal(html.includes("Final offline provider review 仍需人工复核"), true);
  assert.equal(html.includes("当前只展示 provider final review console"), true);
  assert.equal(html.includes("Provider Launch Readiness Final Review"), true);
  assert.equal(html.includes("Public Release Evidence Console"), true);
  assert.equal(html.includes("No-Provider User Assurance Panel"), true);
  assert.equal(html.includes("Offline Launch Readiness Finalizer"), true);
  assert.equal(html.includes("User-Safe Public Claim Verifier"), true);
  assert.equal(html.includes("Release Evidence 不生成真实证据文件"), true);
  assert.equal(html.includes("User Assurance 不生成真实用户保证书"), true);
  assert.equal(html.includes("Launch Finalizer 不执行真实 launch"), true);
  assert.equal(html.includes("Claim Verifier 不承诺最低价、最终价或官方背书"), true);
  assert.equal(html.includes("Human launch readiness final review 仍需人工复核"), true);
  assert.equal(html.includes("当前只展示 provider launch readiness final review"), true);
  assert.equal(html.includes("全球购 Public Beta"), true);
  assert.equal(html.includes("Global Shopping Public Beta Review"), true);
  assert.equal(html.includes("Global Shopping Read-Only Public Beta Shell"), true);
  assert.equal(html.includes("Provider-Zero Runtime Lock"), true);
  assert.equal(html.includes("Provider-Zero Status Panel"), true);
  assert.equal(html.includes("User Trust Launch Board"), true);
  assert.equal(html.includes("Public Beta Safety Copy Center"), true);
  assert.equal(html.includes("只读候选价"), true);
  assert.equal(html.includes("官方价锚点"), true);
  assert.equal(html.includes("费用归一化"), true);
  assert.equal(html.includes("Provider-Zero：未接入真实供应商"), true);
  assert.equal(html.includes("未读取密钥"), true);
  assert.equal(html.includes("未联网调用"), true);
  assert.equal(html.includes("未生成订单"), true);
  assert.equal(html.includes("请在对应平台自行确认价格并完成下单"), true);
  assert.equal(html.includes("平台实时页面为准"), true);
  assert.equal(html.includes("当前不提供付款、下单或出票能力"), true);
  assert.equal(html.includes("Human public beta review 仍需人工复核"), true);
  assert.equal(html.includes("当前只展示全球购 Public Beta"), true);
  assert.equal(html.includes("Offline Provider Certification Center"), true);
  assert.equal(html.includes("Mock Integration Regression Lab"), true);
  assert.equal(html.includes("Human Approval Evidence Binder"), true);
  assert.equal(html.includes("Adapter Boundary Lock"), true);
  assert.equal(html.includes("Certification Center 不生成真实认证文件"), true);
  assert.equal(html.includes("Regression Lab 不运行真实 provider"), true);
  assert.equal(html.includes("Evidence Binder 不写文件、不上传"), true);
  assert.equal(html.includes("Boundary Lock 不修改配置、不启用 provider"), true);
  assert.equal(html.includes("Human certification review 仍需人工复核"), true);
  assert.equal(html.includes("当前只展示 provider 离线认证与边界锁"), true);
  assert.equal(html.includes("Provider Sandbox Readiness Workbench"), true);
  assert.equal(html.includes("Offline Provider Scenario Lab"), true);
  assert.equal(html.includes("Read-Only Provider Adapter SDK Skeleton"), true);
  assert.equal(html.includes("Manual Activation Command Center"), true);
  assert.equal(html.includes("Readiness Workbench 不激活 sandbox"), true);
  assert.equal(html.includes("Offline Scenario Lab 不联网、不读密钥"), true);
  assert.equal(html.includes("Adapter SDK Skeleton 不生成 endpoint、不导入真实 SDK"), true);
  assert.equal(html.includes("Command Center 不创建 release、不 push"), true);
  assert.equal(html.includes("当前只展示 provider sandbox 里程碑工作台"), true);
