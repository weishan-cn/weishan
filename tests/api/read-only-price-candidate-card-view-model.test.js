...
function main() {
  ...
  assert.equal(api.READ_ONLY_PRICE_CANDIDATE_CARD_VIEW_MODEL_VERSION, "2.1.66");
  ...
  assert.equal(card.sessionSummary.sessionId, "deterministic-read-only-quote-session-v2.1.66");
