...
function main() {
  ...
  assert.equal(api.READ_ONLY_QUOTE_SESSION_MANAGER_VERSION, "2.1.56");
  ...
  assert.equal(session.appVersion, "2.1.56");
  assert.equal(session.sessionId, "deterministic-read-only-quote-session-v2.1.56");
