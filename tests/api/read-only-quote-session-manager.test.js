...
function main() {
  ...
  assert.equal(api.READ_ONLY_QUOTE_SESSION_MANAGER_VERSION, "2.2.4");
  ...
  assert.equal(session.appVersion, "2.2.4");
  assert.equal(session.sessionId, "deterministic-read-only-quote-session-v2.2.4");
