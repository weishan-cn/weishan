...
function main() {
  ...
  assert.equal(api.READ_ONLY_QUOTE_SESSION_MANAGER_VERSION, "2.4.1");
  ...
  assert.equal(session.appVersion, "2.4.1");
  assert.equal(session.sessionId, "deterministic-read-only-quote-session-v2.4.1");
