...
function main() {
  ...
  assert.equal(api.READ_ONLY_QUOTE_SESSION_MANAGER_VERSION, "4.0.9");
  ...
  assert.equal(session.appVersion, "4.0.9");
  assert.equal(session.sessionId, "deterministic-read-only-quote-session-v2.5.0");
