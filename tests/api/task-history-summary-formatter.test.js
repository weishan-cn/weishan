...
function main(){
  ...
  assert.equal(api.TASK_HISTORY_SUMMARY_FORMATTER_VERSION, "2.1.88");
  const longPrompt = "任务：v2.1.88 · User Surface Final Cleanup " + "不要显示完整开发指令 ".repeat(20) + "```raw JSON``` token endpoint";
