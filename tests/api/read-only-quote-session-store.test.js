...
function main() {
  ...
  assert.equal(api.READ_ONLY_QUOTE_SESSION_STORE_VERSION, "2.1.91");
  const mem = storage();
  ...
  assert.equal(loaded.sessionSummary.sessionId, "deterministic-read-only-quote-session-v2.1.91");
