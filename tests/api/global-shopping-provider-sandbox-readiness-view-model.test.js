...
function main() {
  ...
  assert.equal(api.GLOBAL_SHOPPING_PROVIDER_SANDBOX_READINESS_VIEW_MODEL_VERSION, "2.1.96");
  ...
  assert.equal(/bookingUrl|paymentUrl|orderUrl|checkoutUrl|token|secret/i.test(safeJson), false);
