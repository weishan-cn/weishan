...
assert.deepEqual(Array.from(search.routeMerchantNativeSource({ inputSummary:"荷兰可口可乐" }).eligibleSourceIds), ["prijsprofeet_public_api", "cc_asian_market_public_api", "dutchshopper_public_api"]);
assert.deepEqual(Array.from(search.routeMerchantNativeSource({ query:"Coca-Cola", inputSummary:"荷兰可口可乐" }).eligibleSourceIds), ["prijsprofeet_public_api", "cc_asian_market_public_api", "dutchshopper_public_api"]);
...
assert.equal(search.merchantNativeSourceQuery({ query:"荷兰可口可乐" }, "prijsprofeet_public_api"), "可口可乐");
assert.equal(search.merchantNativeSourceQuery({ query:"荷兰可口可乐 Zero" }, "prijsprofeet_public_api"), "可口可乐 Zero");
