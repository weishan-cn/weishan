...
function main() {
  ...
  assert.equal(api.REAL_FLIGHT_PRICE_READ_ONLY_PROVIDER_CONTRACT_VERSION, "2.1.51");
  ...
  assert.equal(contract.appVersion, "2.1.51");
  ...
  assert.equal(audit.appVersion, "2.1.51");
