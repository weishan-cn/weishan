...
function main() {
  ...
  assert.equal(api.MULTI_PROVIDER_SANDBOX_DRY_RUN_ORCHESTRATOR_VERSION, "2.1.74");
  ...
  assert.equal(result.appVersion, "2.1.74");
  ...
  assert.equal(result.sessionSummary.sessionId, "deterministic-read-only-quote-session-v2.1.74");
