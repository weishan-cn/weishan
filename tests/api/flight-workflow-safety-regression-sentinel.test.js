...
function main() {
  ...
  assert.equal(api.FLIGHT_WORKFLOW_SAFETY_REGRESSION_SENTINEL_VERSION, "3.9.0");
  ...
  const finalLaunchReview = api.buildFlightWorkflowSafetyRegressionReport({
    providerLaunchAuditSnapshotSummary:{ status:"ready", safety:{ bookingUrl:null, payment:false, order:false, ticketing:false, rawUserTextStored:false, rawResponseStored:false, secretStored:false, fileWrite:false, download:false } },
    offlinePolicyReplayCenterSummary:{ status:"ready", safety:{ bookingUrl:null, payment:false, order:false, ticketing:false, rawUserTextStored:false, rawResponseStored:false, secretStored:false, fileWrite:false, download:false } },
    humanActivationFinalDossierSummary:{ status:"ready", safety:{ bookingUrl:null, payment:false, order:false, ticketing:false, rawUserTextStored:false, rawResponseStored:false, secretStored:false, fileWrite:false, download:false } },
    adapterLaunchBoundaryVerifierSummary:{ status:"ready", safety:{ bookingUrl:null, payment:false, order:false, ticketing:false, rawUserTextStored:false, rawResponseStored:false, secretStored:false, autoOpen:false } },
    providerFinalLaunchReviewViewModelSummary:{ status:"ready", bookingUrl:null, paymentUrl:null, orderUrl:null, autoOpen:false, fileWrite:false, download:false }
  });
  assert.equal(finalLaunchReview.status, "pass");
  assert.equal(finalLaunchReview.providerLaunchAuditSnapshotSummary.status, "ready");
  assert.equal(finalLaunchReview.offlinePolicyReplayCenterSummary.status, "ready");
  ...
  const governanceClosure = api.buildFlightWorkflowSafetyRegressionReport({
    offlineProviderGovernanceClosureBoardSummary:{ status:"ready", safety:{ bookingUrl:null, payment:false, order:false, ticketing:false, rawUserTextStored:false, rawResponseStored:false, secretStored:false, fileWrite:false, download:false } },
    noActivationComplianceSealSummary:{ status:"ready", safety:{ bookingUrl:null, payment:false, order:false, ticketing:false, rawUserTextStored:false, rawResponseStored:false, secretStored:false, fileWrite:false, download:false } },
    finalReadinessHandoffSimulatorSummary:{ status:"ready", safety:{ bookingUrl:null, payment:false, order:false, ticketing:false, rawUserTextStored:false, rawResponseStored:false, secretStored:false, fileWrite:false, download:false } },
    providerGovernanceClosureEvidenceLedgerSummary:{ status:"ready", safety:{ bookingUrl:null, payment:false, order:false, ticketing:false, rawUserTextStored:false, rawResponseStored:false, secretStored:false, fileWrite:false, download:false } },
    providerGovernanceClosureViewModelSummary:{ status:"ready", bookingUrl:null, paymentUrl:null, orderUrl:null, autoOpen:false, fileWrite:false, download:false }
  });
  assert.equal(governanceClosure.status, "pass");
  assert.equal(governanceClosure.offlineProviderGovernanceClosureBoardSummary.status, "ready");
  assert.equal(governanceClosure.noActivationComplianceSealSummary.status, "ready");
  ...
  const trustClosure = api.buildFlightWorkflowSafetyRegressionReport({
    providerPublicTrustClosureCenterSummary:{ status:"ready", safety:{ bookingUrl:null, payment:false, order:false, ticketing:false, rawUserTextStored:false, rawResponseStored:false, secretStored:false, fileWrite:false, download:false } },
    offlineReleaseMemorySnapshotSummary:{ status:"ready", safety:{ bookingUrl:null, payment:false, order:false, ticketing:false, rawUserTextStored:false, rawResponseStored:false, secretStored:false, fileWrite:false, download:false } },
    noProviderExecutionFinalGuardSummary:{ status:"ready", safety:{ bookingUrl:null, payment:false, order:false, ticketing:false, rawUserTextStored:false, rawResponseStored:false, secretStored:false, fileWrite:false, download:false } },
    userVisibleSafetyBoundaryExplainerSummary:{ status:"ready", safety:{ bookingUrl:null, payment:false, order:false, ticketing:false, rawUserTextStored:false, rawResponseStored:false, secretStored:false, fileWrite:false, download:false } },
    providerTrustClosureViewModelSummary:{ status:"ready", bookingUrl:null, paymentUrl:null, orderUrl:null, autoOpen:false, fileWrite:false, download:false }
  });
  assert.equal(trustClosure.status, "pass");
  assert.equal(trustClosure.providerPublicTrustClosureCenterSummary.status, "ready");
  assert.equal(trustClosure.offlineReleaseMemorySnapshotSummary.status, "ready");
  assert.equal(trustClosure.noProviderExecutionFinalGuardSummary.status, "ready");
  assert.equal(trustClosure.userVisibleSafetyBoundaryExplainerSummary.status, "ready");
  const launchReadinessFinal = api.buildFlightWorkflowSafetyRegressionReport({
    publicReleaseEvidenceConsoleSummary:{ status:"ready", safety:{ bookingUrl:null, payment:false, order:false, ticketing:false, rawUserTextStored:false, rawResponseStored:false, secretStored:false, fileWrite:false, download:false } },
    noProviderUserAssurancePanelSummary:{ status:"ready", safety:{ bookingUrl:null, payment:false, order:false, ticketing:false, rawUserTextStored:false, rawResponseStored:false, secretStored:false, fileWrite:false, download:false } },
    offlineLaunchReadinessFinalizerSummary:{ status:"ready", safety:{ bookingUrl:null, payment:false, order:false, ticketing:false, rawUserTextStored:false, rawResponseStored:false, secretStored:false, fileWrite:false, download:false } },
    userSafePublicClaimVerifierSummary:{ status:"ready", safety:{ bookingUrl:null, payment:false, order:false, ticketing:false, rawUserTextStored:false, rawResponseStored:false, secretStored:false, fileWrite:false, download:false } },
    providerLaunchReadinessFinalViewModelSummary:{ status:"ready", bookingUrl:null, paymentUrl:null, orderUrl:null, autoOpen:false, fileWrite:false, download:false }
  });
  assert.equal(launchReadinessFinal.status, "pass");
  assert.equal(launchReadinessFinal.publicReleaseEvidenceConsoleSummary.status, "ready");
  assert.equal(launchReadinessFinal.noProviderUserAssurancePanelSummary.status, "ready");
  assert.equal(launchReadinessFinal.offlineLaunchReadinessFinalizerSummary.status, "ready");
  assert.equal(launchReadinessFinal.userSafePublicClaimVerifierSummary.status, "ready");
  assert.equal(launchReadinessFinal.providerLaunchReadinessFinalViewModelSummary.status, "ready");
  assert.equal(trustClosure.providerTrustClosureViewModelSummary.status, "ready");
