...
function main() {
  const windowRef = load(["apps/desktop/src/renderer/core/globalShoppingPublicBetaViewModel.js"]);
  const api = windowRef.WeishanGlobalShoppingPublicBetaViewModel;
  assert.equal(api.GLOBAL_SHOPPING_PUBLIC_BETA_VIEW_MODEL_VERSION, "4.0.0");
