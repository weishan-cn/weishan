...
test.describe.serial("commerce agent workbench", () => {
  ...
  test("v2.1.68 local read-only quote evidence recovery stays candidate-only @commerce-ui-regression", async () => {
    await resetCommerceTasks(page);
    await page.evaluate((id) => {
      try {
  ...
  test("v2.1.68 decision assistant visible on read-only candidates @commerce-ui-regression", async () => {
    await resetCommerceTasks(page);
    await installOpenExternalMock(page);
  ...
  test("v2.2.1 global shopping provider fixture stays read-only and local @commerce-smoke", async () => {
    await resetCommerceTasks(page);
  ...
  test("v4.1.7 public beta acceptance snapshot stays local and bounded @commerce-smoke", async () => {
    await resetCommerceTasks(page);
    await installOpenExternalMock(page);
    await page.waitForFunction(() => !!(
    ...
    const v400 = await page.evaluate(() => {
      ...
      const card = {
        ...
        globalShoppingFeeNormalizationViewSummary:{ status:"ready", userFacingSummary:{ title:"费用归一化", resultLabel:"费用归一化已准备", redacted:true }, rows:[{ rowId:"fee_normalization", label:"费用归一化", value:"费用归一化已准备", status:"pass", redacted:true }], redacted:true },
        globalShoppingOfficialAnchorComparisonViewSummary:{ status:"ready", userFacingSummary:{ title:"官方价锚点", resultLabel:"官方价锚点已准备", redacted:true }, rows:[{ rowId:"official_anchor", label:"官方价锚点", value:"官方价锚点已准备", status:"pass", redacted:true }], redacted:true },
        ...
        publicBetaUserOnboardingShellSummary:{ status:"ready", userFacingSummary:{ title:"Public Beta User Onboarding", resultLabel:"Public Beta User Onboarding 已准备", redacted:true }, rows:[{ rowId:"public_beta_user_onboarding", label:"Public Beta User Onboarding", value:"Public Beta User Onboarding 已准备", status:"pass", redacted:true }], redacted:true },
        visualTrialGuideSummary:{ status:"ready", userFacingSummary:{ title:"Visual Trial Guide", resultLabel:"Visual Trial Guide 已准备", redacted:true }, rows:[{ rowId:"visual_trial_guide", label:"Visual Trial Guide", value:"Visual Trial Guide 已准备", status:"pass", redacted:true }], redacted:true },
        safeFeedbackDraftPanelSummary:{ status:"ready", userFacingSummary:{ title:"Safe Feedback Draft", resultLabel:"Safe Feedback Draft 已准备", redacted:true }, rows:[{ rowId:"safe_feedback_draft", label:"Safe Feedback Draft", value:"Safe Feedback Draft 已准备", status:"pass", redacted:true }], redacted:true },
        publicBetaOnboardingViewModelSummary:{ status:"ready", userFacingSummary:{ title:"Public Beta Onboarding View Model", resultLabel:"Public Beta User Onboarding / Visual Trial Guide / Safe Feedback Draft 已准备", redacted:true }, rows:[{ rowId:"public_beta_onboarding_view_model", label:"Public Beta Onboarding View Model", value:"Public Beta User Onboarding / Visual Trial Guide / Safe Feedback Draft 已准备", status:"pass", redacted:true }], redacted:true },
        publicBetaRcConsoleSummary:{ status:"manual_review_required", rcStatus:"manual_review_required", userFacingSummary:{ title:"Public Beta RC Console", resultLabel:"Public Beta RC Console 进入人工复核", redacted:true }, rows:[{ rowId:"public_beta_rc_console", label:"Public Beta RC Console", value:"Public Beta RC Console 进入人工复核", status:"warning", redacted:true }], redacted:true },
        offlineTrialReleaseGateSummary:{ status:"ready", userFacingSummary:{ title:"Offline Trial Release Gate", resultLabel:"Offline Trial Release Gate 已准备", redacted:true }, rows:[{ rowId:"offline_trial_release_gate", label:"Offline Trial Release Gate", value:"Offline Trial Release Gate 已准备", status:"pass", redacted:true }], redacted:true },
        publicBetaRcViewModelSummary:{ status:"ready", userFacingSummary:{ title:"Public Beta RC Console", resultLabel:"Public Beta RC Console / Offline Trial Release Gate 已准备", redacted:true }, rows:[{ rowId:"public_beta_rc_view_model", label:"Public Beta RC View Model", value:"Public Beta RC Console / Offline Trial Release Gate 已准备", status:"pass", redacted:true }], safeToProceedWithManualRcReview:true, redacted:true },
        ...
        publicBetaAcceptanceReviewConsoleSummary:{ status:"manual_review_required", userFacingSummary:{ title:"Public Beta Acceptance Review Console", resultLabel:"Public Beta Acceptance Review Console 需人工复核", redacted:true }, rows:[{ rowId:"public_beta_acceptance_review_console", label:"Public Beta Acceptance Review Console", value:"Public Beta Acceptance Review Console 需人工复核", status:"warning", redacted:true }], redacted:true },
        offlineTrialClosureBoardSummary:{ status:"manual_review_required", userFacingSummary:{ title:"Offline Trial Closure Board", resultLabel:"Offline Trial Closure Board 需人工复核", redacted:true }, rows:[{ rowId:"offline_trial_closure_board", label:"Offline Trial Closure Board", value:"Offline Trial Closure Board 需人工复核", status:"warning", redacted:true }], redacted:true },
        noLaunchAssuranceGateSummary:{ status:"ready", userFacingSummary:{ title:"No-Launch Assurance Gate", resultLabel:"No-Launch Assurance Gate 已准备", redacted:true }, rows:[{ rowId:"no_launch_assurance_gate", label:"No-Launch Assurance Gate", value:"No-Launch Assurance Gate 已准备", status:"pass", redacted:true }], redacted:true },
        publicBetaClosureReviewViewModelSummary:{ status:"ready", userFacingSummary:{ title:"Public Beta Closure Review View Model", resultLabel:"Public Beta Closure Review View Model 已准备", redacted:true }, rows:[{ rowId:"public_beta_closure_review_view_model", label:"Public Beta Closure Review View Model", value:"Public Beta Closure Review View Model 已准备", status:"pass", redacted:true }], safeToProceedWithManualClosureReview:true, redacted:true },
        ...
        publicBetaAcceptanceBoardSummary:{ status:"ready", userFacingSummary:{ title:"Public Beta Acceptance Board", resultLabel:"安全文案通过", redacted:true }, rows:[{ rowId:"public_beta_acceptance_board", label:"Public Beta Acceptance Board", value:"安全文案通过", status:"pass", redacted:true }], redacted:true },
        publicBetaOperatorViewModelSummary:{ status:"ready", userFacingSummary:{ title:"Public Beta Operator View Model", resultLabel:"仍需人工复核后再决定是否进入下一阶段", redacted:true }, rows:[{ rowId:"public_beta_operator_view_model", label:"Public Beta Operator View Model", value:"仍需人工复核后再决定是否进入下一阶段", status:"warning", redacted:true }], redacted:true },
        ...
        publicBetaUserOnboardingShellStatus:"ready",
        visualTrialGuideStatus:"ready",
        safeFeedbackDraftPanelStatus:"ready",
        publicBetaOnboardingViewModelStatus:"ready",
        ...
        publicBetaAcceptanceBoardStatus:"ready",
    ...
    expect(v400.text).toContain("全球购 Public Beta");
    ...
    expect(v400.text).toContain("候选价证据");
    expect(v400.text).toContain("候选价证据已准备");
    expect(v400.text).toContain("来源与时间");
    expect(v400.text).toContain("可信度");
    expect(v400.text).toContain("风险说明");
    ...
    expect(v400.text).toContain("Public Beta User Onboarding");
    expect(v400.text).toContain("Visual Trial Guide");
    expect(v400.text).toContain("Safe Feedback Draft");
    expect(v400.text).toContain("Readonly Capabilities");
    expect(v400.text).toContain("Locked Capabilities");
    expect(v400.text).toContain("Privacy Boundary");
    expect(v400.text).toContain("你可以查看候选价、费用归一化和官方价锚点");
    expect(v400.text).toContain("当前不会付款、下单或出票");
    expect(v400.text).toContain("不会保存账号、证件或支付信息");
    expect(v400.text).toContain("反馈入口目前仅为草稿，不发送、不上传、不保存用户原文");
    expect(v400.text).toContain("feedbackEnabled:false");
    expect(v400.text).toContain("uploadEnabled:false");
    expect(v400.text).toContain("emailEnabled:false");
    expect(v400.text).toContain("externalFormUrl:null");
    expect(v400.text).toContain("Public Beta RC Console");
    expect(v400.text).toContain("Offline Trial Release Gate");
    expect(v400.text).toContain("No Release Mutation");
    expect(v400.text).toContain("No Transaction");
    expect(v400.text).toContain("No Provider");
    ...
    expect(v400.text).toContain("Public Beta Acceptance Review Console");
    expect(v400.text).toContain("Offline Trial Closure Board");
    expect(v400.text).toContain("No-Launch Assurance Gate");
    expect(v400.text).toContain("Acceptance Review");
    expect(v400.text).toContain("Trial Closure");
    expect(v400.text).toContain("No Launch");
    expect(v400.text).toContain("当前不发布、不创建 release、不 push");
    expect(v400.text).toContain("试用闭环仅为离线视图，不关闭真实任务");
    expect(v400.text).toContain("验收复核后仍需人工决定下一阶段");
    ...
    expect(v400.text).toContain("含运费/不含运费");
    expect(v400.text).toContain("服务费说明");
    expect(v400.text).toContain("归一化价格仅用于辅助比较");
    expect(v400.text).toContain("不代表真实最终价");
    expect(v400.text).toContain("全球购 Public Beta 已准备");
    expect(v400.text).not.toContain("ready_to_publish");
    expect(v400.text).not.toContain("production_ready");
    expect(v400.text).not.toContain("auto_release");
    expect(v400.text).not.toContain("auto_publish");
    expect(v400.text).not.toContain("auto_launch");
    expect(v400.text).not.toContain("enable_provider");
    expect(v400.text).not.toContain("enable_payment");
    expect(v400.text).not.toContain("enable_order");
    expect(v400.text).not.toContain("已发布");
    expect(v400.text).not.toContain("已 launch");
    expect(v400.text).not.toContain("已自动发布");
    expect(v400.text).not.toContain("已创建 release");
    expect(v400.text).not.toContain("已 push");
    expect(v400.text).not.toContain("已关闭真实任务");
    expect(v400.text).not.toContain("已创建 issue");
    expect(v400.text).not.toContain("已上传问题");
    ...
    expect(v400.text).not.toContain("可下单");
    expect(v400.text).not.toContain("可以出票");
    expect(v400.text).not.toContain("立即购买");
    expect(v400.text).not.toContain("一键预订");
    expect(v400.text).toContain("Provider-Zero Status Panel 已准备");
    ...
    expect(v400.text).toContain("未联网调用");
    expect(v400.text).toContain("未生成 endpoint");
    expect(v400.text).toContain("未打开外部平台");
    expect(v400.text).toContain("未启用付款");
    expect(v400.text).toContain("未生成订单");
    expect(v400.text).toContain("未出票");
    expect(v400.text).toContain("未保存 raw provider 数据");
    expect(v400.text).toContain("候选价证据已准备");
    expect(v400.text).toContain("费用归一化已准备");
    expect(v400.text).toContain("官方价锚点已准备");
    expect(v400.text).toContain("Flight / Hotel / Product 只读外壳已准备");
    expect(v400.text).toContain("Provider-Zero 状态通过");
    expect(v400.text).toContain("候选价证据通过");
    expect(v400.text).toContain("费用归一化通过");
    expect(v400.text).toContain("官方价锚点通过");
    expect(v400.text).toContain("安全文案通过");
    expect(v400.text).toContain("最终离线审计通过");
    expect(v400.text).toContain("用户边界清晰");
    ...
    expect(v400.text).not.toContain("最终成交价");
    expect(v400.text).not.toContain("立即购买");
    expect(v400.text).not.toContain("直接下单");
    expect(v400.text).not.toContain("一键下单");
    expect(v400.text).not.toContain("一键出票");
    expect(v400.text).not.toContain("授权付款");
    expect(v400.text).not.toContain("可创建订单");
    expect(v400.text).not.toContain("反馈已发送");
    expect(v400.text).not.toContain("已上传反馈");
    expect(v400.text).not.toContain("已保存用户原文");
    expect(v400.text).not.toContain("可付款");
    expect(v400.text).not.toContain("可下单");
    expect(v400.text).not.toContain("可以出票");
    expect(v400.text).not.toContain("可直接出票");
    expect(v400.text).not.toContain("一键预订");
    expect(v400.text).not.toContain("已进入正式 Beta");
    expect(v400.text).not.toContain("已自动开放");
    expect(v400.text).not.toContain("官方保证");
    expect(v400.text).not.toContain("官方背书");
    ...
    expect(v400.text).not.toMatch(/(?:token|secret|apiKey)\s*[:=]\s*[\w-]+/i);
    ...
    expect(v400.sectionText).not.toContain("已生成 endpoint");
  ...
  test("v2.1.68 manual platform check capture stays local and blocks sensitive input @commerce-ui-regression", async () => {
    await resetCommerceTasks(page);
    await installOpenExternalMock(page);
