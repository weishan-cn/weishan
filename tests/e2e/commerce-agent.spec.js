...
test.describe.serial("commerce agent workbench", () => {
  ...
  test("v2.1.80 flight workflow release readiness dashboard stays local @commerce-smoke", async () => {
    await resetCommerceTasks(page);
  ...
  test("v2.1.80 pilot onboarding guard appears before guided test @commerce-smoke", async () => {
    await resetCommerceTasks(page);
  ...
  test("v2.1.80 public pilot readiness snapshot stays local @commerce-smoke", async () => {
    await resetCommerceTasks(page);
  ...
  test("v2.1.80 support playbook console stays local @commerce-smoke", async () => {
    await resetCommerceTasks(page);
  ...
  test("v2.1.80 public pilot cohort progress tracker stays local @commerce-smoke", async () => {
    await resetCommerceTasks(page);
  ...
  test("v2.1.80 read-only trial milestone board stays local @commerce-smoke", async () => {
    await resetCommerceTasks(page);
  ...
  test("v2.1.80 cohort progress view model stays local @commerce-smoke", async () => {
    await resetCommerceTasks(page);
  ...
  test("v2.1.80 restricted category blocks pilot onboarding @commerce-smoke", async () => {
    await resetCommerceTasks(page);
