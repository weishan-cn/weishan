(function(){
  ...
  if (!window.WeishanCommerceAgent && typeof document !== "undefined" && document.currentScript && document.write) {
    document.write('<scr' + 'ipt src="./renderer/core/commerceAgent.js?v=2.0.88"></scr' + 'ipt>');
  }
  ...
  if (!window.WeishanCommerceProviderApprovalWorkflow && typeof document !== "undefined" && document.currentScript && document.write) {
    document.write('<scr' + 'ipt src="./renderer/core/commerceProviderApprovalWorkflow.js?v=2.0.41"></scr' + 'ipt>');
  }
  ...
  if (!window.WeishanCommerceEbayBrowseStubProfile && typeof document !== "undefined" && document.currentScript && document.write) {
    document.write('<scr' + 'ipt src="./renderer/core/commerceEbayBrowseStubProfile.js?v=2.0.44"></scr' + 'ipt>');
  }
  ...
  if (!window.WeishanCommerceProviderSandboxDryRun && typeof document !== "undefined" && document.currentScript && document.write) {
    document.write('<scr' + 'ipt src="./renderer/core/commerceProviderSandboxDryRun.js?v=2.0.48"></scr' + 'ipt>');
  }
  if (!window.WeishanCommerceConnectorGate && typeof document !== "undefined" && document.currentScript && document.write) {
    document.write('<scr' + 'ipt src="./renderer/core/commerceConnectorGate.js?v=2.0.48"></scr' + 'ipt>');
  }
  if (!window.WeishanCommerceProviderIntegrationReadiness && typeof document !== "undefined" && document.currentScript && document.write) {
    document.write('<scr' + 'ipt src="./renderer/core/commerceProviderIntegrationReadiness.js?v=2.0.48"></scr' + 'ipt>');
  }
  ...
  if (!window.WeishanCommerceProviderConfig && typeof document !== "undefined" && document.currentScript && document.write) {
    document.write('<scr' + 'ipt src="./renderer/core/commerceProviderConfig.js?v=2.0.48"></scr' + 'ipt>');
  }
  ...
  if (!window.WeishanCommerceProviders && typeof document !== "undefined" && document.currentScript && document.write) {
    document.write('<scr' + 'ipt src="./renderer/core/commerceProviders.js?v=2.0.48"></scr' + 'ipt>');
  }
  if (!window.WeishanCommerceSearch && typeof document !== "undefined" && document.currentScript && document.write) {
    document.write('<scr' + 'ipt src="./renderer/core/commerceSearch.js?v=2.0.48"></scr' + 'ipt>');
  }
  ...
  function attachSubPlanQuestions(commercePlan){
    ...
    const generator = commerceSubPlanQuestionGenerator();
