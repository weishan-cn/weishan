;(function () {
  ...
  const READ_ONLY_QUOTE_SESSION_REPORT_CENTER_VERSION = "4.2.6";
  ...
  function workflowFields(input) {
    ...
    return {
      ...
      publicBetaTrialReadinessPackSummary: stripUnsafe(safe.publicBetaTrialReadinessPackSummary || null),
      ...
      publicBetaUserOnboardingShellSummary: stripUnsafe(safe.publicBetaUserOnboardingShellSummary || null),
      visualTrialGuideSummary: stripUnsafe(safe.visualTrialGuideSummary || null),
      safeFeedbackDraftPanelSummary: stripUnsafe(safe.safeFeedbackDraftPanelSummary || null),
      publicBetaOnboardingViewModelSummary: stripUnsafe(safe.publicBetaOnboardingViewModelSummary || null),
      publicBetaRcConsoleSummary: stripUnsafe(safe.publicBetaRcConsoleSummary || null),
      offlineTrialReleaseGateSummary: stripUnsafe(safe.offlineTrialReleaseGateSummary || null),
      publicBetaRcViewModelSummary: stripUnsafe(safe.publicBetaRcViewModelSummary || null),
      publicBetaStabilityAuditSummary: stripUnsafe(safe.publicBetaStabilityAuditSummary || null),
      manualLaunchHandoffPackSummary: stripUnsafe(safe.manualLaunchHandoffPackSummary || null),
      manualLaunchHandoffViewModelSummary: stripUnsafe(safe.manualLaunchHandoffViewModelSummary || null),
      ...
      publicBetaTrialReadinessPackStatus: safeText(safe.publicBetaTrialReadinessPackStatus || safe.publicBetaTrialReadinessPackSummary && safe.publicBetaTrialReadinessPackSummary.status || ""),
      ...
      publicBetaUserOnboardingShellStatus: safeText(safe.publicBetaUserOnboardingShellStatus || safe.publicBetaUserOnboardingShellSummary && safe.publicBetaUserOnboardingShellSummary.status || ""),
      visualTrialGuideStatus: safeText(safe.visualTrialGuideStatus || safe.visualTrialGuideSummary && safe.visualTrialGuideSummary.status || ""),
      safeFeedbackDraftPanelStatus: safeText(safe.safeFeedbackDraftPanelStatus || safe.safeFeedbackDraftPanelSummary && safe.safeFeedbackDraftPanelSummary.status || ""),
      publicBetaOnboardingViewModelStatus: safeText(safe.publicBetaOnboardingViewModelStatus || safe.publicBetaOnboardingViewModelSummary && safe.publicBetaOnboardingViewModelSummary.status || ""),
      publicBetaRcConsoleStatus: safeText(safe.publicBetaRcConsoleStatus || safe.publicBetaRcConsoleSummary && (safe.publicBetaRcConsoleSummary.rcStatus || safe.publicBetaRcConsoleSummary.status) || ""),
      offlineTrialReleaseGateStatus: safeText(safe.offlineTrialReleaseGateStatus || safe.offlineTrialReleaseGateSummary && safe.offlineTrialReleaseGateSummary.status || ""),
      publicBetaRcViewModelStatus: safeText(safe.publicBetaRcViewModelStatus || safe.publicBetaRcViewModelSummary && safe.publicBetaRcViewModelSummary.status || ""),
      publicBetaStabilityAuditStatus: safeText(safe.publicBetaStabilityAuditStatus || safe.publicBetaStabilityAuditSummary && safe.publicBetaStabilityAuditSummary.status || ""),
      manualLaunchHandoffPackStatus: safeText(safe.manualLaunchHandoffPackStatus || safe.manualLaunchHandoffPackSummary && safe.manualLaunchHandoffPackSummary.status || ""),
      manualLaunchHandoffViewModelStatus: safeText(safe.manualLaunchHandoffViewModelStatus || safe.manualLaunchHandoffViewModelSummary && safe.manualLaunchHandoffViewModelSummary.status || ""),
  ...
  function buildUserFacingQuoteEvidenceSummary(input) {
    ...
    const publicBetaTrialReadinessPackSummary = stripUnsafe(workflow.publicBetaTrialReadinessPackSummary || safe.publicBetaTrialReadinessPackSummary || null);
    ...
    const publicBetaUserOnboardingShellSummary = stripUnsafe(workflow.publicBetaUserOnboardingShellSummary || safe.publicBetaUserOnboardingShellSummary || null);
    const visualTrialGuideSummary = stripUnsafe(workflow.visualTrialGuideSummary || safe.visualTrialGuideSummary || null);
    const safeFeedbackDraftPanelSummary = stripUnsafe(workflow.safeFeedbackDraftPanelSummary || safe.safeFeedbackDraftPanelSummary || null);
    const publicBetaOnboardingViewModelSummary = stripUnsafe(workflow.publicBetaOnboardingViewModelSummary || safe.publicBetaOnboardingViewModelSummary || null);
    return clone({
      title: "候选报价证据摘要",
      ...
      publicBetaRcConsoleSummary: workflow.publicBetaRcConsoleSummary || safe.publicBetaRcConsoleSummary || null,
      offlineTrialReleaseGateSummary: workflow.offlineTrialReleaseGateSummary || safe.offlineTrialReleaseGateSummary || null,
      publicBetaRcViewModelSummary: workflow.publicBetaRcViewModelSummary || safe.publicBetaRcViewModelSummary || null,
      publicBetaStabilityAuditSummary: workflow.publicBetaStabilityAuditSummary || safe.publicBetaStabilityAuditSummary || null,
      manualLaunchHandoffPackSummary: workflow.manualLaunchHandoffPackSummary || safe.manualLaunchHandoffPackSummary || null,
      manualLaunchHandoffViewModelSummary: workflow.manualLaunchHandoffViewModelSummary || safe.manualLaunchHandoffViewModelSummary || null,
      publicBetaManualQaReportCenterSummary: workflow.publicBetaManualQaReportCenterSummary || safe.publicBetaManualQaReportCenterSummary || null,
      ...
      publicBetaManualAcceptanceChecklistSummary: workflow.publicBetaManualAcceptanceChecklistSummary || safe.publicBetaManualAcceptanceChecklistSummary ? { title:"Public Beta Manual Acceptance Checklist", line:workflow.publicBetaManualAcceptanceChecklistSummary && workflow.publicBetaManualAcceptanceChecklistSummary.userFacingSummary && workflow.publicBetaManualAcceptanceChecklistSummary.userFacingSummary.resultLabel || safe.publicBetaManualAcceptanceChecklistSummary && safe.publicBetaManualAcceptanceChecklistSummary.userFacingSummary && safe.publicBetaManualAcceptanceChecklistSummary.userFacingSummary.resultLabel || "Public Beta Manual Acceptance Checklist 仍需复核", redacted:true } : null,
      offlineUserScenarioPackSummary: workflow.offlineUserScenarioPackSummary || safe.offlineUserScenarioPackSummary ? { title:"Offline User Scenario Pack", line:workflow.offlineUserScenarioPackSummary && workflow.offlineUserScenarioPackSummary.userFacingSummary && workflow.offlineUserScenarioPackSummary.userFacingSummary.resultLabel || safe.offlineUserScenarioPackSummary && safe.offlineUserScenarioPackSummary.userFacingSummary && safe.offlineUserScenarioPackSummary.userFacingSummary.resultLabel || "Offline User Scenario Pack 仍需复核", redacted:true } : null,
      noDataRetentionGuardSummary: workflow.noDataRetentionGuardSummary || safe.noDataRetentionGuardSummary ? { title:"No-Data-Retention Guard", line:workflow.noDataRetentionGuardSummary && workflow.noDataRetentionGuardSummary.userFacingSummary && workflow.noDataRetentionGuardSummary.userFacingSummary.resultLabel || safe.noDataRetentionGuardSummary && safe.noDataRetentionGuardSummary.userFacingSummary && safe.noDataRetentionGuardSummary.userFacingSummary.resultLabel || "No-Data-Retention Guard 仍需复核", redacted:true } : null,
      publicBetaAcceptanceReviewViewModelSummary: workflow.publicBetaAcceptanceReviewViewModelSummary || safe.publicBetaAcceptanceReviewViewModelSummary ? { title:"Public Beta Acceptance Review ViewModel", line:workflow.publicBetaAcceptanceReviewViewModelSummary && workflow.publicBetaAcceptanceReviewViewModelSummary.userFacingSummary && workflow.publicBetaAcceptanceReviewViewModelSummary.userFacingSummary.resultLabel || safe.publicBetaAcceptanceReviewViewModelSummary && safe.publicBetaAcceptanceReviewViewModelSummary.userFacingSummary && safe.publicBetaAcceptanceReviewViewModelSummary.userFacingSummary.resultLabel || "Public Beta Acceptance Review ViewModel 仍需复核", redacted:true } : null,
      publicBetaOfflineAcceptanceEvidenceCenterSummary: workflow.publicBetaOfflineAcceptanceEvidenceCenterSummary || safe.publicBetaOfflineAcceptanceEvidenceCenterSummary ? { title:"Public Beta Offline Acceptance Evidence Center", line:workflow.publicBetaOfflineAcceptanceEvidenceCenterSummary && workflow.publicBetaOfflineAcceptanceEvidenceCenterSummary.userFacingSummary && workflow.publicBetaOfflineAcceptanceEvidenceCenterSummary.userFacingSummary.resultLabel || safe.publicBetaOfflineAcceptanceEvidenceCenterSummary && safe.publicBetaOfflineAcceptanceEvidenceCenterSummary.userFacingSummary && safe.publicBetaOfflineAcceptanceEvidenceCenterSummary.userFacingSummary.resultLabel || "Public Beta Offline Acceptance Evidence Center 仍需复核", redacted:true } : null,
      manualScenarioReviewBoardSummary: workflow.manualScenarioReviewBoardSummary || safe.manualScenarioReviewBoardSummary ? { title:"Manual Scenario Review Board", line:workflow.manualScenarioReviewBoardSummary && workflow.manualScenarioReviewBoardSummary.userFacingSummary && workflow.manualScenarioReviewBoardSummary.userFacingSummary.resultLabel || safe.manualScenarioReviewBoardSummary && safe.manualScenarioReviewBoardSummary.userFacingSummary && safe.manualScenarioReviewBoardSummary.userFacingSummary.resultLabel || "Manual Scenario Review Board 仍需复核", redacted:true } : null,
      zeroPersistenceRegressionGateSummary: workflow.zeroPersistenceRegressionGateSummary || safe.zeroPersistenceRegressionGateSummary ? { title:"Zero-Persistence Regression Gate", line:workflow.zeroPersistenceRegressionGateSummary && workflow.zeroPersistenceRegressionGateSummary.userFacingSummary && workflow.zeroPersistenceRegressionGateSummary.userFacingSummary.resultLabel || safe.zeroPersistenceRegressionGateSummary && safe.zeroPersistenceRegressionGateSummary.userFacingSummary && safe.zeroPersistenceRegressionGateSummary.userFacingSummary.resultLabel || "Zero-Persistence Regression Gate 仍需复核", redacted:true } : null,
      publicBetaOfflineAcceptanceViewModelSummary: workflow.publicBetaOfflineAcceptanceViewModelSummary || safe.publicBetaOfflineAcceptanceViewModelSummary ? { title:"Public Beta Offline Acceptance ViewModel", line:workflow.publicBetaOfflineAcceptanceViewModelSummary && workflow.publicBetaOfflineAcceptanceViewModelSummary.userFacingSummary && workflow.publicBetaOfflineAcceptanceViewModelSummary.userFacingSummary.resultLabel || safe.publicBetaOfflineAcceptanceViewModelSummary && safe.publicBetaOfflineAcceptanceViewModelSummary.userFacingSummary && safe.publicBetaOfflineAcceptanceViewModelSummary.userFacingSummary.resultLabel || "Public Beta Offline Acceptance ViewModel 仍需复核", redacted:true } : null,
      publicBetaFinalAcceptanceLockSummary: workflow.publicBetaFinalAcceptanceLockSummary || safe.publicBetaFinalAcceptanceLockSummary ? { title:"Public Beta Final Acceptance Lock", line:workflow.publicBetaFinalAcceptanceLockSummary && workflow.publicBetaFinalAcceptanceLockSummary.userFacingSummary && workflow.publicBetaFinalAcceptanceLockSummary.userFacingSummary.resultLabel || safe.publicBetaFinalAcceptanceLockSummary && safe.publicBetaFinalAcceptanceLockSummary.userFacingSummary && safe.publicBetaFinalAcceptanceLockSummary.userFacingSummary.resultLabel || "Public Beta Final Acceptance Lock 仍需复核", redacted:true } : null,
      offlineReleaseCandidateAuditSummary: workflow.offlineReleaseCandidateAuditSummary || safe.offlineReleaseCandidateAuditSummary ? { title:"Offline Release Candidate Audit", line:workflow.offlineReleaseCandidateAuditSummary && workflow.offlineReleaseCandidateAuditSummary.userFacingSummary && workflow.offlineReleaseCandidateAuditSummary.userFacingSummary.resultLabel || safe.offlineReleaseCandidateAuditSummary && safe.offlineReleaseCandidateAuditSummary.userFacingSummary && safe.offlineReleaseCandidateAuditSummary.userFacingSummary.resultLabel || "Offline Release Candidate Audit 仍需复核", redacted:true } : null,
      zeroActionSafetyConsoleSummary: workflow.zeroActionSafetyConsoleSummary || safe.zeroActionSafetyConsoleSummary ? { title:"Zero-Action Safety Console", line:workflow.zeroActionSafetyConsoleSummary && workflow.zeroActionSafetyConsoleSummary.userFacingSummary && workflow.zeroActionSafetyConsoleSummary.userFacingSummary.resultLabel || safe.zeroActionSafetyConsoleSummary && safe.zeroActionSafetyConsoleSummary.userFacingSummary && safe.zeroActionSafetyConsoleSummary.userFacingSummary.resultLabel || "Zero-Action Safety Console 仍需复核", redacted:true } : null,
      publicBetaFinalAcceptanceViewModelSummary: workflow.publicBetaFinalAcceptanceViewModelSummary || safe.publicBetaFinalAcceptanceViewModelSummary ? { title:"Public Beta Final Acceptance ViewModel", line:workflow.publicBetaFinalAcceptanceViewModelSummary && workflow.publicBetaFinalAcceptanceViewModelSummary.userFacingSummary && workflow.publicBetaFinalAcceptanceViewModelSummary.userFacingSummary.resultLabel || safe.publicBetaFinalAcceptanceViewModelSummary && safe.publicBetaFinalAcceptanceViewModelSummary.userFacingSummary && safe.publicBetaFinalAcceptanceViewModelSummary.userFacingSummary.resultLabel || "Public Beta Final Acceptance ViewModel 仍需复核", redacted:true } : null,
      ...
      offlineReadinessReviewPanelSummary: workflow.offlineReadinessReviewPanelSummary || safe.offlineReadinessReviewPanelSummary ? { title:"Offline Readiness Review Panel", line:workflow.offlineReadinessReviewPanelSummary && workflow.offlineReadinessReviewPanelSummary.userFacingSummary && workflow.offlineReadinessReviewPanelSummary.userFacingSummary.resultLabel || safe.offlineReadinessReviewPanelSummary && safe.offlineReadinessReviewPanelSummary.userFacingSummary && safe.offlineReadinessReviewPanelSummary.userFacingSummary.resultLabel || "Offline Readiness Review Panel 仍需复核", redacted:true } : null,
      publicBetaFreezeReviewViewModelSummary: workflow.publicBetaFreezeReviewViewModelSummary || safe.publicBetaFreezeReviewViewModelSummary ? { title:"Public Beta Freeze Review View Model", line:workflow.publicBetaFreezeReviewViewModelSummary && workflow.publicBetaFreezeReviewViewModelSummary.userFacingSummary && workflow.publicBetaFreezeReviewViewModelSummary.userFacingSummary.resultLabel || safe.publicBetaFreezeReviewViewModelSummary && safe.publicBetaFreezeReviewViewModelSummary.userFacingSummary && safe.publicBetaFreezeReviewViewModelSummary.userFacingSummary.resultLabel || "Public Beta Freeze Review View Model 仍需复核", redacted:true } : null,
      publicBetaFreezeEvidenceSummary: workflow.publicBetaFreezeEvidenceSummary || safe.publicBetaFreezeEvidenceSummary ? { title:"Public Beta Freeze Evidence Summary", line:workflow.publicBetaFreezeEvidenceSummary && workflow.publicBetaFreezeEvidenceSummary.userFacingSummary && workflow.publicBetaFreezeEvidenceSummary.userFacingSummary.resultLabel || safe.publicBetaFreezeEvidenceSummary && safe.publicBetaFreezeEvidenceSummary.userFacingSummary && safe.publicBetaFreezeEvidenceSummary.userFacingSummary.resultLabel || "Public Beta Freeze Evidence Summary 仍需复核", redacted:true } : null,
      manualTrialIssueReviewBoardSummary: workflow.manualTrialIssueReviewBoardSummary || safe.manualTrialIssueReviewBoardSummary ? { title:"Manual Trial Issue Review Board", line:workflow.manualTrialIssueReviewBoardSummary && workflow.manualTrialIssueReviewBoardSummary.userFacingSummary && workflow.manualTrialIssueReviewBoardSummary.userFacingSummary.resultLabel || safe.manualTrialIssueReviewBoardSummary && safe.manualTrialIssueReviewBoardSummary.userFacingSummary && safe.manualTrialIssueReviewBoardSummary.userFacingSummary.resultLabel || "Manual Trial Issue Review Board 仍需复核", redacted:true } : null,
      offlineAcceptanceSnapshotSummary: workflow.offlineAcceptanceSnapshotSummary || safe.offlineAcceptanceSnapshotSummary ? { title:"Offline Acceptance Snapshot", line:workflow.offlineAcceptanceSnapshotSummary && workflow.offlineAcceptanceSnapshotSummary.userFacingSummary && workflow.offlineAcceptanceSnapshotSummary.userFacingSummary.resultLabel || safe.offlineAcceptanceSnapshotSummary && safe.offlineAcceptanceSnapshotSummary.userFacingSummary && safe.offlineAcceptanceSnapshotSummary.userFacingSummary.resultLabel || "Offline Acceptance Snapshot 仍需复核", redacted:true } : null,
      publicBetaAcceptanceSnapshotViewModelSummary: workflow.publicBetaAcceptanceSnapshotViewModelSummary || safe.publicBetaAcceptanceSnapshotViewModelSummary ? { title:"Public Beta Acceptance Snapshot View Model", line:workflow.publicBetaAcceptanceSnapshotViewModelSummary && workflow.publicBetaAcceptanceSnapshotViewModelSummary.userFacingSummary && workflow.publicBetaAcceptanceSnapshotViewModelSummary.userFacingSummary.resultLabel || safe.publicBetaAcceptanceSnapshotViewModelSummary && safe.publicBetaAcceptanceSnapshotViewModelSummary.userFacingSummary && safe.publicBetaAcceptanceSnapshotViewModelSummary.userFacingSummary.resultLabel || "Public Beta Acceptance Snapshot View Model 仍需复核", redacted:true } : null,
      publicBetaAcceptanceReviewConsoleSummary: workflow.publicBetaAcceptanceReviewConsoleSummary || safe.publicBetaAcceptanceReviewConsoleSummary ? { title:"Public Beta Acceptance Review Console", line:workflow.publicBetaAcceptanceReviewConsoleSummary && workflow.publicBetaAcceptanceReviewConsoleSummary.userFacingSummary && workflow.publicBetaAcceptanceReviewConsoleSummary.userFacingSummary.resultLabel || safe.publicBetaAcceptanceReviewConsoleSummary && safe.publicBetaAcceptanceReviewConsoleSummary.userFacingSummary && safe.publicBetaAcceptanceReviewConsoleSummary.userFacingSummary.resultLabel || "Public Beta Acceptance Review Console 仍需复核", redacted:true } : null,
      offlineTrialClosureBoardSummary: workflow.offlineTrialClosureBoardSummary || safe.offlineTrialClosureBoardSummary ? { title:"Offline Trial Closure Board", line:workflow.offlineTrialClosureBoardSummary && workflow.offlineTrialClosureBoardSummary.userFacingSummary && workflow.offlineTrialClosureBoardSummary.userFacingSummary.resultLabel || safe.offlineTrialClosureBoardSummary && safe.offlineTrialClosureBoardSummary.userFacingSummary && safe.offlineTrialClosureBoardSummary.userFacingSummary.resultLabel || "Offline Trial Closure Board 仍需复核", redacted:true } : null,
      noLaunchAssuranceGateSummary: workflow.noLaunchAssuranceGateSummary || safe.noLaunchAssuranceGateSummary ? { title:"No-Launch Assurance Gate", line:workflow.noLaunchAssuranceGateSummary && workflow.noLaunchAssuranceGateSummary.userFacingSummary && workflow.noLaunchAssuranceGateSummary.userFacingSummary.resultLabel || safe.noLaunchAssuranceGateSummary && safe.noLaunchAssuranceGateSummary.userFacingSummary && safe.noLaunchAssuranceGateSummary.userFacingSummary.resultLabel || "No-Launch Assurance Gate 仍需复核", redacted:true } : null,
      publicBetaClosureReviewViewModelSummary: workflow.publicBetaClosureReviewViewModelSummary || safe.publicBetaClosureReviewViewModelSummary ? { title:"Public Beta Closure Review View Model", line:workflow.publicBetaClosureReviewViewModelSummary && workflow.publicBetaClosureReviewViewModelSummary.userFacingSummary && workflow.publicBetaClosureReviewViewModelSummary.userFacingSummary.resultLabel || safe.publicBetaClosureReviewViewModelSummary && safe.publicBetaClosureReviewViewModelSummary.userFacingSummary && safe.publicBetaClosureReviewViewModelSummary.userFacingSummary.resultLabel || "Public Beta Closure Review View Model 仍需复核", redacted:true } : null,
      publicBetaClosureEvidenceArchiveSummary: workflow.publicBetaClosureEvidenceArchiveSummary || safe.publicBetaClosureEvidenceArchiveSummary ? { title:"Public Beta Closure Evidence Archive", line:workflow.publicBetaClosureEvidenceArchiveSummary && workflow.publicBetaClosureEvidenceArchiveSummary.userFacingSummary && workflow.publicBetaClosureEvidenceArchiveSummary.userFacingSummary.resultLabel || safe.publicBetaClosureEvidenceArchiveSummary && safe.publicBetaClosureEvidenceArchiveSummary.userFacingSummary && safe.publicBetaClosureEvidenceArchiveSummary.userFacingSummary.resultLabel || "Public Beta Closure Evidence Archive 仍需复核", redacted:true } : null,
      manualTrialExitCriteriaSummary: workflow.manualTrialExitCriteriaSummary || safe.manualTrialExitCriteriaSummary ? { title:"Manual Trial Exit Criteria", line:workflow.manualTrialExitCriteriaSummary && workflow.manualTrialExitCriteriaSummary.userFacingSummary && workflow.manualTrialExitCriteriaSummary.userFacingSummary.resultLabel || safe.manualTrialExitCriteriaSummary && safe.manualTrialExitCriteriaSummary.userFacingSummary && safe.manualTrialExitCriteriaSummary.userFacingSummary.resultLabel || "Manual Trial Exit Criteria 仍需复核", redacted:true } : null,
      offlineNextStepPlanningBoardSummary: workflow.offlineNextStepPlanningBoardSummary || safe.offlineNextStepPlanningBoardSummary ? { title:"Offline Next-Step Planning Board", line:workflow.offlineNextStepPlanningBoardSummary && workflow.offlineNextStepPlanningBoardSummary.userFacingSummary && workflow.offlineNextStepPlanningBoardSummary.userFacingSummary.resultLabel || safe.offlineNextStepPlanningBoardSummary && safe.offlineNextStepPlanningBoardSummary.userFacingSummary && safe.offlineNextStepPlanningBoardSummary.userFacingSummary.resultLabel || "Offline Next-Step Planning Board 仍需复核", redacted:true } : null,
      publicBetaNextStepViewModelSummary: workflow.publicBetaNextStepViewModelSummary || safe.publicBetaNextStepViewModelSummary ? { title:"Public Beta Next-Step ViewModel", line:workflow.publicBetaNextStepViewModelSummary && workflow.publicBetaNextStepViewModelSummary.userFacingSummary && workflow.publicBetaNextStepViewModelSummary.userFacingSummary.resultLabel || safe.publicBetaNextStepViewModelSummary && safe.publicBetaNextStepViewModelSummary.userFacingSummary && safe.publicBetaNextStepViewModelSummary.userFacingSummary.resultLabel || "Public Beta Next-Step ViewModel 仍需复核", redacted:true } : null,
      publicBetaFinalReadinessCommandCenterSummary: workflow.publicBetaFinalReadinessCommandCenterSummary || safe.publicBetaFinalReadinessCommandCenterSummary ? { title:"Public Beta Final Readiness Command Center", line:workflow.publicBetaFinalReadinessCommandCenterSummary && workflow.publicBetaFinalReadinessCommandCenterSummary.userFacingSummary && workflow.publicBetaFinalReadinessCommandCenterSummary.userFacingSummary.resultLabel || safe.publicBetaFinalReadinessCommandCenterSummary && safe.publicBetaFinalReadinessCommandCenterSummary.userFacingSummary && safe.publicBetaFinalReadinessCommandCenterSummary.userFacingSummary.resultLabel || "Public Beta Final Readiness Command Center 仍需复核", redacted:true } : null,
      offlineLaunchBlockerMatrixSummary: workflow.offlineLaunchBlockerMatrixSummary || safe.offlineLaunchBlockerMatrixSummary ? { title:"Offline Launch Blocker Matrix", line:workflow.offlineLaunchBlockerMatrixSummary && workflow.offlineLaunchBlockerMatrixSummary.userFacingSummary && workflow.offlineLaunchBlockerMatrixSummary.userFacingSummary.resultLabel || safe.offlineLaunchBlockerMatrixSummary && safe.offlineLaunchBlockerMatrixSummary.userFacingSummary && safe.offlineLaunchBlockerMatrixSummary.userFacingSummary.resultLabel || "Offline Launch Blocker Matrix 仍需复核", redacted:true } : null,
      manualNextPhaseDossierSummary: workflow.manualNextPhaseDossierSummary || safe.manualNextPhaseDossierSummary ? { title:"Manual Next-Phase Dossier", line:workflow.manualNextPhaseDossierSummary && workflow.manualNextPhaseDossierSummary.userFacingSummary && workflow.manualNextPhaseDossierSummary.userFacingSummary.resultLabel || safe.manualNextPhaseDossierSummary && safe.manualNextPhaseDossierSummary.userFacingSummary && safe.manualNextPhaseDossierSummary.userFacingSummary.resultLabel || "Manual Next-Phase Dossier 仍需复核", redacted:true } : null,
      publicBetaFinalReadinessViewModelSummary: workflow.publicBetaFinalReadinessViewModelSummary || safe.publicBetaFinalReadinessViewModelSummary ? { title:"Public Beta Final Readiness ViewModel", line:workflow.publicBetaFinalReadinessViewModelSummary && workflow.publicBetaFinalReadinessViewModelSummary.userFacingSummary && workflow.publicBetaFinalReadinessViewModelSummary.userFacingSummary.resultLabel || safe.publicBetaFinalReadinessViewModelSummary && safe.publicBetaFinalReadinessViewModelSummary.userFacingSummary && safe.publicBetaFinalReadinessViewModelSummary.userFacingSummary.resultLabel || "Public Beta Final Readiness ViewModel 仍需复核", redacted:true } : null,
      publicBetaCandidateLockSummary: workflow.publicBetaCandidateLockSummary || safe.publicBetaCandidateLockSummary ? { title:"Public Beta Candidate Lock", line:workflow.publicBetaCandidateLockSummary && workflow.publicBetaCandidateLockSummary.userFacingSummary && workflow.publicBetaCandidateLockSummary.userFacingSummary.resultLabel || safe.publicBetaCandidateLockSummary && safe.publicBetaCandidateLockSummary.userFacingSummary && safe.publicBetaCandidateLockSummary.userFacingSummary.resultLabel || "Public Beta Candidate Lock 仍需复核", redacted:true } : null,
      finalTrialHandoffConsoleSummary: workflow.finalTrialHandoffConsoleSummary || safe.finalTrialHandoffConsoleSummary ? { title:"Final Trial Handoff Console", line:workflow.finalTrialHandoffConsoleSummary && workflow.finalTrialHandoffConsoleSummary.userFacingSummary && workflow.finalTrialHandoffConsoleSummary.userFacingSummary.resultLabel || safe.finalTrialHandoffConsoleSummary && safe.finalTrialHandoffConsoleSummary.userFacingSummary && safe.finalTrialHandoffConsoleSummary.userFacingSummary.resultLabel || "Final Trial Handoff Console 仍需复核", redacted:true } : null,
      noProviderProductionBoundarySummary: workflow.noProviderProductionBoundarySummary || safe.noProviderProductionBoundarySummary ? { title:"No-Provider Production Boundary", line:workflow.noProviderProductionBoundarySummary && workflow.noProviderProductionBoundarySummary.userFacingSummary && workflow.noProviderProductionBoundarySummary.userFacingSummary.resultLabel || safe.noProviderProductionBoundarySummary && safe.noProviderProductionBoundarySummary.userFacingSummary && safe.noProviderProductionBoundarySummary.userFacingSummary.resultLabel || "No-Provider Production Boundary 仍需复核", redacted:true } : null,
      publicBetaCandidateViewModelSummary: workflow.publicBetaCandidateViewModelSummary || safe.publicBetaCandidateViewModelSummary ? { title:"Public Beta Candidate ViewModel", line:workflow.publicBetaCandidateViewModelSummary && workflow.publicBetaCandidateViewModelSummary.userFacingSummary && workflow.publicBetaCandidateViewModelSummary.userFacingSummary.resultLabel || safe.publicBetaCandidateViewModelSummary && safe.publicBetaCandidateViewModelSummary.userFacingSummary && safe.publicBetaCandidateViewModelSummary.userFacingSummary.resultLabel || "Public Beta Candidate ViewModel 仍需复核", redacted:true } : null,
      publicBetaCandidateEvidenceReviewSummary: workflow.publicBetaCandidateEvidenceReviewSummary || safe.publicBetaCandidateEvidenceReviewSummary ? { title:"Public Beta Candidate Evidence Review", line:workflow.publicBetaCandidateEvidenceReviewSummary && workflow.publicBetaCandidateEvidenceReviewSummary.userFacingSummary && workflow.publicBetaCandidateEvidenceReviewSummary.userFacingSummary.resultLabel || safe.publicBetaCandidateEvidenceReviewSummary && safe.publicBetaCandidateEvidenceReviewSummary.userFacingSummary && safe.publicBetaCandidateEvidenceReviewSummary.userFacingSummary.resultLabel || "Public Beta Candidate Evidence Review 仍需复核", redacted:true } : null,
      trialOperatorNotesPanelSummary: workflow.trialOperatorNotesPanelSummary || safe.trialOperatorNotesPanelSummary ? { title:"Trial Operator Notes Panel", line:workflow.trialOperatorNotesPanelSummary && workflow.trialOperatorNotesPanelSummary.userFacingSummary && workflow.trialOperatorNotesPanelSummary.userFacingSummary.resultLabel || safe.trialOperatorNotesPanelSummary && safe.trialOperatorNotesPanelSummary.userFacingSummary && safe.trialOperatorNotesPanelSummary.userFacingSummary.resultLabel || "Trial Operator Notes Panel 仍需复核", redacted:true } : null,
      offlineSafetyDeltaBoardSummary: workflow.offlineSafetyDeltaBoardSummary || safe.offlineSafetyDeltaBoardSummary ? { title:"Offline Safety Delta Board", line:workflow.offlineSafetyDeltaBoardSummary && workflow.offlineSafetyDeltaBoardSummary.userFacingSummary && workflow.offlineSafetyDeltaBoardSummary.userFacingSummary.resultLabel || safe.offlineSafetyDeltaBoardSummary && safe.offlineSafetyDeltaBoardSummary.userFacingSummary && safe.offlineSafetyDeltaBoardSummary.userFacingSummary.resultLabel || "Offline Safety Delta Board 仍需复核", redacted:true } : null,
      publicBetaCandidateReviewViewModelSummary: workflow.publicBetaCandidateReviewViewModelSummary || safe.publicBetaCandidateReviewViewModelSummary ? { title:"Public Beta Candidate Review ViewModel", line:workflow.publicBetaCandidateReviewViewModelSummary && workflow.publicBetaCandidateReviewViewModelSummary.userFacingSummary && workflow.publicBetaCandidateReviewViewModelSummary.userFacingSummary.resultLabel || safe.publicBetaCandidateReviewViewModelSummary && safe.publicBetaCandidateReviewViewModelSummary.userFacingSummary && safe.publicBetaCandidateReviewViewModelSummary.userFacingSummary.resultLabel || "Public Beta Candidate Review ViewModel 仍需复核", redacted:true } : null,
      publicBetaCandidateQaFreezeSummary: workflow.publicBetaCandidateQaFreezeSummary || safe.publicBetaCandidateQaFreezeSummary ? { title:"Public Beta Candidate QA Freeze", line:workflow.publicBetaCandidateQaFreezeSummary && workflow.publicBetaCandidateQaFreezeSummary.userFacingSummary && workflow.publicBetaCandidateQaFreezeSummary.userFacingSummary.resultLabel || safe.publicBetaCandidateQaFreezeSummary && safe.publicBetaCandidateQaFreezeSummary.userFacingSummary && safe.publicBetaCandidateQaFreezeSummary.userFacingSummary.resultLabel || "Public Beta Candidate QA Freeze 仍需复核", redacted:true } : null,
      trialFeedbackIntakeMockSummary: workflow.trialFeedbackIntakeMockSummary || safe.trialFeedbackIntakeMockSummary ? { title:"Trial Feedback Intake Mock", line:workflow.trialFeedbackIntakeMockSummary && workflow.trialFeedbackIntakeMockSummary.userFacingSummary && workflow.trialFeedbackIntakeMockSummary.userFacingSummary.resultLabel || safe.trialFeedbackIntakeMockSummary && safe.trialFeedbackIntakeMockSummary.userFacingSummary && safe.trialFeedbackIntakeMockSummary.userFacingSummary.resultLabel || "Trial Feedback Intake Mock 仍需复核", redacted:true } : null,
      offlineRegressionEvidenceBoardSummary: workflow.offlineRegressionEvidenceBoardSummary || safe.offlineRegressionEvidenceBoardSummary ? { title:"Offline Regression Evidence Board", line:workflow.offlineRegressionEvidenceBoardSummary && workflow.offlineRegressionEvidenceBoardSummary.userFacingSummary && workflow.offlineRegressionEvidenceBoardSummary.userFacingSummary.resultLabel || safe.offlineRegressionEvidenceBoardSummary && safe.offlineRegressionEvidenceBoardSummary.userFacingSummary && safe.offlineRegressionEvidenceBoardSummary.userFacingSummary.resultLabel || "Offline Regression Evidence Board 仍需复核", redacted:true } : null,
      publicBetaQaFreezeViewModelSummary: workflow.publicBetaQaFreezeViewModelSummary || safe.publicBetaQaFreezeViewModelSummary ? { title:"Public Beta QA Freeze ViewModel", line:workflow.publicBetaQaFreezeViewModelSummary && workflow.publicBetaQaFreezeViewModelSummary.userFacingSummary && workflow.publicBetaQaFreezeViewModelSummary.userFacingSummary.resultLabel || safe.publicBetaQaFreezeViewModelSummary && safe.publicBetaQaFreezeViewModelSummary.userFacingSummary && safe.publicBetaQaFreezeViewModelSummary.userFacingSummary.resultLabel || "Public Beta QA Freeze ViewModel 仍需复核", redacted:true } : null,
      publicBetaCandidateQaFreezeSummary: workflow.publicBetaCandidateQaFreezeSummary || safe.publicBetaCandidateQaFreezeSummary ? { title:"Public Beta Candidate QA Freeze", line:workflow.publicBetaCandidateQaFreezeSummary && workflow.publicBetaCandidateQaFreezeSummary.userFacingSummary && workflow.publicBetaCandidateQaFreezeSummary.userFacingSummary.resultLabel || safe.publicBetaCandidateQaFreezeSummary && safe.publicBetaCandidateQaFreezeSummary.userFacingSummary && safe.publicBetaCandidateQaFreezeSummary.userFacingSummary.resultLabel || "Public Beta Candidate QA Freeze 仍需复核", redacted:true } : null,
      trialFeedbackIntakeMockSummary: workflow.trialFeedbackIntakeMockSummary || safe.trialFeedbackIntakeMockSummary ? { title:"Trial Feedback Intake Mock", line:workflow.trialFeedbackIntakeMockSummary && workflow.trialFeedbackIntakeMockSummary.userFacingSummary && workflow.trialFeedbackIntakeMockSummary.userFacingSummary.resultLabel || safe.trialFeedbackIntakeMockSummary && safe.trialFeedbackIntakeMockSummary.userFacingSummary && safe.trialFeedbackIntakeMockSummary.userFacingSummary.resultLabel || "Trial Feedback Intake Mock 仍需复核", redacted:true } : null,
      offlineRegressionEvidenceBoardSummary: workflow.offlineRegressionEvidenceBoardSummary || safe.offlineRegressionEvidenceBoardSummary ? { title:"Offline Regression Evidence Board", line:workflow.offlineRegressionEvidenceBoardSummary && workflow.offlineRegressionEvidenceBoardSummary.userFacingSummary && workflow.offlineRegressionEvidenceBoardSummary.userFacingSummary.resultLabel || safe.offlineRegressionEvidenceBoardSummary && safe.offlineRegressionEvidenceBoardSummary.userFacingSummary && safe.offlineRegressionEvidenceBoardSummary.userFacingSummary.resultLabel || "Offline Regression Evidence Board 仍需复核", redacted:true } : null,
      publicBetaQaFreezeViewModelSummary: workflow.publicBetaQaFreezeViewModelSummary || safe.publicBetaQaFreezeViewModelSummary ? { title:"Public Beta QA Freeze ViewModel", line:workflow.publicBetaQaFreezeViewModelSummary && workflow.publicBetaQaFreezeViewModelSummary.userFacingSummary && workflow.publicBetaQaFreezeViewModelSummary.userFacingSummary.resultLabel || safe.publicBetaQaFreezeViewModelSummary && safe.publicBetaQaFreezeViewModelSummary.userFacingSummary && safe.publicBetaQaFreezeViewModelSummary.userFacingSummary.resultLabel || "Public Beta QA Freeze ViewModel 仍需复核", redacted:true } : null,
      ...
      publicBetaUserOnboardingShellStatus: workflow.publicBetaUserOnboardingShellStatus || safe.publicBetaUserOnboardingShellStatus || "",
      visualTrialGuideStatus: workflow.visualTrialGuideStatus || safe.visualTrialGuideStatus || "",
      safeFeedbackDraftPanelStatus: workflow.safeFeedbackDraftPanelStatus || safe.safeFeedbackDraftPanelStatus || "",
      publicBetaOnboardingViewModelStatus: workflow.publicBetaOnboardingViewModelStatus || safe.publicBetaOnboardingViewModelStatus || "",
      publicBetaRcConsoleStatus: workflow.publicBetaRcConsoleStatus || safe.publicBetaRcConsoleStatus || "",
      offlineTrialReleaseGateStatus: workflow.offlineTrialReleaseGateStatus || safe.offlineTrialReleaseGateStatus || "",
      publicBetaRcViewModelStatus: workflow.publicBetaRcViewModelStatus || safe.publicBetaRcViewModelStatus || "",
      publicBetaStabilityAuditStatus: workflow.publicBetaStabilityAuditStatus || safe.publicBetaStabilityAuditStatus || "",
      manualLaunchHandoffPackStatus: workflow.manualLaunchHandoffPackStatus || safe.manualLaunchHandoffPackStatus || "",
      manualLaunchHandoffViewModelStatus: workflow.manualLaunchHandoffViewModelStatus || safe.manualLaunchHandoffViewModelStatus || "",
      ...
      publicBetaManualAcceptanceChecklistStatus: workflow.publicBetaManualAcceptanceChecklistStatus || safe.publicBetaManualAcceptanceChecklistStatus || "",
      offlineUserScenarioPackStatus: workflow.offlineUserScenarioPackStatus || safe.offlineUserScenarioPackStatus || "",
      noDataRetentionStatus: workflow.noDataRetentionStatus || safe.noDataRetentionStatus || "",
      publicBetaAcceptanceReviewViewModelStatus: workflow.publicBetaAcceptanceReviewViewModelStatus || safe.publicBetaAcceptanceReviewViewModelStatus || "",
      publicBetaOfflineAcceptanceEvidenceCenterStatus: workflow.publicBetaOfflineAcceptanceEvidenceCenterStatus || safe.publicBetaOfflineAcceptanceEvidenceCenterStatus || "",
      manualScenarioReviewStatus: workflow.manualScenarioReviewStatus || safe.manualScenarioReviewStatus || "",
      zeroPersistenceStatus: workflow.zeroPersistenceStatus || safe.zeroPersistenceStatus || "",
      publicBetaOfflineAcceptanceViewModelStatus: workflow.publicBetaOfflineAcceptanceViewModelStatus || safe.publicBetaOfflineAcceptanceViewModelStatus || "",
      ...
      offlineReadinessReviewPanelStatus: workflow.offlineReadinessReviewPanelStatus || safe.offlineReadinessReviewPanelStatus || "",
      publicBetaFreezeReviewViewModelStatus: workflow.publicBetaFreezeReviewViewModelStatus || safe.publicBetaFreezeReviewViewModelStatus || "",
      publicBetaFreezeEvidenceStatus: workflow.publicBetaFreezeEvidenceStatus || safe.publicBetaFreezeEvidenceStatus || "",
      manualTrialIssueReviewStatus: workflow.manualTrialIssueReviewStatus || safe.manualTrialIssueReviewStatus || "",
      offlineAcceptanceSnapshotStatus: workflow.offlineAcceptanceSnapshotStatus || safe.offlineAcceptanceSnapshotStatus || "",
      publicBetaAcceptanceSnapshotViewModelStatus: workflow.publicBetaAcceptanceSnapshotViewModelStatus || safe.publicBetaAcceptanceSnapshotViewModelStatus || "",
      publicBetaAcceptanceReviewConsoleStatus: workflow.publicBetaAcceptanceReviewConsoleStatus || safe.publicBetaAcceptanceReviewConsoleStatus || "",
      offlineTrialClosureBoardStatus: workflow.offlineTrialClosureBoardStatus || safe.offlineTrialClosureBoardStatus || "",
      noLaunchAssuranceGateStatus: workflow.noLaunchAssuranceGateStatus || safe.noLaunchAssuranceGateStatus || "",
      publicBetaClosureReviewViewModelStatus: workflow.publicBetaClosureReviewViewModelStatus || safe.publicBetaClosureReviewViewModelStatus || "",
      publicBetaClosureEvidenceArchiveStatus: workflow.publicBetaClosureEvidenceArchiveStatus || safe.publicBetaClosureEvidenceArchiveStatus || "",
      manualTrialExitCriteriaStatus: workflow.manualTrialExitCriteriaStatus || safe.manualTrialExitCriteriaStatus || "",
      offlineNextStepPlanningStatus: workflow.offlineNextStepPlanningStatus || safe.offlineNextStepPlanningStatus || "",
      publicBetaNextStepViewModelStatus: workflow.publicBetaNextStepViewModelStatus || safe.publicBetaNextStepViewModelStatus || "",
      publicBetaFinalReadinessCommandCenterStatus: workflow.publicBetaFinalReadinessCommandCenterStatus || safe.publicBetaFinalReadinessCommandCenterStatus || "",
      offlineLaunchBlockerMatrixStatus: workflow.offlineLaunchBlockerMatrixStatus || safe.offlineLaunchBlockerMatrixStatus || "",
      manualNextPhaseDossierStatus: workflow.manualNextPhaseDossierStatus || safe.manualNextPhaseDossierStatus || "",
      publicBetaFinalReadinessViewModelStatus: workflow.publicBetaFinalReadinessViewModelStatus || safe.publicBetaFinalReadinessViewModelStatus || "",
      publicBetaCandidateLockStatus: workflow.publicBetaCandidateLockStatus || safe.publicBetaCandidateLockStatus || "",
      finalTrialHandoffStatus: workflow.finalTrialHandoffStatus || safe.finalTrialHandoffStatus || "",
      noProviderProductionBoundaryStatus: workflow.noProviderProductionBoundaryStatus || safe.noProviderProductionBoundaryStatus || "",
      publicBetaCandidateViewModelStatus: workflow.publicBetaCandidateViewModelStatus || safe.publicBetaCandidateViewModelStatus || "",
      publicBetaCandidateEvidenceReviewStatus: workflow.publicBetaCandidateEvidenceReviewStatus || safe.publicBetaCandidateEvidenceReviewStatus || "",
      trialOperatorNotesStatus: workflow.trialOperatorNotesStatus || safe.trialOperatorNotesStatus || "",
      offlineSafetyDeltaStatus: workflow.offlineSafetyDeltaStatus || safe.offlineSafetyDeltaStatus || "",
      publicBetaCandidateReviewViewModelStatus: workflow.publicBetaCandidateReviewViewModelStatus || safe.publicBetaCandidateReviewViewModelStatus || "",
      publicBetaCandidateQaFreezeStatus: workflow.publicBetaCandidateQaFreezeStatus || safe.publicBetaCandidateQaFreezeStatus || "",
      trialFeedbackIntakeStatus: workflow.trialFeedbackIntakeStatus || safe.trialFeedbackIntakeStatus || "",
      offlineRegressionEvidenceStatus: workflow.offlineRegressionEvidenceStatus || safe.offlineRegressionEvidenceStatus || "",
      publicBetaQaFreezeViewModelStatus: workflow.publicBetaQaFreezeViewModelStatus || safe.publicBetaQaFreezeViewModelStatus || "",
      ...
      safeToProceedWithManualAcceptanceReview: workflow.safeToProceedWithManualAcceptanceReview === true || safe.safeToProceedWithManualAcceptanceReview === true,
      safeToProceedWithManualOfflineAcceptanceReview: workflow.safeToProceedWithManualOfflineAcceptanceReview === true || safe.safeToProceedWithManualOfflineAcceptanceReview === true,
      safeToProceedWithManualFinalAcceptanceReview: workflow.safeToProceedWithManualFinalAcceptanceReview === true || safe.safeToProceedWithManualFinalAcceptanceReview === true,
      ...
      safeToProceedWithManualAcceptanceSnapshotReview: workflow.safeToProceedWithManualAcceptanceSnapshotReview === true || safe.safeToProceedWithManualAcceptanceSnapshotReview === true,
      safeToProceedWithManualClosureReview: workflow.safeToProceedWithManualClosureReview === true || safe.safeToProceedWithManualClosureReview === true,
      safeToProceedWithManualNextStepReview: workflow.safeToProceedWithManualNextStepReview === true || safe.safeToProceedWithManualNextStepReview === true,
      safeToProceedWithManualFinalReadinessReview: workflow.safeToProceedWithManualFinalReadinessReview === true || safe.safeToProceedWithManualFinalReadinessReview === true,
      safeToProceedWithManualCandidateReview: workflow.safeToProceedWithManualCandidateReview === true || safe.safeToProceedWithManualCandidateReview === true,
      safeToProceedWithManualCandidateEvidenceReview: workflow.safeToProceedWithManualCandidateEvidenceReview === true || safe.safeToProceedWithManualCandidateEvidenceReview === true,
      safeToProceedWithManualQaFreezeReview: workflow.safeToProceedWithManualQaFreezeReview === true || safe.safeToProceedWithManualQaFreezeReview === true,
      safeToProceedWithManualQaFreezeReview: workflow.safeToProceedWithManualQaFreezeReview === true || safe.safeToProceedWithManualQaFreezeReview === true,
      ...
      safeToProceedWithHumanPublicBetaReview: workflow.safeToProceedWithHumanPublicBetaReview === true || safe.safeToProceedWithHumanPublicBetaReview === true,
  ...
  function buildSafetyQuoteEvidenceReport(input) {
    ...
    return clone({
      ...
      publicBetaTrialReadinessPackSummary: workflow.publicBetaTrialReadinessPackSummary || safe.publicBetaTrialReadinessPackSummary || null,
      ...
      publicBetaUserOnboardingShellSummary: workflow.publicBetaUserOnboardingShellSummary || safe.publicBetaUserOnboardingShellSummary || null,
      visualTrialGuideSummary: workflow.visualTrialGuideSummary || safe.visualTrialGuideSummary || null,
      safeFeedbackDraftPanelSummary: workflow.safeFeedbackDraftPanelSummary || safe.safeFeedbackDraftPanelSummary || null,
      publicBetaOnboardingViewModelSummary: workflow.publicBetaOnboardingViewModelSummary || safe.publicBetaOnboardingViewModelSummary || null,
      publicBetaRcConsoleSummary: workflow.publicBetaRcConsoleSummary || safe.publicBetaRcConsoleSummary || null,
      offlineTrialReleaseGateSummary: workflow.offlineTrialReleaseGateSummary || safe.offlineTrialReleaseGateSummary || null,
      publicBetaRcViewModelSummary: workflow.publicBetaRcViewModelSummary || safe.publicBetaRcViewModelSummary || null,
      publicBetaStabilityAuditSummary: workflow.publicBetaStabilityAuditSummary || safe.publicBetaStabilityAuditSummary || null,
