;(function () {
  ...
  const FLIGHT_WORKFLOW_EVENT_LEDGER_VERSION = "2.1.82";
  ...
  const DEFAULT_WORKFLOW_ID = "deterministic-flight-workflow-event-ledger-v2.1.82";
  ...
  function eventIdFor(index) { return "deterministic-flight-workflow-event-v2.1.82-" + String(index); }
