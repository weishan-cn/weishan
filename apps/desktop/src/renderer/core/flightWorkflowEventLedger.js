;(function () {
  ...
  const FLIGHT_WORKFLOW_EVENT_LEDGER_VERSION = "2.2.2";
  ...
  const DEFAULT_WORKFLOW_ID = "deterministic-flight-workflow-event-ledger-v2.2.2";
  ...
  function eventIdFor(index) { return "deterministic-flight-workflow-event-v2.2.2-" + String(index); }
