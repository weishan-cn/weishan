(function(){
  ...
  const AVAILABILITY_STATES = Object.freeze(["READY", "EXPERIMENTAL", "COMING_LATER", "FOUNDATION_PLANNED_NOT_READY_FOR_USER_EXECUTION", "CONNECTOR_FOUNDATION_NOT_READY_FOR_USER_EXECUTION", "INCOMPATIBLE", "REVOKED"]);
