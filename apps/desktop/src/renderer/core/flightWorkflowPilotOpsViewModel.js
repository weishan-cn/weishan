;(function () {
  ...
  const FLIGHT_WORKFLOW_PILOT_OPS_VIEW_MODEL_VERSION = "2.1.82";
  ...
  function buildFlightWorkflowPilotOpsViewModel(input) {
    try {
      ...
      return sanitizeFlightWorkflowPilotOpsViewModel({ status:"failed_safe", title:"只读试点运营摘要", cards:[], opsRows:[], decisionRows:[], riskRows:[], caveat:CAVEAT });
    }
  }
