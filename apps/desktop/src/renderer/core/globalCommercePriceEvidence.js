;(function () {
  ...
  const CONDITIONS = Object.freeze([
    ...
    "LOGIN_ONLY", "TAX_EXCLUSIVE", "SHIPPING_EXCLUSIVE", "BUNDLE", "SUBSCRIPTION",
    "GROUP_BUY", "FINANCING", "LOYALTY", "QUANTITY"
  ]);
  const HANDOFF_TYPES = Object.freeze([
    "OFFICIAL_MERCHANT_PRODUCT", "PROVIDER_REDIRECT", "AUTHORIZED_DEEPLINK", "PROVIDER_EVIDENCE_PAGE",
    "DIRECT_PRODUCT", "AFFILIATE_HANDOFF", "SEARCH_RESULTS_HANDOFF", "NONE"
  ]);
