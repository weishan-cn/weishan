;(function () {
  ...
  const FLIGHT_WORKFLOW_SAFETY_REGRESSION_SENTINEL_VERSION = "2.2.6";
  ...
  function buildFlightWorkflowSafetyRegressionReport(input) {
    try {
      ...
      const userManualReviewViewModelSummary = input.userManualReviewViewModelSummary || null;
