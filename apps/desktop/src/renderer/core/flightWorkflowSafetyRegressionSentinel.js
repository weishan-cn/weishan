;(function () {
  ...
  const FLIGHT_WORKFLOW_SAFETY_REGRESSION_SENTINEL_VERSION = "2.2.7";
  ...
  function buildFlightWorkflowSafetyRegressionReport(input) {
    try {
      ...
      const userManualReviewViewModelSummary = input.userManualReviewViewModelSummary || null; const manualPlatformVisitPreparationCenterSummary = input.manualPlatformVisitPreparationCenterSummary || null; const externalPlatformBoundaryBriefSummary = input.externalPlatformBoundaryBriefSummary || null; const finalUserSafetyChecklistSummary = input.finalUserSafetyChecklistSummary || null; const platformVisitPreparationViewModelSummary = input.platformVisitPreparationViewModelSummary || null;
