;(function () {
  ...
  const READ_ONLY_PRICE_CANDIDATE_CARD_VIEW_MODEL_VERSION = "2.1.99";
  ...
  function buildReadOnlyPriceCandidateCardViewModel(input) {
    ...
    return clone({
      ...
      sandboxProviderResponseContractSummary: sandboxProviderResponseContractSummary,
      pricePipelineOrchestratorSummary: pricePipelineOrchestratorSummary,
      readOnlyCandidateJourneySummary: readOnlyCandidateJourneySummary,
      providerFixtureViewModelSummary: providerFixtureViewModelSummary,
      priceSourceNormalizationSummary: priceSourceNormalizationSummary,
      officialPriceAnchorSummary: officialPriceAnchorSummary,
      priceCandidateDisplaySummary: priceCandidateDisplaySummary,
      ...
      pricePipelineStatus: pricePipelineStatus,
      readOnlyCandidateJourneyStatus: readOnlyCandidateJourneyStatus,
      ...
      safeToProceedWithFirstRealReadOnlyProviderSandbox: safeToProceedWithFirstRealReadOnlyProviderSandbox,
      ...
      safeToProceedWithRealReadOnlyProviderSandbox: safeToProceedWithRealReadOnlyProviderSandbox,
      rcReviewStatus: rcReviewStatus,
      rcEvidenceStatus: rcEvidenceStatus,
      rcRegressionStatus: rcRegressionStatus,
      releaseRiskStatus: releaseRiskStatus,
  ...
  function renderReadOnlyPriceCandidateCardHtml(input) {
    ...
    const providerCoverageHtml = card.providerCoverageViewModelSummary ? '<section class="commerce-global-shopping-provider-coverage" data-commerce-global-shopping-provider-coverage="true"><h5>Provider 覆盖与来源可信度</h5><p>第一个 Sandbox Provider Connector</p><p>Provider 覆盖看板</p><p>只读来源可信度评分</p><p>Sandbox Connector</p><p>来源覆盖</p><p>来源可信度</p><p>第一个 Sandbox Connector 已准备</p><p>Provider 覆盖结构已准备</p><p>来源可信度评分已准备</p><p>覆盖来源不代表全网覆盖</p><p>可信度不代表官方背书</p><p>低价不等于最佳</p><p>Provider 覆盖不代表下单能力</p><p>当前仅展示 fixture/dry-run/sandbox provider 覆盖和来源可信度</p><p>不代表全网覆盖、官方背书、真实价格或下单能力</p><button type="button" class="cmd-btn gray" data-commerce-global-shopping-first-sandbox-provider-connector-show="true">查看 Sandbox Connector</button><button type="button" class="cmd-btn gray" data-commerce-global-shopping-provider-coverage-show="true">查看 Provider 覆盖</button><button type="button" class="cmd-btn gray" data-commerce-global-shopping-source-trust-show="true">查看来源可信度</button><div data-commerce-global-shopping-first-sandbox-provider-connector-output="true"><p>第一个 Sandbox Provider Connector</p><p>' + escapeHtml(card.firstSandboxProviderConnectorSummary && card.firstSandboxProviderConnectorSummary.userFacingSummary && card.firstSandboxProviderConnectorSummary.userFacingSummary.resultLabel || 'Sandbox Connector 仍需复核') + '</p><p>bookingUrl:null</p><p>payment:false</p><p>order:false</p></div><div data-commerce-global-shopping-provider-coverage-output="true"><p>Provider 覆盖看板</p><p>' + escapeHtml(card.providerCoverageDashboardSummary && card.providerCoverageDashboardSummary.userFacingSummary && card.providerCoverageDashboardSummary.userFacingSummary.resultLabel || 'Provider 覆盖仍需复核') + '</p><p>覆盖来源不代表全网覆盖</p><p>bookingUrl:null</p><p>payment:false</p><p>order:false</p></div><div data-commerce-global-shopping-source-trust-output="true"><p>只读来源可信度评分</p><p>' + escapeHtml(card.readOnlySourceTrustScoreSummary && card.readOnlySourceTrustScoreSummary.userFacingSummary && card.readOnlySourceTrustScoreSummary.userFacingSummary.resultLabel || '来源可信度仍需复核') + '</p><p>可信度不代表官方背书</p><p>低价不等于最佳</p><p>bookingUrl:null</p><p>payment:false</p><p>order:false</p></div></section>' : '';
