;(function () {
  ...
  const READ_ONLY_PRICE_CANDIDATE_CARD_VIEW_MODEL_VERSION = "2.1.92";
  ...
  function buildReadOnlyPriceCandidateCardViewModel(input) {
    ...
    const compactOperatorConsoleSummary = compactSummary(operatorConsoleSummary, ["status", "userFacingSummary", "globalShoppingProductGoalSummary", "jumpToPlatformBoundarySummary", "sameItemMatcherSummary", "duplicateCandidateMergerSummary", "coveredLowestCandidateBoardSummary", "externalDeepLinkSafetySummary", "searchParameterPrefillSummary", "jumpToPlatformHandoffPreviewSummary", "sandboxDeepLinkCandidateSummary", "platformAvailabilitySummary", "partnerLinkPolicySummary", "sandboxHandoffViewModelSummary", "sameItemMatcherStatus", "duplicateMergeStatus", "coveredLowestStatus", "externalDeepLinkSafetyStatus", "searchPrefillStatus", "handoffPreviewStatus", "sandboxDeepLinkStatus", "platformAvailabilityStatus", "partnerLinkPolicyStatus", "sandboxHandoffStatus", "safeToProceedWithDeepLinkSafetyGate", "safeToProceedWithSandboxDeepLinkCandidate", "safeToProceedWithPartnerFixtureAdapter"]);
    ...
    const safeToProceedWithSandboxDeepLinkCandidate = safeToProceedWithDeepLinkSafetyGate === true && externalDeepLinkSafetyStatus === "safe" && searchPrefillStatus === "safe" && handoffPreviewStatus === "ready" && sandboxDeepLinkStatus === "ready";
