;(function () {
  ...
  const READ_ONLY_PRICE_CANDIDATE_CARD_VIEW_MODEL_VERSION = "2.1.81";
  ...
  function buildReadOnlyPriceCandidateCardViewModel(input) {
    ...
    workflowMeta = Object.assign({}, workflowMeta, { rolloutControlSummary:rolloutControlSummary, cohortHealthSummary:cohortHealthSummary, rolloutControlViewModel:rolloutControlViewModel, rolloutDecisionStatus:rolloutDecisionStatus, cohortHealthStatus:cohortHealthStatus, rolloutNextStep:rolloutNextStep });
