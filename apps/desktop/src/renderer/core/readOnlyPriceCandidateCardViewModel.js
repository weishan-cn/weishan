;(function () {
  ...
  const READ_ONLY_PRICE_CANDIDATE_CARD_VIEW_MODEL_VERSION = "4.2.8";
  ...
  function resolvedSummary(input, prepared, key) {
    const safe = obj(input);
    const preparedSafe = obj(prepared);
    if (safe[key] && typeof safe[key] === "object") return safe[key];
    if (preparedSafe[key] && typeof preparedSafe[key] === "object") return preparedSafe[key];
    return null;
  }
  ...
  function getGlobalShoppingProviderPublicTrustClosureCenterApi() { return window.WeishanGlobalShoppingProviderPublicTrustClosureCenter || {}; }
  function getGlobalShoppingOfflineReleaseMemorySnapshotApi() { return window.WeishanGlobalShoppingOfflineReleaseMemorySnapshot || {}; }
  function getGlobalShoppingNoProviderExecutionFinalGuardApi() { return window.WeishanGlobalShoppingNoProviderExecutionFinalGuard || {}; }
  function getGlobalShoppingUserVisibleSafetyBoundaryExplainerApi() { return window.WeishanGlobalShoppingUserVisibleSafetyBoundaryExplainer || {}; }
  function getGlobalShoppingProviderTrustClosureViewModelApi() { return window.WeishanGlobalShoppingProviderTrustClosureViewModel || {}; }
  function getGlobalShoppingProviderReadOnlyPublicReleaseCenterApi() { return window.WeishanGlobalShoppingProviderReadOnlyPublicReleaseCenter || {}; }
  function getGlobalShoppingTrustClosureExportPreviewApi() { return window.WeishanGlobalShoppingTrustClosureExportPreview || {}; }
  function getGlobalShoppingFinalNoProviderBoundaryReceiptApi() { return window.WeishanGlobalShoppingFinalNoProviderBoundaryReceipt || {}; }
  function getGlobalShoppingPublicSafetyStatementPreviewApi() { return window.WeishanGlobalShoppingPublicSafetyStatementPreview || {}; }
  function getGlobalShoppingProviderPublicReleaseViewModelApi() { return window.WeishanGlobalShoppingProviderPublicReleaseViewModel || {}; }
  function getGlobalShoppingPublicReleaseEvidenceConsoleApi() { return window.WeishanGlobalShoppingPublicReleaseEvidenceConsole || {}; }
  function getGlobalShoppingNoProviderUserAssurancePanelApi() { return window.WeishanGlobalShoppingNoProviderUserAssurancePanel || {}; }
  function getGlobalShoppingOfflineLaunchReadinessFinalizerApi() { return window.WeishanGlobalShoppingOfflineLaunchReadinessFinalizer || {}; }
  function getGlobalShoppingUserSafePublicClaimVerifierApi() { return window.WeishanGlobalShoppingUserSafePublicClaimVerifier || {}; }
  function getGlobalShoppingProviderLaunchReadinessFinalViewModelApi() { return window.WeishanGlobalShoppingProviderLaunchReadinessFinalViewModel || {}; }
  function getGlobalShoppingReadOnlyPublicBetaShellApi() { return window.WeishanGlobalShoppingReadOnlyPublicBetaShell || {}; }
  function getGlobalShoppingProviderZeroRuntimeLockApi() { return window.WeishanGlobalShoppingProviderZeroRuntimeLock || {}; }
  function getGlobalShoppingUserTrustLaunchBoardApi() { return window.WeishanGlobalShoppingUserTrustLaunchBoard || {}; }
  function getGlobalShoppingPublicBetaSafetyCopyCenterApi() { return window.WeishanGlobalShoppingPublicBetaSafetyCopyCenter || {}; }
  function getGlobalShoppingPublicBetaViewModelApi() { return window.WeishanGlobalShoppingPublicBetaViewModel || {}; }
  function getGlobalShoppingPublicBetaFinalGateApi() { return window.WeishanGlobalShoppingPublicBetaFinalGate || {}; }
  function getGlobalShoppingReleaseCandidateConfidenceBoardApi() { return window.WeishanGlobalShoppingReleaseCandidateConfidenceBoard || {}; }
  function getGlobalShoppingPublicBetaFinalViewModelApi() { return window.WeishanGlobalShoppingPublicBetaFinalViewModel || {}; }
  function getGlobalShoppingPublicBetaOperatorConsoleApi() { return window.WeishanGlobalShoppingPublicBetaOperatorConsole || {}; }
  function getGlobalShoppingCategoryExpansionShellApi() { return window.WeishanGlobalShoppingCategoryExpansionShell || {}; }
  function getGlobalShoppingFinalOfflineBetaAuditApi() { return window.WeishanGlobalShoppingFinalOfflineBetaAudit || {}; }
  function getGlobalShoppingPublicBetaAcceptanceBoardApi() { return window.WeishanGlobalShoppingPublicBetaAcceptanceBoard || {}; }
  function getGlobalShoppingPublicBetaOperatorViewModelApi() { return window.WeishanGlobalShoppingPublicBetaOperatorViewModel || {}; }
  function getGlobalShoppingPublicBetaUserJourneyShellApi() { return window.WeishanGlobalShoppingPublicBetaUserJourneyShell || {}; }
  function getGlobalShoppingSafeSearchIntentMatrixApi() { return window.WeishanGlobalShoppingSafeSearchIntentMatrix || {}; }
  function getGlobalShoppingPublicBetaUserBoundaryPanelApi() { return window.WeishanGlobalShoppingPublicBetaUserBoundaryPanel || {}; }
  function getGlobalShoppingCategoryResultSimulatorApi() { return window.WeishanGlobalShoppingCategoryResultSimulator || {}; }
  function getGlobalShoppingReadOnlyComparisonBoardApi() { return window.WeishanGlobalShoppingReadOnlyComparisonBoard || {}; }
  function getGlobalShoppingResultTrustBadgePanelApi() { return window.WeishanGlobalShoppingResultTrustBadgePanel || {}; }
  ...
  function buildReadOnlyPriceCandidateCardViewModel(input) {
    ...
    const globalShoppingProviderPublicTrustClosureCenterApi = getGlobalShoppingProviderPublicTrustClosureCenterApi();
    const globalShoppingOfflineReleaseMemorySnapshotApi = getGlobalShoppingOfflineReleaseMemorySnapshotApi();
    const globalShoppingNoProviderExecutionFinalGuardApi = getGlobalShoppingNoProviderExecutionFinalGuardApi();
    const globalShoppingUserVisibleSafetyBoundaryExplainerApi = getGlobalShoppingUserVisibleSafetyBoundaryExplainerApi();
    const globalShoppingProviderTrustClosureViewModelApi = getGlobalShoppingProviderTrustClosureViewModelApi();
    const globalShoppingProviderReadOnlyPublicReleaseCenterApi = getGlobalShoppingProviderReadOnlyPublicReleaseCenterApi();
    const globalShoppingTrustClosureExportPreviewApi = getGlobalShoppingTrustClosureExportPreviewApi();
    const globalShoppingFinalNoProviderBoundaryReceiptApi = getGlobalShoppingFinalNoProviderBoundaryReceiptApi();
    const globalShoppingPublicSafetyStatementPreviewApi = getGlobalShoppingPublicSafetyStatementPreviewApi();
    const globalShoppingProviderPublicReleaseViewModelApi = getGlobalShoppingProviderPublicReleaseViewModelApi();
    const globalShoppingPublicReleaseEvidenceConsoleApi = getGlobalShoppingPublicReleaseEvidenceConsoleApi();
    const globalShoppingNoProviderUserAssurancePanelApi = getGlobalShoppingNoProviderUserAssurancePanelApi();
    const globalShoppingOfflineLaunchReadinessFinalizerApi = getGlobalShoppingOfflineLaunchReadinessFinalizerApi();
    const globalShoppingUserSafePublicClaimVerifierApi = getGlobalShoppingUserSafePublicClaimVerifierApi();
    const globalShoppingProviderLaunchReadinessFinalViewModelApi = getGlobalShoppingProviderLaunchReadinessFinalViewModelApi();
    const globalShoppingReadOnlyPublicBetaShellApi = getGlobalShoppingReadOnlyPublicBetaShellApi();
    const globalShoppingProviderZeroRuntimeLockApi = getGlobalShoppingProviderZeroRuntimeLockApi();
    const globalShoppingUserTrustLaunchBoardApi = getGlobalShoppingUserTrustLaunchBoardApi();
    const globalShoppingPublicBetaSafetyCopyCenterApi = getGlobalShoppingPublicBetaSafetyCopyCenterApi();
    const globalShoppingPublicBetaViewModelApi = getGlobalShoppingPublicBetaViewModelApi();
    const globalShoppingPublicBetaFinalGateApi = getGlobalShoppingPublicBetaFinalGateApi();
    const globalShoppingReleaseCandidateConfidenceBoardApi = getGlobalShoppingReleaseCandidateConfidenceBoardApi();
    const globalShoppingPublicBetaFinalViewModelApi = getGlobalShoppingPublicBetaFinalViewModelApi();
    const globalShoppingPublicBetaOperatorConsoleApi = getGlobalShoppingPublicBetaOperatorConsoleApi();
    const globalShoppingCategoryExpansionShellApi = getGlobalShoppingCategoryExpansionShellApi();
    const globalShoppingFinalOfflineBetaAuditApi = getGlobalShoppingFinalOfflineBetaAuditApi();
    const globalShoppingPublicBetaAcceptanceBoardApi = getGlobalShoppingPublicBetaAcceptanceBoardApi();
    const globalShoppingPublicBetaOperatorViewModelApi = getGlobalShoppingPublicBetaOperatorViewModelApi();
    ...
    // This card is a presentation boundary. It must consume an already-resolved
    // pipeline summary instead of recursively constructing the provider graph.
    const pricePipelineOrchestratorSummary = resolvedSummary(safe, compactOperatorConsoleSummary, "pricePipelineOrchestratorSummary");
    ...
    const finalizedPricePipelineOrchestratorSummary = pricePipelineOrchestratorSummary;
    ...
    const readOnlyPlatformHandoffSimulatorSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "readOnlyPlatformHandoffSimulatorSummary");
    const redactedSearchParameterPackSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "redactedSearchParameterPackSummary");
    const userConfirmationChecklistSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "userConfirmationChecklistSummary");
    const platformHandoffSimulationViewModelSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "platformHandoffSimulationViewModelSummary");
    ...
    const readOnlyHandoffPacketPreviewSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "readOnlyHandoffPacketPreviewSummary");
    const platformPreflightSafetyGateSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "platformPreflightSafetyGateSummary");
    const userActionBoundaryReceiptSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "userActionBoundaryReceiptSummary");
    const handoffPacketViewModelSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "handoffPacketViewModelSummary");
    ...
    const manualPlatformReviewCockpitSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "manualPlatformReviewCockpitSummary");
    const handoffAcceptanceWalkthroughSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "handoffAcceptanceWalkthroughSummary");
    const platformRealityCheckBoardSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "platformRealityCheckBoardSummary");
    const manualPlatformReviewViewModelSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "manualPlatformReviewViewModelSummary");
    ...
    const userFacingManualReviewFlowSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "userFacingManualReviewFlowSummary");
    const platformVerificationProgressTrackerSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "platformVerificationProgressTrackerSummary");
    const safeNextActionPanelSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "safeNextActionPanelSummary");
    const userManualReviewViewModelSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "userManualReviewViewModelSummary");
    ...
    const externalPlatformBoundaryBriefSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "externalPlatformBoundaryBriefSummary");
    const finalUserSafetyChecklistSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "finalUserSafetyChecklistSummary");
    const manualPlatformVisitPreparationCenterSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "manualPlatformVisitPreparationCenterSummary");
    const platformVisitPreparationViewModelSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "platformVisitPreparationViewModelSummary");
    const externalPlatformExitRampPreviewSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "externalPlatformExitRampPreviewSummary");
    const manualVisitSafetyBriefSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "manualVisitSafetyBriefSummary");
    const readOnlySessionClosurePackSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "readOnlySessionClosurePackSummary");
    const externalPlatformExitViewModelSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "externalPlatformExitViewModelSummary");
    const readOnlyCommerceSessionRecapCenterSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "readOnlyCommerceSessionRecapCenterSummary");
    const userTrustClosureSummarySummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "userTrustClosureSummarySummary");
    const nextFeatureReadinessGateSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "nextFeatureReadinessGateSummary");
    const commerceSessionRecapViewModelSummary = resolvedSummary(safe, finalizedPricePipelineOrchestratorSummary, "commerceSessionRecapViewModelSummary");
    ...
    const providerPublicTrustClosureCenterSummary = safe.providerPublicTrustClosureCenterSummary && typeof safe.providerPublicTrustClosureCenterSummary === "object" ? safe.providerPublicTrustClosureCenterSummary : (typeof globalShoppingProviderPublicTrustClosureCenterApi.buildGlobalShoppingProviderPublicTrustClosureCenter === "function" ? globalShoppingProviderPublicTrustClosureCenterApi.buildGlobalShoppingProviderPublicTrustClosureCenter({ providerDistributionFreezeConsoleSummary:providerDistributionFreezeConsoleSummary, userFacingSafetyReceiptSummary:userFacingSafetyReceiptSummary, offlineReleaseCandidateClosurePackSummary:offlineReleaseCandidateClosurePackSummary, providerNoProductionGuaranteeMatrixSummary:providerNoProductionGuaranteeMatrixSummary, providerDistributionClosureViewModelSummary:providerDistributionClosureViewModelSummary }) : null);
    const providerPublicTrustClosureCenterStatus = text(providerPublicTrustClosureCenterSummary && providerPublicTrustClosureCenterSummary.status || "");
    const offlineReleaseMemorySnapshotSummary = safe.offlineReleaseMemorySnapshotSummary && typeof safe.offlineReleaseMemorySnapshotSummary === "object" ? safe.offlineReleaseMemorySnapshotSummary : (typeof globalShoppingOfflineReleaseMemorySnapshotApi.buildGlobalShoppingOfflineReleaseMemorySnapshot === "function" ? globalShoppingOfflineReleaseMemorySnapshotApi.buildGlobalShoppingOfflineReleaseMemorySnapshot({ providerPublicTrustClosureCenterSummary:providerPublicTrustClosureCenterSummary, providerDistributionFreezeConsoleSummary:providerDistributionFreezeConsoleSummary, finalUserTrustSummarySummary:finalUserTrustSummarySummary, readOnlyReleaseEvidenceSummary:readOnlyReleaseEvidenceSummary, verifyE2eBuildSummary:verifyE2eBuildSummary }) : null);
    const offlineReleaseMemorySnapshotStatus = text(offlineReleaseMemorySnapshotSummary && offlineReleaseMemorySnapshotSummary.status || "");
    const noProviderExecutionFinalGuardSummary = safe.noProviderExecutionFinalGuardSummary && typeof safe.noProviderExecutionFinalGuardSummary === "object" ? safe.noProviderExecutionFinalGuardSummary : (typeof globalShoppingNoProviderExecutionFinalGuardApi.buildGlobalShoppingNoProviderExecutionFinalGuard === "function" ? globalShoppingNoProviderExecutionFinalGuardApi.buildGlobalShoppingNoProviderExecutionFinalGuard({ providerPublicTrustClosureCenterSummary:providerPublicTrustClosureCenterSummary, offlineReleaseMemorySnapshotSummary:offlineReleaseMemorySnapshotSummary, providerNoProductionGuaranteeMatrixSummary:providerNoProductionGuaranteeMatrixSummary, noActivationEnforcementLedgerSummary:noActivationEnforcementLedgerSummary, safetySentinelSummary:safetyRegressionSummary }) : null);
    const noProviderExecutionFinalGuardStatus = text(noProviderExecutionFinalGuardSummary && noProviderExecutionFinalGuardSummary.status || "");
    const userVisibleSafetyBoundaryExplainerSummary = safe.userVisibleSafetyBoundaryExplainerSummary && typeof safe.userVisibleSafetyBoundaryExplainerSummary === "object" ? safe.userVisibleSafetyBoundaryExplainerSummary : (typeof globalShoppingUserVisibleSafetyBoundaryExplainerApi.buildGlobalShoppingUserVisibleSafetyBoundaryExplainer === "function" ? globalShoppingUserVisibleSafetyBoundaryExplainerApi.buildGlobalShoppingUserVisibleSafetyBoundaryExplainer({ providerPublicTrustClosureCenterSummary:providerPublicTrustClosureCenterSummary, offlineReleaseMemorySnapshotSummary:offlineReleaseMemorySnapshotSummary, noProviderExecutionFinalGuardSummary:noProviderExecutionFinalGuardSummary, userFacingSafetyReceiptSummary:userFacingSafetyReceiptSummary, finalUserTrustSummarySummary:finalUserTrustSummarySummary }) : null);
    const userVisibleSafetyBoundaryExplainerStatus = text(userVisibleSafetyBoundaryExplainerSummary && userVisibleSafetyBoundaryExplainerSummary.status || "");
    const providerTrustClosureViewModelSummary = safe.providerTrustClosureViewModelSummary && typeof safe.providerTrustClosureViewModelSummary === "object" ? safe.providerTrustClosureViewModelSummary : (typeof globalShoppingProviderTrustClosureViewModelApi.buildGlobalShoppingProviderTrustClosureViewModel === "function" ? globalShoppingProviderTrustClosureViewModelApi.buildGlobalShoppingProviderTrustClosureViewModel({ providerPublicTrustClosureCenterSummary:providerPublicTrustClosureCenterSummary, offlineReleaseMemorySnapshotSummary:offlineReleaseMemorySnapshotSummary, noProviderExecutionFinalGuardSummary:noProviderExecutionFinalGuardSummary, userVisibleSafetyBoundaryExplainerSummary:userVisibleSafetyBoundaryExplainerSummary }) : null);
    const providerTrustClosureViewModelStatus = text(providerTrustClosureViewModelSummary && providerTrustClosureViewModelSummary.status || "");
    const safeToProceedWithHumanTrustClosureReview = providerTrustClosureViewModelStatus === "ready";
    const providerReadOnlyPublicReleaseCenterSummary = safe.providerReadOnlyPublicReleaseCenterSummary && typeof safe.providerReadOnlyPublicReleaseCenterSummary === "object" ? safe.providerReadOnlyPublicReleaseCenterSummary : (typeof globalShoppingProviderReadOnlyPublicReleaseCenterApi.buildGlobalShoppingProviderReadOnlyPublicReleaseCenter === "function" ? globalShoppingProviderReadOnlyPublicReleaseCenterApi.buildGlobalShoppingProviderReadOnlyPublicReleaseCenter({ providerPublicTrustClosureCenterSummary:providerPublicTrustClosureCenterSummary, offlineReleaseMemorySnapshotSummary:offlineReleaseMemorySnapshotSummary, noProviderExecutionFinalGuardSummary:noProviderExecutionFinalGuardSummary, userVisibleSafetyBoundaryExplainerSummary:userVisibleSafetyBoundaryExplainerSummary, providerTrustClosureViewModelSummary:providerTrustClosureViewModelSummary }) : null);
    const providerReadOnlyPublicReleaseCenterStatus = text(providerReadOnlyPublicReleaseCenterSummary && providerReadOnlyPublicReleaseCenterSummary.status || "");
    const trustClosureExportPreviewSummary = safe.trustClosureExportPreviewSummary && typeof safe.trustClosureExportPreviewSummary === "object" ? safe.trustClosureExportPreviewSummary : (typeof globalShoppingTrustClosureExportPreviewApi.buildGlobalShoppingTrustClosureExportPreview === "function" ? globalShoppingTrustClosureExportPreviewApi.buildGlobalShoppingTrustClosureExportPreview({ providerReadOnlyPublicReleaseCenterSummary:providerReadOnlyPublicReleaseCenterSummary, providerPublicTrustClosureCenterSummary:providerPublicTrustClosureCenterSummary, offlineReleaseMemorySnapshotSummary:offlineReleaseMemorySnapshotSummary, finalUserTrustSummarySummary:finalUserTrustSummarySummary, readOnlyReleaseEvidenceSummary:readOnlyReleaseEvidenceSummary }) : null);
    const trustClosureExportPreviewStatus = text(trustClosureExportPreviewSummary && trustClosureExportPreviewSummary.status || "");
    const finalNoProviderBoundaryReceiptSummary = safe.finalNoProviderBoundaryReceiptSummary && typeof safe.finalNoProviderBoundaryReceiptSummary === "object" ? safe.finalNoProviderBoundaryReceiptSummary : (typeof globalShoppingFinalNoProviderBoundaryReceiptApi.buildGlobalShoppingFinalNoProviderBoundaryReceipt === "function" ? globalShoppingFinalNoProviderBoundaryReceiptApi.buildGlobalShoppingFinalNoProviderBoundaryReceipt({ providerReadOnlyPublicReleaseCenterSummary:providerReadOnlyPublicReleaseCenterSummary, trustClosureExportPreviewSummary:trustClosureExportPreviewSummary, noProviderExecutionFinalGuardSummary:noProviderExecutionFinalGuardSummary, providerNoActivationGuaranteeBoardSummary:providerNoActivationGuaranteeBoardSummary, safetySentinelSummary:safetyRegressionSummary }) : null);
    const finalNoProviderBoundaryReceiptStatus = text(finalNoProviderBoundaryReceiptSummary && finalNoProviderBoundaryReceiptSummary.status || "");
    const publicSafetyStatementPreviewSummary = safe.publicSafetyStatementPreviewSummary && typeof safe.publicSafetyStatementPreviewSummary === "object" ? safe.publicSafetyStatementPreviewSummary : (typeof globalShoppingPublicSafetyStatementPreviewApi.buildGlobalShoppingPublicSafetyStatementPreview === "function" ? globalShoppingPublicSafetyStatementPreviewApi.buildGlobalShoppingPublicSafetyStatementPreview({ providerReadOnlyPublicReleaseCenterSummary:providerReadOnlyPublicReleaseCenterSummary, finalNoProviderBoundaryReceiptSummary:finalNoProviderBoundaryReceiptSummary, userVisibleSafetyBoundaryExplainerSummary:userVisibleSafetyBoundaryExplainerSummary, userFacingSafetyReceiptSummary:userFacingSafetyReceiptSummary, finalUserTrustSummarySummary:finalUserTrustSummarySummary }) : null);
    const publicSafetyStatementPreviewStatus = text(publicSafetyStatementPreviewSummary && publicSafetyStatementPreviewSummary.status || "");
    const providerPublicReleaseViewModelSummary = safe.providerPublicReleaseViewModelSummary && typeof safe.providerPublicReleaseViewModelSummary === "object" ? safe.providerPublicReleaseViewModelSummary : (typeof globalShoppingProviderPublicReleaseViewModelApi.buildGlobalShoppingProviderPublicReleaseViewModel === "function" ? globalShoppingProviderPublicReleaseViewModelApi.buildGlobalShoppingProviderPublicReleaseViewModel({ providerReadOnlyPublicReleaseCenterSummary:providerReadOnlyPublicReleaseCenterSummary, trustClosureExportPreviewSummary:trustClosureExportPreviewSummary, finalNoProviderBoundaryReceiptSummary:finalNoProviderBoundaryReceiptSummary, publicSafetyStatementPreviewSummary:publicSafetyStatementPreviewSummary }) : null);
    const providerPublicReleaseViewModelStatus = text(providerPublicReleaseViewModelSummary && providerPublicReleaseViewModelSummary.status || "");
    const safeToProceedWithHumanPublicReleaseReview = providerPublicReleaseViewModelStatus === "ready";
    const publicReleaseEvidenceConsoleSummary = safe.publicReleaseEvidenceConsoleSummary && typeof safe.publicReleaseEvidenceConsoleSummary === "object" ? safe.publicReleaseEvidenceConsoleSummary : (typeof globalShoppingPublicReleaseEvidenceConsoleApi.buildGlobalShoppingPublicReleaseEvidenceConsole === "function" ? globalShoppingPublicReleaseEvidenceConsoleApi.buildGlobalShoppingPublicReleaseEvidenceConsole({ providerReadOnlyPublicReleaseCenterSummary:providerReadOnlyPublicReleaseCenterSummary, trustClosureExportPreviewSummary:trustClosureExportPreviewSummary, finalNoProviderBoundaryReceiptSummary:finalNoProviderBoundaryReceiptSummary, publicSafetyStatementPreviewSummary:publicSafetyStatementPreviewSummary, providerPublicReleaseViewModelSummary:providerPublicReleaseViewModelSummary, verifyE2eBuildSummary:verifyE2eBuildSummary }) : null);
    const publicReleaseEvidenceConsoleStatus = text(publicReleaseEvidenceConsoleSummary && publicReleaseEvidenceConsoleSummary.status || "");
    const noProviderUserAssurancePanelSummary = safe.noProviderUserAssurancePanelSummary && typeof safe.noProviderUserAssurancePanelSummary === "object" ? safe.noProviderUserAssurancePanelSummary : (typeof globalShoppingNoProviderUserAssurancePanelApi.buildGlobalShoppingNoProviderUserAssurancePanel === "function" ? globalShoppingNoProviderUserAssurancePanelApi.buildGlobalShoppingNoProviderUserAssurancePanel({ publicReleaseEvidenceConsoleSummary:publicReleaseEvidenceConsoleSummary, finalNoProviderBoundaryReceiptSummary:finalNoProviderBoundaryReceiptSummary, noProviderExecutionFinalGuardSummary:noProviderExecutionFinalGuardSummary, userVisibleSafetyBoundaryExplainerSummary:userVisibleSafetyBoundaryExplainerSummary, finalUserTrustSummarySummary:finalUserTrustSummarySummary }) : null);
    const noProviderUserAssurancePanelStatus = text(noProviderUserAssurancePanelSummary && noProviderUserAssurancePanelSummary.status || "");
    const offlineLaunchReadinessFinalizerSummary = safe.offlineLaunchReadinessFinalizerSummary && typeof safe.offlineLaunchReadinessFinalizerSummary === "object" ? safe.offlineLaunchReadinessFinalizerSummary : (typeof globalShoppingOfflineLaunchReadinessFinalizerApi.buildGlobalShoppingOfflineLaunchReadinessFinalizer === "function" ? globalShoppingOfflineLaunchReadinessFinalizerApi.buildGlobalShoppingOfflineLaunchReadinessFinalizer({ publicReleaseEvidenceConsoleSummary:publicReleaseEvidenceConsoleSummary, noProviderUserAssurancePanelSummary:noProviderUserAssurancePanelSummary, offlineReleaseMemorySnapshotSummary:offlineReleaseMemorySnapshotSummary, readOnlyReleaseEvidenceSummary:readOnlyReleaseEvidenceSummary, verifyE2eBuildSummary:verifyE2eBuildSummary }) : null);
    const offlineLaunchReadinessFinalizerStatus = text(offlineLaunchReadinessFinalizerSummary && offlineLaunchReadinessFinalizerSummary.status || "");
    const userSafePublicClaimVerifierSummary = safe.userSafePublicClaimVerifierSummary && typeof safe.userSafePublicClaimVerifierSummary === "object" ? safe.userSafePublicClaimVerifierSummary : (typeof globalShoppingUserSafePublicClaimVerifierApi.buildGlobalShoppingUserSafePublicClaimVerifier === "function" ? globalShoppingUserSafePublicClaimVerifierApi.buildGlobalShoppingUserSafePublicClaimVerifier({ publicReleaseEvidenceConsoleSummary:publicReleaseEvidenceConsoleSummary, noProviderUserAssurancePanelSummary:noProviderUserAssurancePanelSummary, offlineLaunchReadinessFinalizerSummary:offlineLaunchReadinessFinalizerSummary, publicSafetyStatementPreviewSummary:publicSafetyStatementPreviewSummary, userVisibleSafetyBoundaryExplainerSummary:userVisibleSafetyBoundaryExplainerSummary }) : null);
    const userSafePublicClaimVerifierStatus = text(userSafePublicClaimVerifierSummary && userSafePublicClaimVerifierSummary.status || "");
    const providerLaunchReadinessFinalViewModelSummary = safe.providerLaunchReadinessFinalViewModelSummary && typeof safe.providerLaunchReadinessFinalViewModelSummary === "object" ? safe.providerLaunchReadinessFinalViewModelSummary : (typeof globalShoppingProviderLaunchReadinessFinalViewModelApi.buildGlobalShoppingProviderLaunchReadinessFinalViewModel === "function" ? globalShoppingProviderLaunchReadinessFinalViewModelApi.buildGlobalShoppingProviderLaunchReadinessFinalViewModel({ publicReleaseEvidenceConsoleSummary:publicReleaseEvidenceConsoleSummary, noProviderUserAssurancePanelSummary:noProviderUserAssurancePanelSummary, offlineLaunchReadinessFinalizerSummary:offlineLaunchReadinessFinalizerSummary, userSafePublicClaimVerifierSummary:userSafePublicClaimVerifierSummary }) : null);
    const providerLaunchReadinessFinalViewModelStatus = text(providerLaunchReadinessFinalViewModelSummary && providerLaunchReadinessFinalViewModelSummary.status || "");
    const safeToProceedWithHumanLaunchReadinessFinalReview = providerLaunchReadinessFinalViewModelStatus === "ready";
    const globalShoppingReadOnlyPublicBetaShellSummary = safe.globalShoppingReadOnlyPublicBetaShellSummary && typeof safe.globalShoppingReadOnlyPublicBetaShellSummary === "object" ? safe.globalShoppingReadOnlyPublicBetaShellSummary : (typeof globalShoppingReadOnlyPublicBetaShellApi.buildGlobalShoppingReadOnlyPublicBetaShell === "function" ? globalShoppingReadOnlyPublicBetaShellApi.buildGlobalShoppingReadOnlyPublicBetaShell({ publicReleaseEvidenceConsoleSummary:publicReleaseEvidenceConsoleSummary, noProviderUserAssurancePanelSummary:noProviderUserAssurancePanelSummary, offlineLaunchReadinessFinalizerSummary:offlineLaunchReadinessFinalizerSummary, userSafePublicClaimVerifierSummary:userSafePublicClaimVerifierSummary, providerLaunchReadinessFinalViewModelSummary:providerLaunchReadinessFinalViewModelSummary }) : null);
    const globalShoppingReadOnlyPublicBetaShellStatus = text(globalShoppingReadOnlyPublicBetaShellSummary && globalShoppingReadOnlyPublicBetaShellSummary.status || "");
    const providerZeroRuntimeLockSummary = safe.providerZeroRuntimeLockSummary && typeof safe.providerZeroRuntimeLockSummary === "object" ? safe.providerZeroRuntimeLockSummary : (typeof globalShoppingProviderZeroRuntimeLockApi.buildGlobalShoppingProviderZeroRuntimeLock === "function" ? globalShoppingProviderZeroRuntimeLockApi.buildGlobalShoppingProviderZeroRuntimeLock({ globalShoppingReadOnlyPublicBetaShellSummary:globalShoppingReadOnlyPublicBetaShellSummary, noProviderUserAssurancePanelSummary:noProviderUserAssurancePanelSummary, noProviderExecutionFinalGuardSummary:noProviderExecutionFinalGuardSummary, providerNoProductionGuaranteeMatrixSummary:providerNoProductionGuaranteeMatrixSummary, safetyRegressionSummary:safetyRegressionSummary }) : null);
    const providerZeroRuntimeLockStatus = text(providerZeroRuntimeLockSummary && providerZeroRuntimeLockSummary.status || "");
    const globalShoppingReadOnlyCandidateEvidenceUnifierApi = window.WeishanGlobalShoppingReadOnlyCandidateEvidenceUnifier || {};
    const globalShoppingReadOnlyCandidateEvidenceUnifierSummary = safe.globalShoppingReadOnlyCandidateEvidenceUnifierSummary && typeof safe.globalShoppingReadOnlyCandidateEvidenceUnifierSummary === "object" ? safe.globalShoppingReadOnlyCandidateEvidenceUnifierSummary : (typeof globalShoppingReadOnlyCandidateEvidenceUnifierApi.buildGlobalShoppingReadOnlyCandidateEvidenceUnifier === "function" ? globalShoppingReadOnlyCandidateEvidenceUnifierApi.buildGlobalShoppingReadOnlyCandidateEvidenceUnifier({ candidateId:selectedCandidate && selectedCandidate.quoteId || priceQuote && priceQuote.quoteId || "candidate-evidence", category:"全球购候选价", sourceLabel:selectedCandidate && (selectedCandidate.providerName || selectedCandidate.sourceLabel) || source.providerName || "来源待补充", observedPrice:selectedCandidate && selectedCandidate.totalPrice || priceQuote.totalPrice || null, normalizedPrice:selectedCandidate && selectedCandidate.totalPrice || priceQuote.totalPrice || null, currency:selectedCandidate && selectedCandidate.currency || priceQuote.currency || "CNY", taxIncluded:selectedCandidate && selectedCandidate.taxesAndFees != null ? true : null, shippingIncluded:false, serviceFeeIncluded:selectedCandidate && selectedCandidate.providerFees != null ? true : null, officialAnchorAvailable:!!officialPriceAnchorSummary, evidenceTimestampLabel:selectedCandidate && (selectedCandidate.observedAtLabel || selectedCandidate.selectedSourceSummary) || "来源与时间待补充", trustLevel:"needs_review", riskNotes:["当前仍为只读候选证据"] }) : null);
    const globalShoppingReadOnlyCandidateEvidenceUnifierStatus = text(globalShoppingReadOnlyCandidateEvidenceUnifierSummary && globalShoppingReadOnlyCandidateEvidenceUnifierSummary.status || "");
    const globalShoppingFeeNormalizationViewApi = window.WeishanGlobalShoppingFeeNormalizationView || {};
    const globalShoppingFeeNormalizationViewSummary = safe.globalShoppingFeeNormalizationViewSummary && typeof safe.globalShoppingFeeNormalizationViewSummary === "object" ? safe.globalShoppingFeeNormalizationViewSummary : (typeof globalShoppingFeeNormalizationViewApi.buildGlobalShoppingFeeNormalizationView === "function" ? globalShoppingFeeNormalizationViewApi.buildGlobalShoppingFeeNormalizationView({ currency:selectedCandidate && selectedCandidate.currency || priceQuote.currency || "CNY", normalizedPrice:selectedCandidate && selectedCandidate.totalPrice || priceQuote.totalPrice || null, taxIncluded:selectedCandidate && selectedCandidate.taxesAndFees != null ? true : null, shippingIncluded:false, serviceFeeIncluded:selectedCandidate && selectedCandidate.providerFees != null ? true : null, serviceFeeNote:selectedCandidate && selectedCandidate.providerFees != null ? "服务费说明已脱敏" : "服务费说明待补充" }) : null);
    const globalShoppingFeeNormalizationViewStatus = text(globalShoppingFeeNormalizationViewSummary && globalShoppingFeeNormalizationViewSummary.status || "");
    const globalShoppingOfficialAnchorComparisonViewApi = window.WeishanGlobalShoppingOfficialAnchorComparisonView || {};
    const globalShoppingOfficialAnchorComparisonViewSummary = safe.globalShoppingOfficialAnchorComparisonViewSummary && typeof safe.globalShoppingOfficialAnchorComparisonViewSummary === "object" ? safe.globalShoppingOfficialAnchorComparisonViewSummary : (typeof globalShoppingOfficialAnchorComparisonViewApi.buildGlobalShoppingOfficialAnchorComparisonView === "function" ? globalShoppingOfficialAnchorComparisonViewApi.buildGlobalShoppingOfficialAnchorComparisonView({ officialAnchorLabel:"官方价锚点", officialAnchorPrice:officialPriceAnchorSummary && officialPriceAnchorSummary.anchorPrice || null, currency:selectedCandidate && selectedCandidate.currency || priceQuote.currency || "CNY", comparisonNote:"以平台实时页面为准", sourceAndTime:selectedCandidate && (selectedCandidate.selectedSourceSummary || selectedCandidate.observedAtLabel) || "来源与时间待补充" }) : null);
    const globalShoppingOfficialAnchorComparisonViewStatus = text(globalShoppingOfficialAnchorComparisonViewSummary && globalShoppingOfficialAnchorComparisonViewSummary.status || "");
    const globalShoppingProviderZeroStatusPanelApi = window.WeishanGlobalShoppingProviderZeroStatusPanel || {};
    const globalShoppingProviderZeroStatusPanelSummary = safe.globalShoppingProviderZeroStatusPanelSummary && typeof safe.globalShoppingProviderZeroStatusPanelSummary === "object" ? safe.globalShoppingProviderZeroStatusPanelSummary : (typeof globalShoppingProviderZeroStatusPanelApi.buildGlobalShoppingProviderZeroStatusPanel === "function" ? globalShoppingProviderZeroStatusPanelApi.buildGlobalShoppingProviderZeroStatusPanel({ globalShoppingReadOnlyPublicBetaShellSummary:globalShoppingReadOnlyPublicBetaShellSummary, providerZeroRuntimeLockSummary:providerZeroRuntimeLockSummary }) : null);
    const globalShoppingProviderZeroStatusPanelStatus = text(globalShoppingProviderZeroStatusPanelSummary && globalShoppingProviderZeroStatusPanelSummary.status || "");
    const userTrustLaunchBoardSummary = safe.userTrustLaunchBoardSummary && typeof safe.userTrustLaunchBoardSummary === "object" ? safe.userTrustLaunchBoardSummary : (typeof globalShoppingUserTrustLaunchBoardApi.buildGlobalShoppingUserTrustLaunchBoard === "function" ? globalShoppingUserTrustLaunchBoardApi.buildGlobalShoppingUserTrustLaunchBoard({ globalShoppingReadOnlyPublicBetaShellSummary:globalShoppingReadOnlyPublicBetaShellSummary, providerZeroRuntimeLockSummary:providerZeroRuntimeLockSummary, finalUserTrustSummarySummary:finalUserTrustSummarySummary, userVisibleSafetyBoundaryExplainerSummary:userVisibleSafetyBoundaryExplainerSummary, publicSafetyStatementPreviewSummary:publicSafetyStatementPreviewSummary }) : null);
    const userTrustLaunchBoardStatus = text(userTrustLaunchBoardSummary && userTrustLaunchBoardSummary.status || "");
    const publicBetaSafetyCopyCenterSummary = safe.publicBetaSafetyCopyCenterSummary && typeof safe.publicBetaSafetyCopyCenterSummary === "object" ? safe.publicBetaSafetyCopyCenterSummary : (typeof globalShoppingPublicBetaSafetyCopyCenterApi.buildGlobalShoppingPublicBetaSafetyCopyCenter === "function" ? globalShoppingPublicBetaSafetyCopyCenterApi.buildGlobalShoppingPublicBetaSafetyCopyCenter({ globalShoppingReadOnlyPublicBetaShellSummary:globalShoppingReadOnlyPublicBetaShellSummary, providerZeroRuntimeLockSummary:providerZeroRuntimeLockSummary, userTrustLaunchBoardSummary:userTrustLaunchBoardSummary, userSafePublicClaimVerifierSummary:userSafePublicClaimVerifierSummary, publicSafetyStatementPreviewSummary:publicSafetyStatementPreviewSummary }) : null);
    const publicBetaSafetyCopyCenterStatus = text(publicBetaSafetyCopyCenterSummary && publicBetaSafetyCopyCenterSummary.status || "");
    const globalShoppingPublicBetaUserFacingCopyPolishApi = window.WeishanGlobalShoppingPublicBetaUserFacingCopyPolish || {};
    const globalShoppingPublicBetaUserFacingCopyPolishSummary = safe.globalShoppingPublicBetaUserFacingCopyPolishSummary && typeof safe.globalShoppingPublicBetaUserFacingCopyPolishSummary === "object" ? safe.globalShoppingPublicBetaUserFacingCopyPolishSummary : (typeof globalShoppingPublicBetaUserFacingCopyPolishApi.buildGlobalShoppingPublicBetaUserFacingCopyPolish === "function" ? globalShoppingPublicBetaUserFacingCopyPolishApi.buildGlobalShoppingPublicBetaUserFacingCopyPolish({ globalShoppingReadOnlyPublicBetaShellSummary:globalShoppingReadOnlyPublicBetaShellSummary, globalShoppingReadOnlyCandidateEvidenceUnifierSummary:globalShoppingReadOnlyCandidateEvidenceUnifierSummary, globalShoppingFeeNormalizationViewSummary:globalShoppingFeeNormalizationViewSummary, globalShoppingOfficialAnchorComparisonViewSummary:globalShoppingOfficialAnchorComparisonViewSummary, publicBetaSafetyCopyCenterSummary:publicBetaSafetyCopyCenterSummary, userTrustLaunchBoardSummary:userTrustLaunchBoardSummary }) : null);
    const globalShoppingPublicBetaUserFacingCopyPolishStatus = text(globalShoppingPublicBetaUserFacingCopyPolishSummary && globalShoppingPublicBetaUserFacingCopyPolishSummary.status || "");
    const globalShoppingPublicBetaViewModelSummary = safe.globalShoppingPublicBetaViewModelSummary && typeof safe.globalShoppingPublicBetaViewModelSummary === "object" ? safe.globalShoppingPublicBetaViewModelSummary : (typeof globalShoppingPublicBetaViewModelApi.buildGlobalShoppingPublicBetaViewModel === "function" ? globalShoppingPublicBetaViewModelApi.buildGlobalShoppingPublicBetaViewModel({ globalShoppingReadOnlyPublicBetaShellSummary:globalShoppingReadOnlyPublicBetaShellSummary, providerZeroRuntimeLockSummary:providerZeroRuntimeLockSummary, userTrustLaunchBoardSummary:userTrustLaunchBoardSummary, publicBetaSafetyCopyCenterSummary:publicBetaSafetyCopyCenterSummary, globalShoppingPublicBetaUserFacingCopyPolishSummary:globalShoppingPublicBetaUserFacingCopyPolishSummary, globalShoppingProviderZeroStatusPanelSummary:globalShoppingProviderZeroStatusPanelSummary, globalShoppingReadOnlyCandidateEvidenceUnifierSummary:globalShoppingReadOnlyCandidateEvidenceUnifierSummary, globalShoppingFeeNormalizationViewSummary:globalShoppingFeeNormalizationViewSummary, globalShoppingOfficialAnchorComparisonViewSummary:globalShoppingOfficialAnchorComparisonViewSummary }) : null);
    ...
    const categoryResultSimulatorSummary = safe.categoryResultSimulatorSummary && typeof safe.categoryResultSimulatorSummary === "object" ? safe.categoryResultSimulatorSummary : (typeof globalShoppingCategoryResultSimulatorApi.buildGlobalShoppingCategoryResultSimulator === "function" ? globalShoppingCategoryResultSimulatorApi.buildGlobalShoppingCategoryResultSimulator({
      ...
      product:{ categoryLabel:"Product 候选结果", sourceLabel:"product mock source", candidateLabel:"product readonly candidate", normalizedPriceLabel:"待补充", evidenceLabel:"只读候选证据", riskLabel:"需要人工复核" }
    }) : null);
    ...
    const resultTrustBadgePanelSummary = safe.resultTrustBadgePanelSummary && typeof safe.resultTrustBadgePanelSummary === "object" ? safe.resultTrustBadgePanelSummary : (typeof globalShoppingResultTrustBadgePanelApi.buildGlobalShoppingResultTrustBadgePanel === "function" ? globalShoppingResultTrustBadgePanelApi.buildGlobalShoppingResultTrustBadgePanel({
      ...
      feeNormalized:globalShoppingFeeNormalizationViewStatus === "ready",
      providerZero:true,
      readOnly:true,
      manualReviewRequired:true
    }) : null);
    ...
    const publicBetaUserJourneyShellSummary = safe.publicBetaUserJourneyShellSummary && typeof safe.publicBetaUserJourneyShellSummary === "object" ? safe.publicBetaUserJourneyShellSummary : (typeof globalShoppingPublicBetaUserJourneyShellApi.buildGlobalShoppingPublicBetaUserJourneyShell === "function" ? globalShoppingPublicBetaUserJourneyShellApi.buildGlobalShoppingPublicBetaUserJourneyShell({
      ...
      categoryResultStep:"Category Result Simulator",
    ...
    const noTransactionRegressionGuardSummary = safe.noTransactionRegressionGuardSummary && typeof safe.noTransactionRegressionGuardSummary === "object" ? safe.noTransactionRegressionGuardSummary : (typeof noTransactionRegressionGuardApi.buildGlobalShoppingNoTransactionRegressionGuard === "function" ? noTransactionRegressionGuardApi.buildGlobalShoppingNoTransactionRegressionGuard({
      ...
      publicBetaAcceptanceBoardSummary:safe.publicBetaAcceptanceBoardSummary && typeof safe.publicBetaAcceptanceBoardSummary === "object" ? safe.publicBetaAcceptanceBoardSummary : null,
    ...
    const noTransactionRegressionGuardStatus = text(noTransactionRegressionGuardSummary && noTransactionRegressionGuardSummary.status || "");
    const publicBetaQaViewModelApi = window.WeishanGlobalShoppingPublicBetaQaViewModel || {};
    const publicBetaQaViewModelSummary = safe.publicBetaQaViewModelSummary && typeof safe.publicBetaQaViewModelSummary === "object" ? safe.publicBetaQaViewModelSummary : (typeof publicBetaQaViewModelApi.buildGlobalShoppingPublicBetaQaViewModel === "function" ? publicBetaQaViewModelApi.buildGlobalShoppingPublicBetaQaViewModel({
      publicBetaVisualQaConsoleSummary:publicBetaVisualQaConsoleSummary,
      publicBetaTrialScenarioChecklistSummary:publicBetaTrialScenarioChecklistSummary,
    ...
    const safeFeedbackDraftPanelStatus = text(safeFeedbackDraftPanelSummary && safeFeedbackDraftPanelSummary.status || "");
    const publicBetaOnboardingViewModelApi = window.WeishanGlobalShoppingPublicBetaOnboardingViewModel || {};
    const publicBetaOnboardingViewModelSummary = safe.publicBetaOnboardingViewModelSummary && typeof safe.publicBetaOnboardingViewModelSummary === "object" ? safe.publicBetaOnboardingViewModelSummary : (typeof publicBetaOnboardingViewModelApi.buildGlobalShoppingPublicBetaOnboardingViewModel === "function" ? publicBetaOnboardingViewModelApi.buildGlobalShoppingPublicBetaOnboardingViewModel({
      publicBetaUserOnboardingShellSummary:publicBetaUserOnboardingShellSummary,
      visualTrialGuideSummary:visualTrialGuideSummary,
    ...
    const offlineTrialReleaseGateStatus = text(offlineTrialReleaseGateSummary && offlineTrialReleaseGateSummary.status || "");
    const publicBetaRcViewModelApi = window.WeishanGlobalShoppingPublicBetaRcViewModel || {};
    const publicBetaRcViewModelSummary = safe.publicBetaRcViewModelSummary && typeof safe.publicBetaRcViewModelSummary === "object" ? safe.publicBetaRcViewModelSummary : (typeof publicBetaRcViewModelApi.buildGlobalShoppingPublicBetaRcViewModel === "function" ? publicBetaRcViewModelApi.buildGlobalShoppingPublicBetaRcViewModel({
    ...
    const manualLaunchHandoffPackStatus = text(manualLaunchHandoffPackSummary && manualLaunchHandoffPackSummary.status || "");
    const manualLaunchHandoffViewModelApi = window.WeishanGlobalShoppingManualLaunchHandoffViewModel || {};
    const manualLaunchHandoffViewModelSummary = safe.manualLaunchHandoffViewModelSummary && typeof safe.manualLaunchHandoffViewModelSummary === "object" ? safe.manualLaunchHandoffViewModelSummary : (typeof manualLaunchHandoffViewModelApi.buildGlobalShoppingManualLaunchHandoffViewModel === "function" ? manualLaunchHandoffViewModelApi.buildGlobalShoppingManualLaunchHandoffViewModel({
      publicBetaStabilityAuditSummary:publicBetaStabilityAuditSummary,
      manualLaunchHandoffPackSummary:manualLaunchHandoffPackSummary
    }) : null);
    const manualLaunchHandoffViewModelStatus = text(manualLaunchHandoffViewModelSummary && manualLaunchHandoffViewModelSummary.status || "");
    const publicBetaManualQaReportCenterApi = window.WeishanGlobalShoppingPublicBetaManualQaReportCenter || {};
    const publicBetaManualQaReportCenterSummary = safe.publicBetaManualQaReportCenterSummary && typeof safe.publicBetaManualQaReportCenterSummary === "object" ? safe.publicBetaManualQaReportCenterSummary : (typeof publicBetaManualQaReportCenterApi.buildGlobalShoppingPublicBetaManualQaReportCenter === "function" ? publicBetaManualQaReportCenterApi.buildGlobalShoppingPublicBetaManualQaReportCenter({
      publicBetaStabilityAuditSummary:publicBetaStabilityAuditSummary,
      manualLaunchHandoffPackSummary:manualLaunchHandoffPackSummary,
      manualLaunchHandoffViewModelSummary:manualLaunchHandoffViewModelSummary,
      publicBetaRcConsoleSummary:publicBetaRcConsoleSummary,
      offlineTrialReleaseGateSummary:offlineTrialReleaseGateSummary,
      validationSummary:"人工 QA 结果待确认",
      e2eSummary:"commerce-agent 18/18 smoke 目标保持只读范围",
      buildSummary:"Build 结果待人工 QA 复核",
      appLaunchSummary:"App 启动结果待人工 QA 复核",
      knownWarnings:["既有 secret scan WARN 仅作为已知警告展示"],
      manualReviewRequired:true
    }) : null);
    const publicBetaManualQaReportCenterStatus = text(publicBetaManualQaReportCenterSummary && publicBetaManualQaReportCenterSummary.status || "");
    const trialFeedbackSafetyGateApi = window.WeishanGlobalShoppingTrialFeedbackSafetyGate || {};
    const trialFeedbackSafetyGateSummary = safe.trialFeedbackSafetyGateSummary && typeof safe.trialFeedbackSafetyGateSummary === "object" ? safe.trialFeedbackSafetyGateSummary : (typeof trialFeedbackSafetyGateApi.buildGlobalShoppingTrialFeedbackSafetyGate === "function" ? trialFeedbackSafetyGateApi.buildGlobalShoppingTrialFeedbackSafetyGate({
      safeFeedbackDraftPanelSummary:safeFeedbackDraftPanelSummary,
      publicBetaFeedbackPlaceholderSummary:publicBetaFeedbackPlaceholderSummary,
      publicBetaManualQaReportCenterSummary:publicBetaManualQaReportCenterSummary,
      noTransactionRegressionGuardSummary:noTransactionRegressionGuardSummary
    }) : null);
    const trialFeedbackSafetyGateStatus = text(trialFeedbackSafetyGateSummary && trialFeedbackSafetyGateSummary.status || "");
    const publicBetaRcEvidenceSnapshotApi = window.WeishanGlobalShoppingPublicBetaRcEvidenceSnapshot || {};
    const publicBetaRcEvidenceSnapshotSummary = safe.publicBetaRcEvidenceSnapshotSummary && typeof safe.publicBetaRcEvidenceSnapshotSummary === "object" ? safe.publicBetaRcEvidenceSnapshotSummary : (typeof publicBetaRcEvidenceSnapshotApi.buildGlobalShoppingPublicBetaRcEvidenceSnapshot === "function" ? publicBetaRcEvidenceSnapshotApi.buildGlobalShoppingPublicBetaRcEvidenceSnapshot({
      publicBetaManualQaReportCenterSummary:publicBetaManualQaReportCenterSummary,
    ...
    const publicBetaRcEvidenceSnapshotStatus = text(publicBetaRcEvidenceSnapshotSummary && publicBetaRcEvidenceSnapshotSummary.status || "");
    const publicBetaManualQaViewModelApi = window.WeishanGlobalShoppingPublicBetaManualQaViewModel || {};
    const publicBetaManualQaViewModelSummary = safe.publicBetaManualQaViewModelSummary && typeof safe.publicBetaManualQaViewModelSummary === "object" ? safe.publicBetaManualQaViewModelSummary : (typeof publicBetaManualQaViewModelApi.buildGlobalShoppingPublicBetaManualQaViewModel === "function" ? publicBetaManualQaViewModelApi.buildGlobalShoppingPublicBetaManualQaViewModel({
      publicBetaManualQaReportCenterSummary:publicBetaManualQaReportCenterSummary,
      trialFeedbackSafetyGateSummary:trialFeedbackSafetyGateSummary,
      publicBetaRcEvidenceSnapshotSummary:publicBetaRcEvidenceSnapshotSummary
    }) : null);
    const publicBetaManualQaViewModelStatus = text(publicBetaManualQaViewModelSummary && publicBetaManualQaViewModelSummary.status || "");
    const publicBetaTrialOperationsConsoleApi = window.WeishanGlobalShoppingPublicBetaTrialOperationsConsole || {};
    const publicBetaTrialOperationsConsoleSummary = safe.publicBetaTrialOperationsConsoleSummary && typeof safe.publicBetaTrialOperationsConsoleSummary === "object" ? safe.publicBetaTrialOperationsConsoleSummary : (typeof publicBetaTrialOperationsConsoleApi.buildGlobalShoppingPublicBetaTrialOperationsConsole === "function" ? publicBetaTrialOperationsConsoleApi.buildGlobalShoppingPublicBetaTrialOperationsConsole({
      consoleMode:"trial_operations_console_only",
      publicBetaManualQaReportCenterSummary:publicBetaManualQaReportCenterSummary,
      trialFeedbackSafetyGateSummary:trialFeedbackSafetyGateSummary,
      publicBetaRcEvidenceSnapshotSummary:publicBetaRcEvidenceSnapshotSummary,
    ...
    const publicBetaTrialOperationsConsoleStatus = text(publicBetaTrialOperationsConsoleSummary && publicBetaTrialOperationsConsoleSummary.status || "");
    const manualQaScenarioRunnerApi = window.WeishanGlobalShoppingManualQaScenarioRunner || {};
    const manualQaScenarioRunnerSummary = safe.manualQaScenarioRunnerSummary && typeof safe.manualQaScenarioRunnerSummary === "object" ? safe.manualQaScenarioRunnerSummary : (typeof manualQaScenarioRunnerApi.buildGlobalShoppingManualQaScenarioRunner === "function" ? manualQaScenarioRunnerApi.buildGlobalShoppingManualQaScenarioRunner({
      runnerMode:"manual_qa_scenario_runner_only",
      manualReviewRequired:true
    }) : null);
    const manualQaScenarioRunnerStatus = text(manualQaScenarioRunnerSummary && manualQaScenarioRunnerSummary.status || "");
    const offlineFeedbackReviewBoardApi = window.WeishanGlobalShoppingOfflineFeedbackReviewBoard || {};
    const offlineFeedbackReviewBoardSummary = safe.offlineFeedbackReviewBoardSummary && typeof safe.offlineFeedbackReviewBoardSummary === "object" ? safe.offlineFeedbackReviewBoardSummary : (typeof offlineFeedbackReviewBoardApi.buildGlobalShoppingOfflineFeedbackReviewBoard === "function" ? offlineFeedbackReviewBoardApi.buildGlobalShoppingOfflineFeedbackReviewBoard({
      boardMode:"offline_feedback_review_only",
      trialFeedbackSafetyGateSummary:trialFeedbackSafetyGateSummary,
      safeFeedbackDraftPanelSummary:safeFeedbackDraftPanelSummary,
      publicBetaFeedbackPlaceholderSummary:publicBetaFeedbackPlaceholderSummary,
    ...
    const offlineFeedbackReviewBoardStatus = text(offlineFeedbackReviewBoardSummary && offlineFeedbackReviewBoardSummary.status || "");
    const publicBetaTrialOperationsViewModelApi = window.WeishanGlobalShoppingPublicBetaTrialOperationsViewModel || {};
    const publicBetaTrialOperationsViewModelSummary = safe.publicBetaTrialOperationsViewModelSummary && typeof safe.publicBetaTrialOperationsViewModelSummary === "object" ? safe.publicBetaTrialOperationsViewModelSummary : (typeof publicBetaTrialOperationsViewModelApi.buildGlobalShoppingPublicBetaTrialOperationsViewModel === "function" ? publicBetaTrialOperationsViewModelApi.buildGlobalShoppingPublicBetaTrialOperationsViewModel({
    ...
    const publicBetaTrialOperationsViewModelStatus = text(publicBetaTrialOperationsViewModelSummary && publicBetaTrialOperationsViewModelSummary.status || "");
    const publicBetaTrialEvidenceLedgerApi = window.WeishanGlobalShoppingPublicBetaTrialEvidenceLedger || {};
    const publicBetaTrialEvidenceLedgerSummary = safe.publicBetaTrialEvidenceLedgerSummary && typeof safe.publicBetaTrialEvidenceLedgerSummary === "object" ? safe.publicBetaTrialEvidenceLedgerSummary : (typeof publicBetaTrialEvidenceLedgerApi.buildGlobalShoppingPublicBetaTrialEvidenceLedger === "function" ? publicBetaTrialEvidenceLedgerApi.buildGlobalShoppingPublicBetaTrialEvidenceLedger({
      ledgerMode:"trial_evidence_ledger_only",
      publicBetaTrialOperationsConsoleSummary:publicBetaTrialOperationsConsoleSummary,
      manualQaScenarioRunnerSummary:manualQaScenarioRunnerSummary,
      offlineFeedbackReviewBoardSummary:offlineFeedbackReviewBoardSummary,
      publicBetaManualQaReportCenterSummary:publicBetaManualQaReportCenterSummary,
    ...
    const publicBetaTrialEvidenceLedgerStatus = text(publicBetaTrialEvidenceLedgerSummary && publicBetaTrialEvidenceLedgerSummary.status || "");
    const publicBetaQaDecisionMatrixApi = window.WeishanGlobalShoppingPublicBetaQaDecisionMatrix || {};
    const publicBetaQaDecisionMatrixSummary = safe.publicBetaQaDecisionMatrixSummary && typeof safe.publicBetaQaDecisionMatrixSummary === "object" ? safe.publicBetaQaDecisionMatrixSummary : (typeof publicBetaQaDecisionMatrixApi.buildGlobalShoppingPublicBetaQaDecisionMatrix === "function" ? publicBetaQaDecisionMatrixApi.buildGlobalShoppingPublicBetaQaDecisionMatrix({
      matrixMode:"qa_decision_matrix_only",
    ...
    const publicBetaQaDecisionMatrixStatus = text(publicBetaQaDecisionMatrixSummary && publicBetaQaDecisionMatrixSummary.status || "");
    const qaOpsOfflineIssueTriageBoardApi = window.WeishanGlobalShoppingOfflineIssueTriageBoard || {};
    const qaOpsOfflineIssueTriageBoardSummary = safe.offlineIssueTriageBoardSummary && typeof safe.offlineIssueTriageBoardSummary === "object" ? safe.offlineIssueTriageBoardSummary : (typeof qaOpsOfflineIssueTriageBoardApi.buildGlobalShoppingOfflineIssueTriageBoard === "function" ? qaOpsOfflineIssueTriageBoardApi.buildGlobalShoppingOfflineIssueTriageBoard({
      boardMode:"offline_issue_triage_only",
      publicBetaTrialEvidenceLedgerSummary:publicBetaTrialEvidenceLedgerSummary,
    ...
    const qaOpsOfflineIssueTriageBoardStatus = text(qaOpsOfflineIssueTriageBoardSummary && qaOpsOfflineIssueTriageBoardSummary.status || "");
    const publicBetaQaOperationsViewModelApi = window.WeishanGlobalShoppingPublicBetaQaOperationsViewModel || {};
    const publicBetaQaOperationsViewModelSummary = safe.publicBetaQaOperationsViewModelSummary && typeof safe.publicBetaQaOperationsViewModelSummary === "object" ? safe.publicBetaQaOperationsViewModelSummary : (typeof publicBetaQaOperationsViewModelApi.buildGlobalShoppingPublicBetaQaOperationsViewModel === "function" ? publicBetaQaOperationsViewModelApi.buildGlobalShoppingPublicBetaQaOperationsViewModel({
      publicBetaTrialEvidenceLedgerSummary:publicBetaTrialEvidenceLedgerSummary,
      publicBetaQaDecisionMatrixSummary:publicBetaQaDecisionMatrixSummary,
      offlineIssueTriageBoardSummary:qaOpsOfflineIssueTriageBoardSummary
    }) : null);
    const publicBetaQaOperationsViewModelStatus = text(publicBetaQaOperationsViewModelSummary && publicBetaQaOperationsViewModelSummary.status || "");
    const publicBetaQaFreezeGateApi = window.WeishanGlobalShoppingPublicBetaQaFreezeGate || {};
    const publicBetaQaFreezeGateSummary = safe.publicBetaQaFreezeGateSummary && typeof safe.publicBetaQaFreezeGateSummary === "object" ? safe.publicBetaQaFreezeGateSummary : (typeof publicBetaQaFreezeGateApi.buildGlobalShoppingPublicBetaQaFreezeGate === "function" ? publicBetaQaFreezeGateApi.buildGlobalShoppingPublicBetaQaFreezeGate({
      gateMode:"qa_freeze_gate_only",
      publicBetaTrialEvidenceLedgerSummary:publicBetaTrialEvidenceLedgerSummary,
      publicBetaQaDecisionMatrixSummary:publicBetaQaDecisionMatrixSummary,
      offlineIssueTriageBoardSummary:offlineIssueTriageBoardSummary,
      publicBetaQaOperationsViewModelSummary:publicBetaQaOperationsViewModelSummary,
    ...
    const publicBetaQaFreezeGateStatus = text(publicBetaQaFreezeGateSummary && (publicBetaQaFreezeGateSummary.status || publicBetaQaFreezeGateSummary.freezeStatus) || "");
    const manualTrialSummaryBoardApi = window.WeishanGlobalShoppingManualTrialSummaryBoard || {};
    const manualTrialSummaryBoardSummary = safe.manualTrialSummaryBoardSummary && typeof safe.manualTrialSummaryBoardSummary === "object" ? safe.manualTrialSummaryBoardSummary : (typeof manualTrialSummaryBoardApi.buildGlobalShoppingManualTrialSummaryBoard === "function" ? manualTrialSummaryBoardApi.buildGlobalShoppingManualTrialSummaryBoard({
      boardMode:"manual_trial_summary_only",
      publicBetaQaFreezeGateSummary:publicBetaQaFreezeGateSummary,
      publicBetaTrialEvidenceLedgerSummary:publicBetaTrialEvidenceLedgerSummary,
      manualQaScenarioRunnerSummary:manualQaScenarioRunnerSummary,
      offlineFeedbackReviewBoardSummary:offlineFeedbackReviewBoardSummary,
    ...
    const manualTrialSummaryBoardStatus = text(manualTrialSummaryBoardSummary && (manualTrialSummaryBoardSummary.status || manualTrialSummaryBoardSummary.trialSummaryStatus) || "");
    const offlineReadinessReviewPanelApi = window.WeishanGlobalShoppingOfflineReadinessReviewPanel || {};
    const offlineReadinessReviewPanelSummary = safe.offlineReadinessReviewPanelSummary && typeof safe.offlineReadinessReviewPanelSummary === "object" ? safe.offlineReadinessReviewPanelSummary : (typeof offlineReadinessReviewPanelApi.buildGlobalShoppingOfflineReadinessReviewPanel === "function" ? offlineReadinessReviewPanelApi.buildGlobalShoppingOfflineReadinessReviewPanel({
      panelMode:"readiness_review_only",
      publicBetaQaFreezeGateSummary:publicBetaQaFreezeGateSummary,
      manualTrialSummaryBoardSummary:manualTrialSummaryBoardSummary,
      offlineTrialReleaseGateSummary:offlineTrialReleaseGateSummary,
      manualLaunchHandoffPackSummary:manualLaunchHandoffPackSummary,
    ...
    const offlineReadinessReviewPanelStatus = text(offlineReadinessReviewPanelSummary && (offlineReadinessReviewPanelSummary.status || offlineReadinessReviewPanelSummary.readinessStatus) || "");
    const publicBetaFreezeReviewViewModelApi = window.WeishanGlobalShoppingPublicBetaFreezeReviewViewModel || {};
    const publicBetaFreezeReviewViewModelSummary = safe.publicBetaFreezeReviewViewModelSummary && typeof safe.publicBetaFreezeReviewViewModelSummary === "object" ? safe.publicBetaFreezeReviewViewModelSummary : (typeof publicBetaFreezeReviewViewModelApi.buildGlobalShoppingPublicBetaFreezeReviewViewModel === "function" ? publicBetaFreezeReviewViewModelApi.buildGlobalShoppingPublicBetaFreezeReviewViewModel({
      publicBetaQaFreezeGateSummary:publicBetaQaFreezeGateSummary,
      manualTrialSummaryBoardSummary:manualTrialSummaryBoardSummary,
      offlineReadinessReviewPanelSummary:offlineReadinessReviewPanelSummary
    }) : null);
    const publicBetaFreezeReviewViewModelStatus = text(publicBetaFreezeReviewViewModelSummary && publicBetaFreezeReviewViewModelSummary.status || "");
    const publicBetaFreezeEvidenceSummaryApi = window.WeishanGlobalShoppingPublicBetaFreezeEvidenceSummary || {};
    const publicBetaFreezeEvidenceSummary = safe.publicBetaFreezeEvidenceSummary && typeof safe.publicBetaFreezeEvidenceSummary === "object" ? safe.publicBetaFreezeEvidenceSummary : (typeof publicBetaFreezeEvidenceSummaryApi.buildGlobalShoppingPublicBetaFreezeEvidenceSummary === "function" ? publicBetaFreezeEvidenceSummaryApi.buildGlobalShoppingPublicBetaFreezeEvidenceSummary({
      summaryMode:"freeze_evidence_summary_only",
      publicBetaQaFreezeGateSummary:publicBetaQaFreezeGateSummary,
      manualTrialSummaryBoardSummary:manualTrialSummaryBoardSummary,
      offlineReadinessReviewPanelSummary:offlineReadinessReviewPanelSummary,
      publicBetaFreezeReviewViewModelSummary:publicBetaFreezeReviewViewModelSummary,
    ...
    const publicBetaFreezeEvidenceStatus = text(publicBetaFreezeEvidenceSummary && (publicBetaFreezeEvidenceSummary.status || publicBetaFreezeEvidenceSummary.freezeEvidenceStatus) || "");
    const manualTrialIssueReviewBoardApi = window.WeishanGlobalShoppingManualTrialIssueReviewBoard || {};
    const manualTrialIssueReviewBoardSummary = safe.manualTrialIssueReviewBoardSummary && typeof safe.manualTrialIssueReviewBoardSummary === "object" ? safe.manualTrialIssueReviewBoardSummary : (typeof manualTrialIssueReviewBoardApi.buildGlobalShoppingManualTrialIssueReviewBoard === "function" ? manualTrialIssueReviewBoardApi.buildGlobalShoppingManualTrialIssueReviewBoard({
      boardMode:"manual_issue_review_only",
      offlineIssueTriageBoardSummary:offlineIssueTriageBoardSummary,
      manualTrialSummaryBoardSummary:manualTrialSummaryBoardSummary,
      publicBetaQaDecisionMatrixSummary:publicBetaQaDecisionMatrixSummary,
      offlineFeedbackReviewBoardSummary:offlineFeedbackReviewBoardSummary,
    ...
    const offlineAcceptanceSnapshotSummary = safe.offlineAcceptanceSnapshotSummary && typeof safe.offlineAcceptanceSnapshotSummary === "object" ? safe.offlineAcceptanceSnapshotSummary : (typeof offlineAcceptanceSnapshotApi.buildGlobalShoppingOfflineAcceptanceSnapshot === "function" ? offlineAcceptanceSnapshotApi.buildGlobalShoppingOfflineAcceptanceSnapshot({
      snapshotMode:"offline_acceptance_snapshot_only",
    ...
    const offlineAcceptanceSnapshotStatus = text(offlineAcceptanceSnapshotSummary && (offlineAcceptanceSnapshotSummary.status || offlineAcceptanceSnapshotSummary.acceptanceSnapshotStatus) || "");
    const publicBetaAcceptanceSnapshotViewModelApi = window.WeishanGlobalShoppingPublicBetaAcceptanceSnapshotViewModel || {};
    const publicBetaAcceptanceSnapshotViewModelSummary = safe.publicBetaAcceptanceSnapshotViewModelSummary && typeof safe.publicBetaAcceptanceSnapshotViewModelSummary === "object" ? safe.publicBetaAcceptanceSnapshotViewModelSummary : (typeof publicBetaAcceptanceSnapshotViewModelApi.buildGlobalShoppingPublicBetaAcceptanceSnapshotViewModel === "function" ? publicBetaAcceptanceSnapshotViewModelApi.buildGlobalShoppingPublicBetaAcceptanceSnapshotViewModel({
      publicBetaFreezeEvidenceSummary:publicBetaFreezeEvidenceSummary,
      manualTrialIssueReviewBoardSummary:manualTrialIssueReviewBoardSummary,
      offlineAcceptanceSnapshotSummary:offlineAcceptanceSnapshotSummary
    }) : null);
    const publicBetaAcceptanceSnapshotViewModelStatus = text(publicBetaAcceptanceSnapshotViewModelSummary && publicBetaAcceptanceSnapshotViewModelSummary.status || "");
    const publicBetaAcceptanceReviewConsoleApi = window.WeishanGlobalShoppingPublicBetaAcceptanceReviewConsole || {};
    const publicBetaAcceptanceReviewConsoleSummary = safe.publicBetaAcceptanceReviewConsoleSummary && typeof safe.publicBetaAcceptanceReviewConsoleSummary === "object" ? safe.publicBetaAcceptanceReviewConsoleSummary : (typeof publicBetaAcceptanceReviewConsoleApi.buildGlobalShoppingPublicBetaAcceptanceReviewConsole === "function" ? publicBetaAcceptanceReviewConsoleApi.buildGlobalShoppingPublicBetaAcceptanceReviewConsole({
      consoleMode:"acceptance_review_console_only",
      publicBetaFreezeEvidenceSummary:publicBetaFreezeEvidenceSummary,
      manualTrialIssueReviewBoardSummary:manualTrialIssueReviewBoardSummary,
      offlineAcceptanceSnapshotSummary:offlineAcceptanceSnapshotSummary,
      publicBetaAcceptanceSnapshotViewModelSummary:publicBetaAcceptanceSnapshotViewModelSummary,
      publicBetaQaFreezeGateSummary:publicBetaQaFreezeGateSummary,
      manualReviewRequired:true
    }) : null);
    const publicBetaAcceptanceReviewConsoleStatus = text(publicBetaAcceptanceReviewConsoleSummary && (publicBetaAcceptanceReviewConsoleSummary.status || publicBetaAcceptanceReviewConsoleSummary.acceptanceReviewStatus) || "");
    const offlineTrialClosureBoardApi = window.WeishanGlobalShoppingOfflineTrialClosureBoard || {};
    const offlineTrialClosureBoardSummary = safe.offlineTrialClosureBoardSummary && typeof safe.offlineTrialClosureBoardSummary === "object" ? safe.offlineTrialClosureBoardSummary : (typeof offlineTrialClosureBoardApi.buildGlobalShoppingOfflineTrialClosureBoard === "function" ? offlineTrialClosureBoardApi.buildGlobalShoppingOfflineTrialClosureBoard({
      boardMode:"offline_trial_closure_only",
    ...
    const offlineTrialClosureBoardStatus = text(offlineTrialClosureBoardSummary && (offlineTrialClosureBoardSummary.status || offlineTrialClosureBoardSummary.closureStatus) || "");
    const noLaunchAssuranceGateApi = window.WeishanGlobalShoppingNoLaunchAssuranceGate || {};
    const noLaunchAssuranceGateSummary = safe.noLaunchAssuranceGateSummary && typeof safe.noLaunchAssuranceGateSummary === "object" ? safe.noLaunchAssuranceGateSummary : (typeof noLaunchAssuranceGateApi.buildGlobalShoppingNoLaunchAssuranceGate === "function" ? noLaunchAssuranceGateApi.buildGlobalShoppingNoLaunchAssuranceGate({
      gateMode:"no_launch_assurance_only",
      publicBetaAcceptanceReviewConsoleSummary:publicBetaAcceptanceReviewConsoleSummary,
    ...
    const noLaunchAssuranceGateStatus = text(noLaunchAssuranceGateSummary && noLaunchAssuranceGateSummary.status || "");
    const publicBetaClosureReviewViewModelApi = window.WeishanGlobalShoppingPublicBetaClosureReviewViewModel || {};
    const publicBetaClosureReviewViewModelSummary = safe.publicBetaClosureReviewViewModelSummary && typeof safe.publicBetaClosureReviewViewModelSummary === "object" ? safe.publicBetaClosureReviewViewModelSummary : (typeof publicBetaClosureReviewViewModelApi.buildGlobalShoppingPublicBetaClosureReviewViewModel === "function" ? publicBetaClosureReviewViewModelApi.buildGlobalShoppingPublicBetaClosureReviewViewModel({
      publicBetaAcceptanceReviewConsoleSummary:publicBetaAcceptanceReviewConsoleSummary,
      offlineTrialClosureBoardSummary:offlineTrialClosureBoardSummary,
      noLaunchAssuranceGateSummary:noLaunchAssuranceGateSummary
    }) : null);
    const publicBetaClosureReviewViewModelStatus = text(publicBetaClosureReviewViewModelSummary && publicBetaClosureReviewViewModelSummary.status || "");
    const publicBetaClosureEvidenceArchiveApi = window.WeishanGlobalShoppingPublicBetaClosureEvidenceArchive || {};
    const publicBetaClosureEvidenceArchiveSummary = safe.publicBetaClosureEvidenceArchiveSummary && typeof safe.publicBetaClosureEvidenceArchiveSummary === "object" ? safe.publicBetaClosureEvidenceArchiveSummary : (typeof publicBetaClosureEvidenceArchiveApi.buildGlobalShoppingPublicBetaClosureEvidenceArchive === "function" ? publicBetaClosureEvidenceArchiveApi.buildGlobalShoppingPublicBetaClosureEvidenceArchive({
      archiveMode:"closure_evidence_archive_only",
      publicBetaAcceptanceReviewConsoleSummary:publicBetaAcceptanceReviewConsoleSummary,
      offlineTrialClosureBoardSummary:offlineTrialClosureBoardSummary,
      noLaunchAssuranceGateSummary:noLaunchAssuranceGateSummary,
    ...
    const publicBetaClosureEvidenceArchiveStatus = text(publicBetaClosureEvidenceArchiveSummary && (publicBetaClosureEvidenceArchiveSummary.status || publicBetaClosureEvidenceArchiveSummary.archiveStatus) || "");
    const manualTrialExitCriteriaApi = window.WeishanGlobalShoppingManualTrialExitCriteria || {};
    const manualTrialExitCriteriaSummary = safe.manualTrialExitCriteriaSummary && typeof safe.manualTrialExitCriteriaSummary === "object" ? safe.manualTrialExitCriteriaSummary : (typeof manualTrialExitCriteriaApi.buildGlobalShoppingManualTrialExitCriteria === "function" ? manualTrialExitCriteriaApi.buildGlobalShoppingManualTrialExitCriteria({
      criteriaMode:"manual_exit_criteria_only",
    ...
    const manualTrialExitCriteriaStatus = text(manualTrialExitCriteriaSummary && (manualTrialExitCriteriaSummary.status || manualTrialExitCriteriaSummary.exitCriteriaStatus) || "");
    const offlineNextStepPlanningBoardApi = window.WeishanGlobalShoppingOfflineNextStepPlanningBoard || {};
    const offlineNextStepPlanningBoardSummary = safe.offlineNextStepPlanningBoardSummary && typeof safe.offlineNextStepPlanningBoardSummary === "object" ? safe.offlineNextStepPlanningBoardSummary : (typeof offlineNextStepPlanningBoardApi.buildGlobalShoppingOfflineNextStepPlanningBoard === "function" ? offlineNextStepPlanningBoardApi.buildGlobalShoppingOfflineNextStepPlanningBoard({
      boardMode:"next_step_planning_only",
      publicBetaClosureEvidenceArchiveSummary:publicBetaClosureEvidenceArchiveSummary,
    ...
    const offlineNextStepPlanningStatus = text(offlineNextStepPlanningBoardSummary && (offlineNextStepPlanningBoardSummary.status || offlineNextStepPlanningBoardSummary.planningStatus) || "");
    const publicBetaNextStepViewModelApi = window.WeishanGlobalShoppingPublicBetaNextStepViewModel || {};
    const publicBetaNextStepViewModelSummary = safe.publicBetaNextStepViewModelSummary && typeof safe.publicBetaNextStepViewModelSummary === "object" ? safe.publicBetaNextStepViewModelSummary : (typeof publicBetaNextStepViewModelApi.buildGlobalShoppingPublicBetaNextStepViewModel === "function" ? publicBetaNextStepViewModelApi.buildGlobalShoppingPublicBetaNextStepViewModel({
      publicBetaClosureEvidenceArchiveSummary:publicBetaClosureEvidenceArchiveSummary,
      manualTrialExitCriteriaSummary:manualTrialExitCriteriaSummary,
      offlineNextStepPlanningBoardSummary:offlineNextStepPlanningBoardSummary
    }) : null);
    const publicBetaNextStepViewModelStatus = text(publicBetaNextStepViewModelSummary && publicBetaNextStepViewModelSummary.status || "");
    const publicBetaFinalReadinessCommandCenterApi = window.WeishanGlobalShoppingPublicBetaFinalReadinessCommandCenter || {};
    const publicBetaFinalReadinessCommandCenterSummary = safe.publicBetaFinalReadinessCommandCenterSummary && typeof safe.publicBetaFinalReadinessCommandCenterSummary === "object" ? safe.publicBetaFinalReadinessCommandCenterSummary : (typeof publicBetaFinalReadinessCommandCenterApi.buildGlobalShoppingPublicBetaFinalReadinessCommandCenter === "function" ? publicBetaFinalReadinessCommandCenterApi.buildGlobalShoppingPublicBetaFinalReadinessCommandCenter({
      publicBetaClosureEvidenceArchiveSummary:publicBetaClosureEvidenceArchiveSummary,
      manualTrialExitCriteriaSummary:manualTrialExitCriteriaSummary,
      offlineNextStepPlanningBoardSummary:offlineNextStepPlanningBoardSummary,
    ...
    const publicBetaFinalReadinessCommandCenterStatus = text(publicBetaFinalReadinessCommandCenterSummary && (publicBetaFinalReadinessCommandCenterSummary.status || publicBetaFinalReadinessCommandCenterSummary.finalReadinessStatus) || "");
    const offlineLaunchBlockerMatrixApi = window.WeishanGlobalShoppingOfflineLaunchBlockerMatrix || {};
    const offlineLaunchBlockerMatrixSummary = safe.offlineLaunchBlockerMatrixSummary && typeof safe.offlineLaunchBlockerMatrixSummary === "object" ? safe.offlineLaunchBlockerMatrixSummary : (typeof offlineLaunchBlockerMatrixApi.buildGlobalShoppingOfflineLaunchBlockerMatrix === "function" ? offlineLaunchBlockerMatrixApi.buildGlobalShoppingOfflineLaunchBlockerMatrix({
    ...
    const offlineLaunchBlockerMatrixStatus = text(offlineLaunchBlockerMatrixSummary && (offlineLaunchBlockerMatrixSummary.status || offlineLaunchBlockerMatrixSummary.blockerMatrixStatus) || "");
    const manualNextPhaseDossierApi = window.WeishanGlobalShoppingManualNextPhaseDossier || {};
    const manualNextPhaseDossierSummary = safe.manualNextPhaseDossierSummary && typeof safe.manualNextPhaseDossierSummary === "object" ? safe.manualNextPhaseDossierSummary : (typeof manualNextPhaseDossierApi.buildGlobalShoppingManualNextPhaseDossier === "function" ? manualNextPhaseDossierApi.buildGlobalShoppingManualNextPhaseDossier({
      publicBetaFinalReadinessCommandCenterSummary:publicBetaFinalReadinessCommandCenterSummary,
    ...
    const manualNextPhaseDossierStatus = text(manualNextPhaseDossierSummary && (manualNextPhaseDossierSummary.status || manualNextPhaseDossierSummary.dossierStatus) || "");
    const publicBetaFinalReadinessViewModelApi = window.WeishanGlobalShoppingPublicBetaFinalReadinessViewModel || {};
    const publicBetaFinalReadinessViewModelSummary = safe.publicBetaFinalReadinessViewModelSummary && typeof safe.publicBetaFinalReadinessViewModelSummary === "object" ? safe.publicBetaFinalReadinessViewModelSummary : (typeof publicBetaFinalReadinessViewModelApi.buildGlobalShoppingPublicBetaFinalReadinessViewModel === "function" ? publicBetaFinalReadinessViewModelApi.buildGlobalShoppingPublicBetaFinalReadinessViewModel({
      publicBetaFinalReadinessCommandCenterSummary:publicBetaFinalReadinessCommandCenterSummary,
      offlineLaunchBlockerMatrixSummary:offlineLaunchBlockerMatrixSummary,
      manualNextPhaseDossierSummary:manualNextPhaseDossierSummary
    }) : null);
    const publicBetaFinalReadinessViewModelStatus = text(publicBetaFinalReadinessViewModelSummary && publicBetaFinalReadinessViewModelSummary.status || "");
    const publicBetaCandidateLockApi = window.WeishanGlobalShoppingPublicBetaCandidateLock || {};
    const publicBetaCandidateLockSummary = safe.publicBetaCandidateLockSummary && typeof safe.publicBetaCandidateLockSummary === "object" ? safe.publicBetaCandidateLockSummary : (typeof publicBetaCandidateLockApi.buildGlobalShoppingPublicBetaCandidateLock === "function" ? publicBetaCandidateLockApi.buildGlobalShoppingPublicBetaCandidateLock({
      publicBetaFinalReadinessCommandCenterSummary:publicBetaFinalReadinessCommandCenterSummary,
      offlineLaunchBlockerMatrixSummary:offlineLaunchBlockerMatrixSummary,
      manualNextPhaseDossierSummary:manualNextPhaseDossierSummary,
    ...
    const publicBetaCandidateLockStatus = text(publicBetaCandidateLockSummary && (publicBetaCandidateLockSummary.status || publicBetaCandidateLockSummary.candidateLockStatus) || "");
    const finalTrialHandoffConsoleApi = window.WeishanGlobalShoppingFinalTrialHandoffConsole || {};
    const finalTrialHandoffConsoleSummary = safe.finalTrialHandoffConsoleSummary && typeof safe.finalTrialHandoffConsoleSummary === "object" ? safe.finalTrialHandoffConsoleSummary : (typeof finalTrialHandoffConsoleApi.buildGlobalShoppingFinalTrialHandoffConsole === "function" ? finalTrialHandoffConsoleApi.buildGlobalShoppingFinalTrialHandoffConsole({
    ...
    const finalTrialHandoffStatus = text(finalTrialHandoffConsoleSummary && (finalTrialHandoffConsoleSummary.status || finalTrialHandoffConsoleSummary.handoffStatus) || "");
    const noProviderProductionBoundaryApi = window.WeishanGlobalShoppingNoProviderProductionBoundary || {};
    const noProviderProductionBoundarySummary = safe.noProviderProductionBoundarySummary && typeof safe.noProviderProductionBoundarySummary === "object" ? safe.noProviderProductionBoundarySummary : (typeof noProviderProductionBoundaryApi.buildGlobalShoppingNoProviderProductionBoundary === "function" ? noProviderProductionBoundaryApi.buildGlobalShoppingNoProviderProductionBoundary({
      publicBetaCandidateLockSummary:publicBetaCandidateLockSummary,
      offlineLaunchBlockerMatrixSummary:offlineLaunchBlockerMatrixSummary,
      noLaunchAssuranceGateSummary:noLaunchAssuranceGateSummary,
      offlineTrialReleaseGateSummary:offlineTrialReleaseGateSummary,
    ...
    const noProviderProductionBoundaryStatus = text(noProviderProductionBoundarySummary && (noProviderProductionBoundarySummary.status || noProviderProductionBoundarySummary.boundaryStatus) || "");
    const publicBetaCandidateViewModelApi = window.WeishanGlobalShoppingPublicBetaCandidateViewModel || {};
    const publicBetaCandidateViewModelSummary = safe.publicBetaCandidateViewModelSummary && typeof safe.publicBetaCandidateViewModelSummary === "object" ? safe.publicBetaCandidateViewModelSummary : (typeof publicBetaCandidateViewModelApi.buildGlobalShoppingPublicBetaCandidateViewModel === "function" ? publicBetaCandidateViewModelApi.buildGlobalShoppingPublicBetaCandidateViewModel({
      publicBetaCandidateLockSummary:publicBetaCandidateLockSummary,
    ...
    const publicBetaCandidateViewModelStatus = text(publicBetaCandidateViewModelSummary && publicBetaCandidateViewModelSummary.status || "");
    const publicBetaCandidateEvidenceReviewApi = window.WeishanGlobalShoppingPublicBetaCandidateEvidenceReview || {};
    const publicBetaCandidateEvidenceReviewSummary = safe.publicBetaCandidateEvidenceReviewSummary && typeof safe.publicBetaCandidateEvidenceReviewSummary === "object" ? safe.publicBetaCandidateEvidenceReviewSummary : (typeof publicBetaCandidateEvidenceReviewApi.buildGlobalShoppingPublicBetaCandidateEvidenceReview === "function" ? publicBetaCandidateEvidenceReviewApi.buildGlobalShoppingPublicBetaCandidateEvidenceReview({
      publicBetaCandidateLockSummary:publicBetaCandidateLockSummary,
      finalTrialHandoffConsoleSummary:finalTrialHandoffConsoleSummary,
      noProviderProductionBoundarySummary:noProviderProductionBoundarySummary,
    ...
    const publicBetaCandidateEvidenceReviewStatus = text(publicBetaCandidateEvidenceReviewSummary && (publicBetaCandidateEvidenceReviewSummary.status || publicBetaCandidateEvidenceReviewSummary.evidenceReviewStatus) || "");
    const trialOperatorNotesPanelApi = window.WeishanGlobalShoppingTrialOperatorNotesPanel || {};
    const trialOperatorNotesPanelSummary = safe.trialOperatorNotesPanelSummary && typeof safe.trialOperatorNotesPanelSummary === "object" ? safe.trialOperatorNotesPanelSummary : (typeof trialOperatorNotesPanelApi.buildGlobalShoppingTrialOperatorNotesPanel === "function" ? trialOperatorNotesPanelApi.buildGlobalShoppingTrialOperatorNotesPanel({
    ...
    const trialOperatorNotesStatus = text(trialOperatorNotesPanelSummary && (trialOperatorNotesPanelSummary.status || trialOperatorNotesPanelSummary.notesStatus) || "");
    const offlineSafetyDeltaBoardApi = window.WeishanGlobalShoppingOfflineSafetyDeltaBoard || {};
    const offlineSafetyDeltaBoardSummary = safe.offlineSafetyDeltaBoardSummary && typeof safe.offlineSafetyDeltaBoardSummary === "object" ? safe.offlineSafetyDeltaBoardSummary : (typeof offlineSafetyDeltaBoardApi.buildGlobalShoppingOfflineSafetyDeltaBoard === "function" ? offlineSafetyDeltaBoardApi.buildGlobalShoppingOfflineSafetyDeltaBoard({
      publicBetaCandidateEvidenceReviewSummary:publicBetaCandidateEvidenceReviewSummary,
    ...
    const offlineSafetyDeltaStatus = text(offlineSafetyDeltaBoardSummary && (offlineSafetyDeltaBoardSummary.status || offlineSafetyDeltaBoardSummary.deltaStatus) || "");
    const publicBetaCandidateReviewViewModelApi = window.WeishanGlobalShoppingPublicBetaCandidateReviewViewModel || {};
    const publicBetaCandidateReviewViewModelSummary = safe.publicBetaCandidateReviewViewModelSummary && typeof safe.publicBetaCandidateReviewViewModelSummary === "object" ? safe.publicBetaCandidateReviewViewModelSummary : (typeof publicBetaCandidateReviewViewModelApi.buildGlobalShoppingPublicBetaCandidateReviewViewModel === "function" ? publicBetaCandidateReviewViewModelApi.buildGlobalShoppingPublicBetaCandidateReviewViewModel({
      publicBetaCandidateEvidenceReviewSummary:publicBetaCandidateEvidenceReviewSummary,
      trialOperatorNotesPanelSummary:trialOperatorNotesPanelSummary,
      offlineSafetyDeltaBoardSummary:offlineSafetyDeltaBoardSummary
    }) : null);
    const publicBetaCandidateReviewViewModelStatus = text(publicBetaCandidateReviewViewModelSummary && publicBetaCandidateReviewViewModelSummary.status || "");
    const publicBetaCandidateQaFreezeApi = window.WeishanGlobalShoppingPublicBetaCandidateQaFreeze || {};
    const publicBetaCandidateQaFreezeSummary = safe.publicBetaCandidateQaFreezeSummary && typeof safe.publicBetaCandidateQaFreezeSummary === "object" ? safe.publicBetaCandidateQaFreezeSummary : (typeof publicBetaCandidateQaFreezeApi.buildGlobalShoppingPublicBetaCandidateQaFreeze === "function" ? publicBetaCandidateQaFreezeApi.buildGlobalShoppingPublicBetaCandidateQaFreeze({
      publicBetaCandidateEvidenceReviewSummary:publicBetaCandidateEvidenceReviewSummary,
      trialOperatorNotesPanelSummary:trialOperatorNotesPanelSummary,
      offlineSafetyDeltaBoardSummary:offlineSafetyDeltaBoardSummary,
    ...
    const publicBetaCandidateQaFreezeStatus = text(publicBetaCandidateQaFreezeSummary && (publicBetaCandidateQaFreezeSummary.status || publicBetaCandidateQaFreezeSummary.qaFreezeStatus) || "");
    const trialFeedbackIntakeMockApi = window.WeishanGlobalShoppingTrialFeedbackIntakeMock || {};
    const trialFeedbackIntakeMockSummary = safe.trialFeedbackIntakeMockSummary && typeof safe.trialFeedbackIntakeMockSummary === "object" ? safe.trialFeedbackIntakeMockSummary : (typeof trialFeedbackIntakeMockApi.buildGlobalShoppingTrialFeedbackIntakeMock === "function" ? trialFeedbackIntakeMockApi.buildGlobalShoppingTrialFeedbackIntakeMock({
    ...
    const trialFeedbackIntakeStatus = text(trialFeedbackIntakeMockSummary && (trialFeedbackIntakeMockSummary.status || trialFeedbackIntakeMockSummary.intakeStatus) || "");
    const offlineRegressionEvidenceBoardApi = window.WeishanGlobalShoppingOfflineRegressionEvidenceBoard || {};
    const offlineRegressionEvidenceBoardSummary = safe.offlineRegressionEvidenceBoardSummary && typeof safe.offlineRegressionEvidenceBoardSummary === "object" ? safe.offlineRegressionEvidenceBoardSummary : (typeof offlineRegressionEvidenceBoardApi.buildGlobalShoppingOfflineRegressionEvidenceBoard === "function" ? offlineRegressionEvidenceBoardApi.buildGlobalShoppingOfflineRegressionEvidenceBoard({
      publicBetaCandidateQaFreezeSummary:publicBetaCandidateQaFreezeSummary,
    ...
    const offlineRegressionEvidenceStatus = text(offlineRegressionEvidenceBoardSummary && (offlineRegressionEvidenceBoardSummary.status || offlineRegressionEvidenceBoardSummary.regressionEvidenceStatus) || "");
    const publicBetaQaFreezeViewModelApi = window.WeishanGlobalShoppingPublicBetaQaFreezeViewModel || {};
    const publicBetaQaFreezeViewModelSummary = safe.publicBetaQaFreezeViewModelSummary && typeof safe.publicBetaQaFreezeViewModelSummary === "object" ? safe.publicBetaQaFreezeViewModelSummary : (typeof publicBetaQaFreezeViewModelApi.buildGlobalShoppingPublicBetaQaFreezeViewModel === "function" ? publicBetaQaFreezeViewModelApi.buildGlobalShoppingPublicBetaQaFreezeViewModel({
      publicBetaCandidateQaFreezeSummary:publicBetaCandidateQaFreezeSummary,
      trialFeedbackIntakeMockSummary:trialFeedbackIntakeMockSummary,
      offlineRegressionEvidenceBoardSummary:offlineRegressionEvidenceBoardSummary
    }) : null);
    const publicBetaQaFreezeViewModelStatus = text(publicBetaQaFreezeViewModelSummary && publicBetaQaFreezeViewModelSummary.status || "");
    const publicBetaReadinessSnapshotApi = window.WeishanGlobalShoppingPublicBetaReadinessSnapshot || {};
    const publicBetaReadinessSnapshotSummary = safe.publicBetaReadinessSnapshotSummary && typeof safe.publicBetaReadinessSnapshotSummary === "object" ? safe.publicBetaReadinessSnapshotSummary : (typeof publicBetaReadinessSnapshotApi.buildGlobalShoppingPublicBetaReadinessSnapshot === "function" ? publicBetaReadinessSnapshotApi.buildGlobalShoppingPublicBetaReadinessSnapshot({
      publicBetaCandidateQaFreezeSummary:publicBetaCandidateQaFreezeSummary,
      trialFeedbackIntakeMockSummary:trialFeedbackIntakeMockSummary,
      offlineRegressionEvidenceBoardSummary:offlineRegressionEvidenceBoardSummary,
    ...
    const publicBetaReadinessSnapshotStatus = text(publicBetaReadinessSnapshotSummary && (publicBetaReadinessSnapshotSummary.status || publicBetaReadinessSnapshotSummary.readinessSnapshotStatus) || "");
    const manualFeedbackReviewQueueMockApi = window.WeishanGlobalShoppingManualFeedbackReviewQueueMock || {};
    const manualFeedbackReviewQueueMockSummary = safe.manualFeedbackReviewQueueMockSummary && typeof safe.manualFeedbackReviewQueueMockSummary === "object" ? safe.manualFeedbackReviewQueueMockSummary : (typeof manualFeedbackReviewQueueMockApi.buildGlobalShoppingManualFeedbackReviewQueueMock === "function" ? manualFeedbackReviewQueueMockApi.buildGlobalShoppingManualFeedbackReviewQueueMock({
    ...
    const manualFeedbackReviewQueueStatus = text(manualFeedbackReviewQueueMockSummary && (manualFeedbackReviewQueueMockSummary.status || manualFeedbackReviewQueueMockSummary.queueStatus) || "");
    const offlineIssueTriageBoardApi = window.WeishanGlobalShoppingOfflineIssueTriageBoard || {};
    const offlineIssueTriageBoardSummary = safe.offlineIssueTriageBoardSummary && typeof safe.offlineIssueTriageBoardSummary === "object" ? safe.offlineIssueTriageBoardSummary : (typeof offlineIssueTriageBoardApi.buildGlobalShoppingOfflineIssueTriageBoard === "function" ? offlineIssueTriageBoardApi.buildGlobalShoppingOfflineIssueTriageBoard({
      publicBetaReadinessSnapshotSummary:publicBetaReadinessSnapshotSummary,
    ...
    const offlineIssueTriageStatus = text(offlineIssueTriageBoardSummary && (offlineIssueTriageBoardSummary.status || offlineIssueTriageBoardSummary.triageStatus) || "");
    const publicBetaReadinessReviewViewModelApi = window.WeishanGlobalShoppingPublicBetaReadinessReviewViewModel || {};
    const publicBetaReadinessReviewViewModelSummary = safe.publicBetaReadinessReviewViewModelSummary && typeof safe.publicBetaReadinessReviewViewModelSummary === "object" ? safe.publicBetaReadinessReviewViewModelSummary : (typeof publicBetaReadinessReviewViewModelApi.buildGlobalShoppingPublicBetaReadinessReviewViewModel === "function" ? publicBetaReadinessReviewViewModelApi.buildGlobalShoppingPublicBetaReadinessReviewViewModel({
      publicBetaReadinessSnapshotSummary:publicBetaReadinessSnapshotSummary,
      manualFeedbackReviewQueueMockSummary:manualFeedbackReviewQueueMockSummary,
      offlineIssueTriageBoardSummary:offlineIssueTriageBoardSummary
    }) : null);
    const publicBetaReadinessReviewViewModelStatus = text(publicBetaReadinessReviewViewModelSummary && publicBetaReadinessReviewViewModelSummary.status || "");
    const publicBetaManualAcceptanceChecklistApi = window.WeishanGlobalShoppingPublicBetaManualAcceptanceChecklist || {};
    const publicBetaManualAcceptanceChecklistSummary = safe.publicBetaManualAcceptanceChecklistSummary && typeof safe.publicBetaManualAcceptanceChecklistSummary === "object" ? safe.publicBetaManualAcceptanceChecklistSummary : (typeof publicBetaManualAcceptanceChecklistApi.buildGlobalShoppingPublicBetaManualAcceptanceChecklist === "function" ? publicBetaManualAcceptanceChecklistApi.buildGlobalShoppingPublicBetaManualAcceptanceChecklist({
      checklistMode:"manual_acceptance_checklist_only",
      publicBetaReadinessSnapshotSummary:publicBetaReadinessSnapshotSummary,
      manualFeedbackReviewQueueMockSummary:manualFeedbackReviewQueueMockSummary,
      offlineIssueTriageBoardSummary:offlineIssueTriageBoardSummary,
    ...
    const publicBetaManualAcceptanceChecklistStatus = text(publicBetaManualAcceptanceChecklistSummary && (publicBetaManualAcceptanceChecklistSummary.status || publicBetaManualAcceptanceChecklistSummary.acceptanceChecklistStatus) || "");
    const offlineUserScenarioPackApi = window.WeishanGlobalShoppingOfflineUserScenarioPack || {};
    const offlineUserScenarioPackSummary = safe.offlineUserScenarioPackSummary && typeof safe.offlineUserScenarioPackSummary === "object" ? safe.offlineUserScenarioPackSummary : (typeof offlineUserScenarioPackApi.buildGlobalShoppingOfflineUserScenarioPack === "function" ? offlineUserScenarioPackApi.buildGlobalShoppingOfflineUserScenarioPack({
      packMode:"offline_user_scenario_pack_only",
    ...
    const offlineUserScenarioPackStatus = text(offlineUserScenarioPackSummary && (offlineUserScenarioPackSummary.status || offlineUserScenarioPackSummary.scenarioPackStatus) || "");
    const noDataRetentionGuardApi = window.WeishanGlobalShoppingNoDataRetentionGuard || {};
    const noDataRetentionGuardSummary = safe.noDataRetentionGuardSummary && typeof safe.noDataRetentionGuardSummary === "object" ? safe.noDataRetentionGuardSummary : (typeof noDataRetentionGuardApi.buildGlobalShoppingNoDataRetentionGuard === "function" ? noDataRetentionGuardApi.buildGlobalShoppingNoDataRetentionGuard({
      guardMode:"no_data_retention_guard_only",
      publicBetaManualAcceptanceChecklistSummary:publicBetaManualAcceptanceChecklistSummary,
    ...
    const noDataRetentionStatus = text(noDataRetentionGuardSummary && (noDataRetentionGuardSummary.status || noDataRetentionGuardSummary.noDataRetentionStatus) || "");
    const publicBetaAcceptanceReviewViewModelApi = window.WeishanGlobalShoppingPublicBetaAcceptanceReviewViewModel || {};
    const publicBetaAcceptanceReviewViewModelSummary = safe.publicBetaAcceptanceReviewViewModelSummary && typeof safe.publicBetaAcceptanceReviewViewModelSummary === "object" ? safe.publicBetaAcceptanceReviewViewModelSummary : (typeof publicBetaAcceptanceReviewViewModelApi.buildGlobalShoppingPublicBetaAcceptanceReviewViewModel === "function" ? publicBetaAcceptanceReviewViewModelApi.buildGlobalShoppingPublicBetaAcceptanceReviewViewModel({
      publicBetaManualAcceptanceChecklistSummary:publicBetaManualAcceptanceChecklistSummary,
      offlineUserScenarioPackSummary:offlineUserScenarioPackSummary,
      noDataRetentionGuardSummary:noDataRetentionGuardSummary
    }) : null);
    const publicBetaAcceptanceReviewViewModelStatus = text(publicBetaAcceptanceReviewViewModelSummary && publicBetaAcceptanceReviewViewModelSummary.status || "");
    const publicBetaOfflineAcceptanceEvidenceCenterApi = window.WeishanGlobalShoppingPublicBetaOfflineAcceptanceEvidenceCenter || {};
    const publicBetaOfflineAcceptanceEvidenceCenterSummary = safe.publicBetaOfflineAcceptanceEvidenceCenterSummary && typeof safe.publicBetaOfflineAcceptanceEvidenceCenterSummary === "object" ? safe.publicBetaOfflineAcceptanceEvidenceCenterSummary : (typeof publicBetaOfflineAcceptanceEvidenceCenterApi.buildGlobalShoppingPublicBetaOfflineAcceptanceEvidenceCenter === "function" ? publicBetaOfflineAcceptanceEvidenceCenterApi.buildGlobalShoppingPublicBetaOfflineAcceptanceEvidenceCenter({
      centerMode:"offline_acceptance_evidence_center_only",
      publicBetaManualAcceptanceChecklistSummary:publicBetaManualAcceptanceChecklistSummary,
      offlineUserScenarioPackSummary:offlineUserScenarioPackSummary,
      noDataRetentionGuardSummary:noDataRetentionGuardSummary,
    ...
    const publicBetaOfflineAcceptanceEvidenceCenterStatus = text(publicBetaOfflineAcceptanceEvidenceCenterSummary && (publicBetaOfflineAcceptanceEvidenceCenterSummary.status || publicBetaOfflineAcceptanceEvidenceCenterSummary.evidenceCenterStatus) || "");
    const manualScenarioReviewBoardApi = window.WeishanGlobalShoppingManualScenarioReviewBoard || {};
    const manualScenarioReviewBoardSummary = safe.manualScenarioReviewBoardSummary && typeof safe.manualScenarioReviewBoardSummary === "object" ? safe.manualScenarioReviewBoardSummary : (typeof manualScenarioReviewBoardApi.buildGlobalShoppingManualScenarioReviewBoard === "function" ? manualScenarioReviewBoardApi.buildGlobalShoppingManualScenarioReviewBoard({
      boardMode:"manual_scenario_review_board_only",
    ...
    const manualScenarioReviewStatus = text(manualScenarioReviewBoardSummary && (manualScenarioReviewBoardSummary.status || manualScenarioReviewBoardSummary.scenarioReviewStatus) || "");
    const zeroPersistenceRegressionGateApi = window.WeishanGlobalShoppingZeroPersistenceRegressionGate || {};
    const zeroPersistenceRegressionGateSummary = safe.zeroPersistenceRegressionGateSummary && typeof safe.zeroPersistenceRegressionGateSummary === "object" ? safe.zeroPersistenceRegressionGateSummary : (typeof zeroPersistenceRegressionGateApi.buildGlobalShoppingZeroPersistenceRegressionGate === "function" ? zeroPersistenceRegressionGateApi.buildGlobalShoppingZeroPersistenceRegressionGate({
      gateMode:"zero_persistence_regression_gate_only",
      publicBetaOfflineAcceptanceEvidenceCenterSummary:publicBetaOfflineAcceptanceEvidenceCenterSummary,
    ...
    const zeroPersistenceStatus = text(zeroPersistenceRegressionGateSummary && (zeroPersistenceRegressionGateSummary.status || zeroPersistenceRegressionGateSummary.zeroPersistenceStatus) || "");
    const publicBetaOfflineAcceptanceViewModelApi = window.WeishanGlobalShoppingPublicBetaOfflineAcceptanceViewModel || {};
    const publicBetaOfflineAcceptanceViewModelSummary = safe.publicBetaOfflineAcceptanceViewModelSummary && typeof safe.publicBetaOfflineAcceptanceViewModelSummary === "object" ? safe.publicBetaOfflineAcceptanceViewModelSummary : (typeof publicBetaOfflineAcceptanceViewModelApi.buildGlobalShoppingPublicBetaOfflineAcceptanceViewModel === "function" ? publicBetaOfflineAcceptanceViewModelApi.buildGlobalShoppingPublicBetaOfflineAcceptanceViewModel({
      publicBetaOfflineAcceptanceEvidenceCenterSummary:publicBetaOfflineAcceptanceEvidenceCenterSummary,
      manualScenarioReviewBoardSummary:manualScenarioReviewBoardSummary,
      zeroPersistenceRegressionGateSummary:zeroPersistenceRegressionGateSummary
    }) : null);
    const publicBetaOfflineAcceptanceViewModelStatus = text(publicBetaOfflineAcceptanceViewModelSummary && publicBetaOfflineAcceptanceViewModelSummary.status || "");
    const publicBetaFinalAcceptanceLockApi = window.WeishanGlobalShoppingPublicBetaFinalAcceptanceLock || {};
    const publicBetaFinalAcceptanceLockSummary = safe.publicBetaFinalAcceptanceLockSummary && typeof safe.publicBetaFinalAcceptanceLockSummary === "object" ? safe.publicBetaFinalAcceptanceLockSummary : (typeof publicBetaFinalAcceptanceLockApi.buildGlobalShoppingPublicBetaFinalAcceptanceLock === "function" ? publicBetaFinalAcceptanceLockApi.buildGlobalShoppingPublicBetaFinalAcceptanceLock({
      lockMode:"final_acceptance_lock_only",
      publicBetaOfflineAcceptanceEvidenceCenterSummary:publicBetaOfflineAcceptanceEvidenceCenterSummary,
      manualScenarioReviewBoardSummary:manualScenarioReviewBoardSummary,
      zeroPersistenceRegressionGateSummary:zeroPersistenceRegressionGateSummary,
    ...
    const publicBetaFinalAcceptanceLockStatus = text(publicBetaFinalAcceptanceLockSummary && (publicBetaFinalAcceptanceLockSummary.status || publicBetaFinalAcceptanceLockSummary.finalAcceptanceLockStatus) || "");
    const offlineReleaseCandidateAuditApi = window.WeishanGlobalShoppingOfflineReleaseCandidateAudit || {};
    const offlineReleaseCandidateAuditSummary = safe.offlineReleaseCandidateAuditSummary && typeof safe.offlineReleaseCandidateAuditSummary === "object" ? safe.offlineReleaseCandidateAuditSummary : (typeof offlineReleaseCandidateAuditApi.buildGlobalShoppingOfflineReleaseCandidateAudit === "function" ? offlineReleaseCandidateAuditApi.buildGlobalShoppingOfflineReleaseCandidateAudit({
      auditMode:"offline_release_candidate_audit_only",
    ...
    const offlineReleaseCandidateAuditStatus = text(offlineReleaseCandidateAuditSummary && (offlineReleaseCandidateAuditSummary.status || offlineReleaseCandidateAuditSummary.releaseCandidateAuditStatus) || "");
    const zeroActionSafetyConsoleApi = window.WeishanGlobalShoppingZeroActionSafetyConsole || {};
    const zeroActionSafetyConsoleSummary = safe.zeroActionSafetyConsoleSummary && typeof safe.zeroActionSafetyConsoleSummary === "object" ? safe.zeroActionSafetyConsoleSummary : (typeof zeroActionSafetyConsoleApi.buildGlobalShoppingZeroActionSafetyConsole === "function" ? zeroActionSafetyConsoleApi.buildGlobalShoppingZeroActionSafetyConsole({
      consoleMode:"zero_action_safety_console_only",
      publicBetaFinalAcceptanceLockSummary:publicBetaFinalAcceptanceLockSummary,
      offlineReleaseCandidateAuditSummary:offlineReleaseCandidateAuditSummary,
      zeroPersistenceRegressionGateSummary:zeroPersistenceRegressionGateSummary,
      manualReviewRequired:true
    }) : null);
    const zeroActionSafetyStatus = text(zeroActionSafetyConsoleSummary && (zeroActionSafetyConsoleSummary.status || zeroActionSafetyConsoleSummary.zeroActionStatus) || "");
    const publicBetaFinalAcceptanceViewModelApi = window.WeishanGlobalShoppingPublicBetaFinalAcceptanceViewModel || {};
    const publicBetaFinalAcceptanceViewModelSummary = safe.publicBetaFinalAcceptanceViewModelSummary && typeof safe.publicBetaFinalAcceptanceViewModelSummary === "object" ? safe.publicBetaFinalAcceptanceViewModelSummary : (typeof publicBetaFinalAcceptanceViewModelApi.buildGlobalShoppingPublicBetaFinalAcceptanceViewModel === "function" ? publicBetaFinalAcceptanceViewModelApi.buildGlobalShoppingPublicBetaFinalAcceptanceViewModel({
      publicBetaFinalAcceptanceLockSummary:publicBetaFinalAcceptanceLockSummary,
      offlineReleaseCandidateAuditSummary:offlineReleaseCandidateAuditSummary,
      zeroActionSafetyConsoleSummary:zeroActionSafetyConsoleSummary
    }) : null);
    const publicBetaFinalAcceptanceViewModelStatus = text(publicBetaFinalAcceptanceViewModelSummary && publicBetaFinalAcceptanceViewModelSummary.status || "");
    const publicBetaOperatorViewModelSummary = safe.publicBetaOperatorViewModelSummary && typeof safe.publicBetaOperatorViewModelSummary === "object" ? safe.publicBetaOperatorViewModelSummary : (typeof globalShoppingPublicBetaOperatorViewModelApi.buildGlobalShoppingPublicBetaOperatorViewModel === "function" ? globalShoppingPublicBetaOperatorViewModelApi.buildGlobalShoppingPublicBetaOperatorViewModel({ publicBetaOperatorConsoleSummary:publicBetaOperatorConsoleSummary, categoryExpansionShellSummary:categoryExpansionShellSummary, publicBetaUserJourneyShellSummary:publicBetaUserJourneyShellSummary, safeSearchIntentMatrixSummary:safeSearchIntentMatrixSummary, publicBetaUserBoundaryPanelSummary:publicBetaUserBoundaryPanelSummary, categoryResultSimulatorSummary:categoryResultSimulatorSummary, readOnlyComparisonBoardSummary:readOnlyComparisonBoardSummary, resultTrustBadgePanelSummary:resultTrustBadgePanelSummary, publicBetaTrialReadinessPackSummary:publicBetaTrialReadinessPackSummary, finalManualAcceptanceConsoleSummary:finalManualAcceptanceConsoleSummary, publicBetaFeedbackPlaceholderSummary:publicBetaFeedbackPlaceholderSummary, publicBetaFinalManualViewModelSummary:publicBetaFinalManualViewModelSummary, finalOfflineBetaAuditSummary:finalOfflineBetaAuditSummary, publicBetaAcceptanceBoardSummary:publicBetaAcceptanceBoardSummary }) : null);
    const publicBetaOperatorViewModelStatus = text(publicBetaOperatorViewModelSummary && publicBetaOperatorViewModelSummary.status || "");
    const safeToProceedWithManualPublicBetaAcceptanceReview = publicBetaOperatorViewModelSummary && publicBetaOperatorViewModelSummary.safeToProceedWithManualPublicBetaAcceptanceReview === true;
    const safeToProceedWithManualTrialReview = publicBetaFinalManualViewModelSummary && publicBetaFinalManualViewModelSummary.safeToProceedWithManualTrialReview === true;
    const safeToProceedWithManualVisualQaReview = publicBetaQaViewModelSummary && publicBetaQaViewModelSummary.safeToProceedWithManualVisualQaReview === true;
    const safeToProceedWithManualRcReview = publicBetaRcViewModelSummary && publicBetaRcViewModelSummary.safeToProceedWithManualRcReview === true;
    const safeToProceedWithManualLaunchHandoffReview = manualLaunchHandoffViewModelSummary && manualLaunchHandoffViewModelSummary.safeToProceedWithManualLaunchHandoffReview === true;
    const safeToProceedWithManualQaReview = publicBetaManualQaViewModelSummary && publicBetaManualQaViewModelSummary.safeToProceedWithManualQaReview === true;
    const safeToProceedWithManualTrialOperationsReview = publicBetaTrialOperationsViewModelSummary && publicBetaTrialOperationsViewModelSummary.safeToProceedWithManualTrialOperationsReview === true;
    const safeToProceedWithManualQaOperationsReview = publicBetaQaOperationsViewModelSummary && publicBetaQaOperationsViewModelSummary.safeToProceedWithManualQaOperationsReview === true;
    const safeToProceedWithManualFreezeReview = publicBetaFreezeReviewViewModelSummary && publicBetaFreezeReviewViewModelSummary.safeToProceedWithManualFreezeReview === true;
    const safeToProceedWithManualAcceptanceSnapshotReview = publicBetaAcceptanceSnapshotViewModelSummary && publicBetaAcceptanceSnapshotViewModelSummary.safeToProceedWithManualAcceptanceSnapshotReview === true;
    const safeToProceedWithManualClosureReview = publicBetaClosureReviewViewModelSummary && publicBetaClosureReviewViewModelSummary.safeToProceedWithManualClosureReview === true;
    const safeToProceedWithManualNextStepReview = publicBetaNextStepViewModelSummary && publicBetaNextStepViewModelSummary.safeToProceedWithManualNextStepReview === true;
    const safeToProceedWithManualFinalReadinessReview = publicBetaFinalReadinessViewModelSummary && publicBetaFinalReadinessViewModelSummary.safeToProceedWithManualFinalReadinessReview === true;
    const safeToProceedWithManualCandidateReview = publicBetaCandidateViewModelSummary && publicBetaCandidateViewModelSummary.safeToProceedWithManualCandidateReview === true;
    const safeToProceedWithManualCandidateEvidenceReview = publicBetaCandidateReviewViewModelSummary && publicBetaCandidateReviewViewModelSummary.safeToProceedWithManualCandidateEvidenceReview === true;
    const safeToProceedWithManualQaFreezeReview = publicBetaQaFreezeViewModelSummary && publicBetaQaFreezeViewModelSummary.safeToProceedWithManualQaFreezeReview === true;
    const safeToProceedWithManualReadinessReview = publicBetaReadinessReviewViewModelSummary && publicBetaReadinessReviewViewModelSummary.safeToProceedWithManualReadinessReview === true;
    const safeToProceedWithManualAcceptanceReview = publicBetaAcceptanceReviewViewModelSummary && publicBetaAcceptanceReviewViewModelSummary.safeToProceedWithManualAcceptanceReview === true;
    const safeToProceedWithManualOfflineAcceptanceReview = publicBetaOfflineAcceptanceViewModelSummary && publicBetaOfflineAcceptanceViewModelSummary.safeToProceedWithManualOfflineAcceptanceReview === true;
    const safeToProceedWithManualFinalAcceptanceReview = publicBetaFinalAcceptanceViewModelSummary && publicBetaFinalAcceptanceViewModelSummary.safeToProceedWithManualFinalAcceptanceReview === true;
    ...
    const riskBadgeModel = typeof riskBadgeApi.buildFlightWorkflowRiskBadges === "function" ? riskBadgeApi.buildFlightWorkflowRiskBadges(Object.assign({
      ...
      offlineReleaseCandidateAuditSummary:offlineReleaseCandidateAuditSummary,
      zeroActionSafetyConsoleSummary:zeroActionSafetyConsoleSummary,
      publicBetaFinalAcceptanceViewModelSummary:publicBetaFinalAcceptanceViewModelSummary,
      publicBetaFreezeEvidenceStatus:publicBetaFreezeEvidenceStatus,
      manualTrialIssueReviewStatus:manualTrialIssueReviewStatus,
      offlineAcceptanceSnapshotStatus:offlineAcceptanceSnapshotStatus,
      publicBetaAcceptanceSnapshotViewModelStatus:publicBetaAcceptanceSnapshotViewModelStatus,
      publicBetaAcceptanceReviewConsoleStatus:publicBetaAcceptanceReviewConsoleStatus,
      offlineTrialClosureBoardStatus:offlineTrialClosureBoardStatus,
      noLaunchAssuranceGateStatus:noLaunchAssuranceGateStatus,
      publicBetaClosureReviewViewModelStatus:publicBetaClosureReviewViewModelStatus,
      publicBetaClosureEvidenceArchiveStatus:publicBetaClosureEvidenceArchiveStatus,
      manualTrialExitCriteriaStatus:manualTrialExitCriteriaStatus,
      offlineNextStepPlanningStatus:offlineNextStepPlanningStatus,
      publicBetaNextStepViewModelStatus:publicBetaNextStepViewModelStatus,
      publicBetaFinalReadinessCommandCenterStatus:publicBetaFinalReadinessCommandCenterStatus,
      offlineLaunchBlockerMatrixStatus:offlineLaunchBlockerMatrixStatus,
      manualNextPhaseDossierStatus:manualNextPhaseDossierStatus,
      publicBetaFinalReadinessViewModelStatus:publicBetaFinalReadinessViewModelStatus,
      publicBetaCandidateLockStatus:publicBetaCandidateLockStatus,
      finalTrialHandoffStatus:finalTrialHandoffStatus,
      noProviderProductionBoundaryStatus:noProviderProductionBoundaryStatus,
      publicBetaCandidateViewModelStatus:publicBetaCandidateViewModelStatus,
      publicBetaFinalAcceptanceLockStatus:publicBetaFinalAcceptanceLockStatus,
      offlineReleaseCandidateAuditStatus:offlineReleaseCandidateAuditStatus,
      zeroActionSafetyStatus:zeroActionSafetyStatus,
      publicBetaFinalAcceptanceViewModelStatus:publicBetaFinalAcceptanceViewModelStatus,
      publicBetaCandidateEvidenceReviewStatus:publicBetaCandidateEvidenceReviewStatus,
      trialOperatorNotesStatus:trialOperatorNotesStatus,
      offlineSafetyDeltaStatus:offlineSafetyDeltaStatus,
      publicBetaCandidateReviewViewModelStatus:publicBetaCandidateReviewViewModelStatus,
      publicBetaCandidateQaFreezeStatus:publicBetaCandidateQaFreezeStatus,
      trialFeedbackIntakeStatus:trialFeedbackIntakeStatus,
      offlineRegressionEvidenceStatus:offlineRegressionEvidenceStatus,
      publicBetaQaFreezeViewModelStatus:publicBetaQaFreezeViewModelStatus,
      safeToProceedWithManualFreezeReview:safeToProceedWithManualFreezeReview,
      safeToProceedWithManualAcceptanceSnapshotReview:safeToProceedWithManualAcceptanceSnapshotReview,
      safeToProceedWithManualClosureReview:safeToProceedWithManualClosureReview,
      safeToProceedWithManualNextStepReview:safeToProceedWithManualNextStepReview,
      safeToProceedWithManualFinalReadinessReview:safeToProceedWithManualFinalReadinessReview,
      safeToProceedWithManualFinalAcceptanceReview:safeToProceedWithManualFinalAcceptanceReview,
      safeToProceedWithManualCandidateReview:safeToProceedWithManualCandidateReview,
      safeToProceedWithManualCandidateEvidenceReview:safeToProceedWithManualCandidateEvidenceReview,
      safeToProceedWithManualQaFreezeReview:safeToProceedWithManualQaFreezeReview,
      publicBetaCandidateQaFreezeSummary:publicBetaCandidateQaFreezeSummary,
      trialFeedbackIntakeMockSummary:trialFeedbackIntakeMockSummary,
      offlineRegressionEvidenceBoardSummary:offlineRegressionEvidenceBoardSummary,
      publicBetaQaFreezeViewModelSummary:publicBetaQaFreezeViewModelSummary,
    ...
    const reportCenterModel = typeof reportCenterApi.buildReadOnlyQuoteSessionReportCenter === "function" ? reportCenterApi.buildReadOnlyQuoteSessionReportCenter(Object.assign({
      ...
      publicBetaRcConsoleSummary:publicBetaRcConsoleSummary,
      offlineTrialReleaseGateSummary:offlineTrialReleaseGateSummary,
      publicBetaRcViewModelSummary:publicBetaRcViewModelSummary,
      publicBetaStabilityAuditSummary:publicBetaStabilityAuditSummary,
      manualLaunchHandoffPackSummary:manualLaunchHandoffPackSummary,
      manualLaunchHandoffViewModelSummary:manualLaunchHandoffViewModelSummary,
    ...
    return clone({
      ...
      manualQaScenarioRunnerSummary:manualQaScenarioRunnerSummary,
      offlineFeedbackReviewBoardSummary:offlineFeedbackReviewBoardSummary,
      publicBetaTrialOperationsViewModelSummary:publicBetaTrialOperationsViewModelSummary,
      publicBetaTrialEvidenceLedgerSummary:publicBetaTrialEvidenceLedgerSummary,
      publicBetaQaDecisionMatrixSummary:publicBetaQaDecisionMatrixSummary,
      publicBetaReadinessSnapshotSummary:publicBetaReadinessSnapshotSummary,
      manualFeedbackReviewQueueMockSummary:manualFeedbackReviewQueueMockSummary,
      ...
      publicBetaRcEvidenceSnapshotStatus:publicBetaRcEvidenceSnapshotStatus,
      publicBetaManualQaViewModelStatus:publicBetaManualQaViewModelStatus,
      publicBetaTrialOperationsConsoleStatus:publicBetaTrialOperationsConsoleStatus,
      manualQaScenarioRunnerStatus:manualQaScenarioRunnerStatus,
      offlineFeedbackReviewBoardStatus:offlineFeedbackReviewBoardStatus,
      publicBetaTrialOperationsViewModelStatus:publicBetaTrialOperationsViewModelStatus,
      publicBetaTrialEvidenceLedgerStatus:publicBetaTrialEvidenceLedgerStatus,
      publicBetaQaDecisionMatrixStatus:publicBetaQaDecisionMatrixStatus,
      publicBetaReadinessSnapshotStatus:publicBetaReadinessSnapshotStatus,
      manualFeedbackReviewQueueStatus:manualFeedbackReviewQueueStatus,
      offlineIssueTriageBoardStatus:offlineIssueTriageStatus,
      offlineIssueTriageStatus:offlineIssueTriageStatus,
      publicBetaReadinessReviewViewModelStatus:publicBetaReadinessReviewViewModelStatus,
      publicBetaManualAcceptanceChecklistStatus:publicBetaManualAcceptanceChecklistStatus,
      offlineUserScenarioPackStatus:offlineUserScenarioPackStatus,
      noDataRetentionStatus:noDataRetentionStatus,
      publicBetaAcceptanceReviewViewModelStatus:publicBetaAcceptanceReviewViewModelStatus,
      publicBetaOfflineAcceptanceEvidenceCenterStatus:publicBetaOfflineAcceptanceEvidenceCenterStatus,
      manualScenarioReviewStatus:manualScenarioReviewStatus,
      zeroPersistenceStatus:zeroPersistenceStatus,
      publicBetaOfflineAcceptanceViewModelStatus:publicBetaOfflineAcceptanceViewModelStatus,
      publicBetaQaOperationsViewModelStatus:publicBetaQaOperationsViewModelStatus,
      publicBetaQaFreezeGateStatus:publicBetaQaFreezeGateStatus,
      manualTrialSummaryBoardStatus:manualTrialSummaryBoardStatus,
      offlineReadinessReviewPanelStatus:offlineReadinessReviewPanelStatus,
      publicBetaFreezeReviewViewModelStatus:publicBetaFreezeReviewViewModelStatus,
      publicBetaFreezeEvidenceSummary:publicBetaFreezeEvidenceSummary,
      manualTrialIssueReviewBoardSummary:manualTrialIssueReviewBoardSummary,
      offlineAcceptanceSnapshotSummary:offlineAcceptanceSnapshotSummary,
      publicBetaAcceptanceSnapshotViewModelSummary:publicBetaAcceptanceSnapshotViewModelSummary,
      ...
      safeToProceedWithManualPublicBetaReview:safeToProceedWithManualPublicBetaReview,
      safeToProceedWithManualVisualQaReview:safeToProceedWithManualVisualQaReview,
      safeToProceedWithManualComparisonReview:safeToProceedWithManualComparisonReview,
      safeToProceedWithManualTrialReview:safeToProceedWithManualTrialReview,
      safeToProceedWithManualPublicBetaAcceptanceReview:safeToProceedWithManualPublicBetaAcceptanceReview,
      safeToProceedWithManualRcReview:safeToProceedWithManualRcReview,
      safeToProceedWithManualLaunchHandoffReview:safeToProceedWithManualLaunchHandoffReview,
      safeToProceedWithManualQaReview:safeToProceedWithManualQaReview,
      safeToProceedWithManualReadinessReview:safeToProceedWithManualReadinessReview,
      safeToProceedWithManualAcceptanceReview:safeToProceedWithManualAcceptanceReview,
      safeToProceedWithManualOfflineAcceptanceReview:safeToProceedWithManualOfflineAcceptanceReview,
      publicBetaFinalAcceptanceLockSummary:publicBetaFinalAcceptanceLockSummary,
      offlineReleaseCandidateAuditSummary:offlineReleaseCandidateAuditSummary,
      zeroActionSafetyConsoleSummary:zeroActionSafetyConsoleSummary,
      publicBetaFinalAcceptanceViewModelSummary:publicBetaFinalAcceptanceViewModelSummary,
      ...
      publicBetaFinalAcceptanceViewModelStatus:publicBetaFinalAcceptanceViewModelStatus,
      safeToProceedWithManualFinalAcceptanceReview:safeToProceedWithManualFinalAcceptanceReview,
      safeToProceedWithManualTrialOperationsReview:safeToProceedWithManualTrialOperationsReview,
      safeToProceedWithManualQaOperationsReview:safeToProceedWithManualQaOperationsReview,
      safeToProceedWithManualFreezeReview:safeToProceedWithManualFreezeReview,
      safeToProceedWithManualAcceptanceSnapshotReview:safeToProceedWithManualAcceptanceSnapshotReview,
      safeToProceedWithManualClosureReview:safeToProceedWithManualClosureReview,
      safeToProceedWithManualNextStepReview:safeToProceedWithManualNextStepReview,
  ...
  function renderReadOnlyPriceCandidateCardHtml(input) {
    ...
    const publicBetaOperatorReviewHtml = card.publicBetaOperatorViewModelSummary ? '<section class="commerce-global-shopping-public-beta-operator-review" data-commerce-global-shopping-public-beta-operator-review="true"><h5>Public Beta Operator Console</h5><p>Public Beta Operator Console</p><p>Category Expansion Shell</p><p>Public Beta User Journey</p><p>Safe Search Intent Matrix</p><p>User Boundary Panel</p><p>Category Result Simulator</p><p>Read-Only Comparison Board</p><p>Result Trust Badge</p><p>Public Beta Trial Readiness Pack</p><p>Final Manual Acceptance Console</p><p>Feedback Placeholder</p><p>Final Offline Beta Audit</p><p>Public Beta Acceptance Board</p><p>Known Limitations</p><p>Manual Review Required</p><p>' + escapeHtml(card.publicBetaOperatorConsoleSummary && card.publicBetaOperatorConsoleSummary.userFacingSummary && card.publicBetaOperatorConsoleSummary.userFacingSummary.resultLabel || 'Public Beta Operator Console 仍需复核') + '</p><p>' + escapeHtml(card.categoryExpansionShellSummary && card.categoryExpansionShellSummary.userFacingSummary && card.categoryExpansionShellSummary.userFacingSummary.resultLabel || 'Category Expansion Shell 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaTrialReadinessPackSummary && card.publicBetaTrialReadinessPackSummary.userFacingSummary && card.publicBetaTrialReadinessPackSummary.userFacingSummary.resultLabel || 'Public Beta Trial Readiness Pack 仍需复核') + '</p><p>' + escapeHtml(card.finalManualAcceptanceConsoleSummary && card.finalManualAcceptanceConsoleSummary.userFacingSummary && card.finalManualAcceptanceConsoleSummary.userFacingSummary.resultLabel || 'Final Manual Acceptance Console 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaFeedbackPlaceholderSummary && card.publicBetaFeedbackPlaceholderSummary.userFacingSummary && card.publicBetaFeedbackPlaceholderSummary.userFacingSummary.resultLabel || 'Feedback Placeholder 仍需复核') + '</p><p>' + escapeHtml(card.finalOfflineBetaAuditSummary && card.finalOfflineBetaAuditSummary.userFacingSummary && card.finalOfflineBetaAuditSummary.userFacingSummary.resultLabel || 'Final Offline Beta Audit 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaAcceptanceBoardSummary && card.publicBetaAcceptanceBoardSummary.userFacingSummary && card.publicBetaAcceptanceBoardSummary.userFacingSummary.resultLabel || 'Public Beta Acceptance Board 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaFinalManualViewModelSummary && card.publicBetaFinalManualViewModelSummary.userFacingSummary && card.publicBetaFinalManualViewModelSummary.userFacingSummary.resultLabel || 'Public Beta Final Manual View Model 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaOperatorViewModelSummary && card.publicBetaOperatorViewModelSummary.userFacingSummary && card.publicBetaOperatorViewModelSummary.userFacingSummary.resultLabel || 'Public Beta Operator View Model 仍需复核') + '</p><p>试用范围：只读候选价、费用归一化、官方价锚点</p><p>锁定能力：provider、联网、付款、下单、出票</p><p>反馈入口暂不发送、不上传、不保存用户原文</p><p>人工验收后再决定下一阶段</p><p>不自动通过</p><p>不自动发布</p><p>不保存反馈内容</p><p>Flight / Hotel / Product 只读外壳已准备</p><p>Provider-Zero 状态通过</p><p>候选价证据通过</p><p>费用归一化通过</p><p>官方价锚点通过</p><p>安全文案通过</p><p>最终离线审计通过</p><p>bookingUrl:null</p><p>payment:false</p><p>order:false</p><p>release:false</p><p>push:false</p></section>' : '';
    const publicBetaQaHtml = card.publicBetaQaViewModelSummary ? '<section class="commerce-global-shopping-public-beta-qa-review" data-commerce-global-shopping-public-beta-qa-review="true"><h5>Public Beta Visual QA Console</h5><p>Public Beta Visual QA Console</p><p>Trial Scenario Checklist</p><p>No-Transaction Regression Guard</p><p>Visual Acceptance</p><p>Scenario Coverage</p><p>Transaction Boundary</p><p>Flight / Hotel / Product / Restricted 场景已覆盖</p><p>交易按钮保持关闭</p><p>未生成 booking / payment / order / checkout URL</p><p>未打开外部平台</p><p>仍需人工视觉验收</p><p>' + escapeHtml(card.publicBetaVisualQaConsoleSummary && card.publicBetaVisualQaConsoleSummary.userFacingSummary && card.publicBetaVisualQaConsoleSummary.userFacingSummary.resultLabel || 'Public Beta Visual QA Console 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaTrialScenarioChecklistSummary && card.publicBetaTrialScenarioChecklistSummary.userFacingSummary && card.publicBetaTrialScenarioChecklistSummary.userFacingSummary.resultLabel || 'Trial Scenario Checklist 仍需复核') + '</p><p>' + escapeHtml(card.noTransactionRegressionGuardSummary && card.noTransactionRegressionGuardSummary.userFacingSummary && card.noTransactionRegressionGuardSummary.userFacingSummary.resultLabel || 'No-Transaction Regression Guard 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaQaViewModelSummary && card.publicBetaQaViewModelSummary.userFacingSummary && card.publicBetaQaViewModelSummary.userFacingSummary.resultLabel || 'Public Beta QA View Model 仍需复核') + '</p><p>Visual QA 只做人工复核，不截图上传，不发送反馈，不打开平台</p><p>Scenario Checklist 仅验证只读试用覆盖，不产生交易</p><p>No-Transaction Regression Guard 持续阻断 booking / payment / order / checkout</p><p>buyButtonEnabled:false</p><p>checkoutButtonEnabled:false</p><p>paymentButtonEnabled:false</p><p>externalUrl:null</p><p>bookingUrl:null</p><p>paymentUrl:null</p><p>orderUrl:null</p></section>' : '';
    const publicBetaOnboardingHtml = card.publicBetaOnboardingViewModelSummary ? '<section class="commerce-global-shopping-public-beta-onboarding" data-commerce-global-shopping-public-beta-onboarding="true"><h5>Public Beta User Onboarding</h5><p>Public Beta User Onboarding</p><p>Visual Trial Guide</p><p>Safe Feedback Draft</p><p>Readonly Capabilities</p><p>Locked Capabilities</p><p>Privacy Boundary</p><p>你可以查看候选价、费用归一化和官方价锚点</p><p>当前不会付款、下单或出票</p><p>不会保存账号、证件或支付信息</p><p>反馈入口目前仅为草稿，不发送、不上传、不保存用户原文</p><p>' + escapeHtml(card.publicBetaUserOnboardingShellSummary && card.publicBetaUserOnboardingShellSummary.userFacingSummary && card.publicBetaUserOnboardingShellSummary.userFacingSummary.resultLabel || 'Public Beta User Onboarding 仍需复核') + '</p><p>' + escapeHtml(card.visualTrialGuideSummary && card.visualTrialGuideSummary.userFacingSummary && card.visualTrialGuideSummary.userFacingSummary.resultLabel || 'Visual Trial Guide 仍需复核') + '</p><p>' + escapeHtml(card.safeFeedbackDraftPanelSummary && card.safeFeedbackDraftPanelSummary.userFacingSummary && card.safeFeedbackDraftPanelSummary.userFacingSummary.resultLabel || 'Safe Feedback Draft 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaOnboardingViewModelSummary && card.publicBetaOnboardingViewModelSummary.userFacingSummary && card.publicBetaOnboardingViewModelSummary.userFacingSummary.resultLabel || 'Public Beta Onboarding View Model 仍需复核') + '</p><p>feedbackEnabled:false</p><p>uploadEnabled:false</p><p>emailEnabled:false</p><p>externalFormUrl:null</p><p>bookingUrl:null</p><p>paymentUrl:null</p><p>orderUrl:null</p></section>' : '';
    const publicBetaRcHtml = card.publicBetaRcViewModelSummary ? '<section class="commerce-global-shopping-public-beta-rc-console" data-commerce-global-shopping-public-beta-rc-console="true"><h5>Public Beta RC Console</h5><p>Offline Trial Release Gate</p><p>No Release Mutation</p><p>No Transaction</p><p>No Provider</p><p>No External Open</p><p>Manual Review Required</p><p>当前只是 RC 候选，不创建 release、不 push</p><p>人工复核通过后才能进入下一阶段</p><p>仍然不接真实 provider、不联网、不启用交易</p><p>' + escapeHtml(card.publicBetaRcConsoleSummary && card.publicBetaRcConsoleSummary.userFacingSummary && card.publicBetaRcConsoleSummary.userFacingSummary.resultLabel || 'Public Beta RC Console 仍需复核') + '</p><p>' + escapeHtml(card.offlineTrialReleaseGateSummary && card.offlineTrialReleaseGateSummary.userFacingSummary && card.offlineTrialReleaseGateSummary.userFacingSummary.resultLabel || 'Offline Trial Release Gate 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaRcViewModelSummary && card.publicBetaRcViewModelSummary.userFacingSummary && card.publicBetaRcViewModelSummary.userFacingSummary.resultLabel || 'Public Beta RC View Model 仍需复核') + '</p><p>manualReviewRequired:true</p><p>externalUrl:null</p><p>platformUrl:null</p><p>providerUrl:null</p><p>bookingUrl:null</p><p>checkoutUrl:null</p><p>paymentUrl:null</p><p>orderUrl:null</p><p>buyButtonEnabled:false</p><p>checkoutButtonEnabled:false</p><p>paymentButtonEnabled:false</p></section>' : '';
    const publicBetaStabilityHandoffHtml = card.manualLaunchHandoffViewModelSummary ? '<section class="commerce-global-shopping-public-beta-stability-handoff" data-commerce-global-shopping-public-beta-stability-handoff="true"><h5>Public Beta Stability Audit</h5><p>Manual Launch Handoff Pack</p><p>Locked Capabilities</p><p>Next Decision Options</p><p>Continue Testing</p><p>Manual Review Required</p><p>当前仍为只读 Public Beta 候选</p><p>不自动发布、不接 provider、不启用交易</p><p>可继续人工试用和问题记录</p><p>既有 secret scan WARN 仅作为已知警告展示</p><p>' + escapeHtml(card.publicBetaStabilityAuditSummary && card.publicBetaStabilityAuditSummary.userFacingSummary && card.publicBetaStabilityAuditSummary.userFacingSummary.resultLabel || 'Public Beta Stability Audit 仍需复核') + '</p><p>' + escapeHtml(card.manualLaunchHandoffPackSummary && card.manualLaunchHandoffPackSummary.userFacingSummary && card.manualLaunchHandoffPackSummary.userFacingSummary.resultLabel || 'Manual Launch Handoff Pack 仍需复核') + '</p><p>' + escapeHtml(card.manualLaunchHandoffViewModelSummary && card.manualLaunchHandoffViewModelSummary.userFacingSummary && card.manualLaunchHandoffViewModelSummary.userFacingSummary.resultLabel || 'Manual Launch Handoff View Model 仍需复核') + '</p><p>manualReviewRequired:true</p><p>externalUrl:null</p><p>platformUrl:null</p><p>providerUrl:null</p><p>bookingUrl:null</p><p>checkoutUrl:null</p><p>paymentUrl:null</p><p>orderUrl:null</p><p>buyButtonEnabled:false</p><p>checkoutButtonEnabled:false</p><p>paymentButtonEnabled:false</p></section>' : '';
    const publicBetaManualQaHtml = card.publicBetaManualQaViewModelSummary ? '<section class="commerce-global-shopping-public-beta-manual-qa" data-commerce-global-shopping-public-beta-manual-qa="true"><h5>Public Beta Manual QA Report Center</h5><p>Trial Feedback Safety Gate</p><p>RC Evidence Snapshot</p><p>QA Evidence</p><p>Feedback Safety</p><p>No-Transaction Evidence</p><p>Manual Review Required</p><p>反馈仍为草稿，不发送、不上传、不保存用户原文</p><p>RC 证据快照不写文件、不导出</p><p>人工 QA 后再决定下一阶段</p><p>' + escapeHtml(card.publicBetaManualQaReportCenterSummary && card.publicBetaManualQaReportCenterSummary.userFacingSummary && card.publicBetaManualQaReportCenterSummary.userFacingSummary.resultLabel || 'Public Beta Manual QA Report Center 仍需复核') + '</p><p>' + escapeHtml(card.trialFeedbackSafetyGateSummary && card.trialFeedbackSafetyGateSummary.userFacingSummary && card.trialFeedbackSafetyGateSummary.userFacingSummary.resultLabel || 'Trial Feedback Safety Gate 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaRcEvidenceSnapshotSummary && card.publicBetaRcEvidenceSnapshotSummary.userFacingSummary && card.publicBetaRcEvidenceSnapshotSummary.userFacingSummary.resultLabel || 'RC Evidence Snapshot 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaManualQaViewModelSummary && card.publicBetaManualQaViewModelSummary.userFacingSummary && card.publicBetaManualQaViewModelSummary.userFacingSummary.resultLabel || 'Public Beta Manual QA ViewModel 仍需复核') + '</p><p>manualReviewRequired:true</p><p>externalUrl:null</p><p>platformUrl:null</p><p>providerUrl:null</p><p>bookingUrl:null</p><p>checkoutUrl:null</p><p>paymentUrl:null</p><p>orderUrl:null</p><p>buyButtonEnabled:false</p><p>checkoutButtonEnabled:false</p><p>paymentButtonEnabled:false</p></section>' : '';
    const publicBetaTrialOperationsHtml = card.publicBetaTrialOperationsViewModelSummary ? '<section class="commerce-global-shopping-public-beta-trial-operations" data-commerce-global-shopping-public-beta-trial-operations="true"><h5>Public Beta Trial Operations Console</h5><p>Manual QA Scenario Runner</p><p>Offline Feedback Review Board</p><p>Scenario Coverage</p><p>Feedback Review</p><p>Next Manual Action</p><p>Manual Review Required</p><p>Flight / Hotel / Product / Restricted / Feedback / No-Transaction / No-Provider 场景已覆盖</p><p>反馈仍保持关闭，不发送、不上传、不保存用户原文</p><p>下一步只能人工复核或继续测试</p><p>不自动发布、不接 provider、不启用交易</p><p>' + escapeHtml(card.publicBetaTrialOperationsConsoleSummary && card.publicBetaTrialOperationsConsoleSummary.userFacingSummary && card.publicBetaTrialOperationsConsoleSummary.userFacingSummary.resultLabel || 'Public Beta Trial Operations Console 仍需复核') + '</p><p>' + escapeHtml(card.manualQaScenarioRunnerSummary && card.manualQaScenarioRunnerSummary.userFacingSummary && card.manualQaScenarioRunnerSummary.userFacingSummary.resultLabel || 'Manual QA Scenario Runner 仍需复核') + '</p><p>' + escapeHtml(card.offlineFeedbackReviewBoardSummary && card.offlineFeedbackReviewBoardSummary.userFacingSummary && card.offlineFeedbackReviewBoardSummary.userFacingSummary.resultLabel || 'Offline Feedback Review Board 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaTrialOperationsViewModelSummary && card.publicBetaTrialOperationsViewModelSummary.userFacingSummary && card.publicBetaTrialOperationsViewModelSummary.userFacingSummary.resultLabel || 'Public Beta Trial Operations View Model 仍需复核') + '</p><p>manualReviewRequired:true</p><p>feedbackEnabled:false</p><p>uploadEnabled:false</p><p>emailEnabled:false</p><p>externalFormUrl:null</p><p>externalUrl:null</p><p>platformUrl:null</p><p>providerUrl:null</p><p>bookingUrl:null</p><p>checkoutUrl:null</p><p>paymentUrl:null</p><p>orderUrl:null</p><p>buyButtonEnabled:false</p><p>checkoutButtonEnabled:false</p><p>paymentButtonEnabled:false</p></section>' : '';
    const publicBetaQaOperationsHtml = card.publicBetaAcceptanceSnapshotViewModelSummary || card.publicBetaClosureReviewViewModelSummary || card.publicBetaNextStepViewModelSummary || card.publicBetaFinalReadinessViewModelSummary || card.publicBetaCandidateViewModelSummary || card.publicBetaAcceptanceReviewViewModelSummary || card.publicBetaOfflineAcceptanceViewModelSummary || card.publicBetaFinalAcceptanceViewModelSummary ? '<section class="commerce-global-shopping-public-beta-qa-operations" data-commerce-global-shopping-public-beta-qa-operations="true"><h5>Public Beta Freeze Evidence Summary</h5><p>Manual Trial Issue Review Board</p><p>Offline Acceptance Snapshot</p><p>Freeze Evidence</p><p>Issue Review</p><p>Acceptance Snapshot</p><p>Manual Review Required</p><p>冻结证据仅为只读摘要，不修改配置</p><p>问题复核仅为离线视图，不创建真实 issue</p><p>验收快照不写文件、不导出</p><p>仍需人工复核后再决定下一阶段</p><p>' + escapeHtml(card.publicBetaFreezeEvidenceSummary && card.publicBetaFreezeEvidenceSummary.userFacingSummary && card.publicBetaFreezeEvidenceSummary.userFacingSummary.resultLabel || 'Public Beta Freeze Evidence Summary 仍需复核') + '</p><p>' + escapeHtml(card.manualTrialIssueReviewBoardSummary && card.manualTrialIssueReviewBoardSummary.userFacingSummary && card.manualTrialIssueReviewBoardSummary.userFacingSummary.resultLabel || 'Manual Trial Issue Review Board 仍需复核') + '</p><p>' + escapeHtml(card.offlineAcceptanceSnapshotSummary && card.offlineAcceptanceSnapshotSummary.userFacingSummary && card.offlineAcceptanceSnapshotSummary.userFacingSummary.resultLabel || 'Offline Acceptance Snapshot 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaAcceptanceSnapshotViewModelSummary && card.publicBetaAcceptanceSnapshotViewModelSummary.userFacingSummary && card.publicBetaAcceptanceSnapshotViewModelSummary.userFacingSummary.resultLabel || 'Public Beta Acceptance Snapshot View Model 仍需复核') + '</p><p>Public Beta Acceptance Review Console</p><p>Offline Trial Closure Board</p><p>No-Launch Assurance Gate</p><p>Acceptance Review</p><p>Trial Closure</p><p>No Launch</p><p>当前不发布、不创建 release、不 push</p><p>试用闭环仅为离线视图，不关闭真实任务</p><p>验收复核后仍需人工决定下一阶段</p><p>仍不允许启用 provider、付款、下单或发布</p><p>' + escapeHtml(card.publicBetaAcceptanceReviewConsoleSummary && card.publicBetaAcceptanceReviewConsoleSummary.userFacingSummary && card.publicBetaAcceptanceReviewConsoleSummary.userFacingSummary.resultLabel || 'Public Beta Acceptance Review Console 仍需复核') + '</p><p>' + escapeHtml(card.offlineTrialClosureBoardSummary && card.offlineTrialClosureBoardSummary.userFacingSummary && card.offlineTrialClosureBoardSummary.userFacingSummary.resultLabel || 'Offline Trial Closure Board 仍需复核') + '</p><p>' + escapeHtml(card.noLaunchAssuranceGateSummary && card.noLaunchAssuranceGateSummary.userFacingSummary && card.noLaunchAssuranceGateSummary.userFacingSummary.resultLabel || 'No-Launch Assurance Gate 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaClosureReviewViewModelSummary && card.publicBetaClosureReviewViewModelSummary.userFacingSummary && card.publicBetaClosureReviewViewModelSummary.userFacingSummary.resultLabel || 'Public Beta Closure Review View Model 仍需复核') + '</p><p>Public Beta Manual Acceptance Checklist</p><p>Offline User Scenario Pack</p><p>No-Data-Retention Guard</p><p>Acceptance Review</p><p>离线验收清单只用于人工复核，不保存验收记录</p><p>离线场景包仅为样例，不收集真实输入</p><p>无数据留存保护门确认不保存反馈、用户原文、场景输入、验收记录或证据文件</p><p>' + escapeHtml(card.publicBetaManualAcceptanceChecklistSummary && card.publicBetaManualAcceptanceChecklistSummary.userFacingSummary && card.publicBetaManualAcceptanceChecklistSummary.userFacingSummary.resultLabel || 'Public Beta Manual Acceptance Checklist 仍需复核') + '</p><p>' + escapeHtml(card.offlineUserScenarioPackSummary && card.offlineUserScenarioPackSummary.userFacingSummary && card.offlineUserScenarioPackSummary.userFacingSummary.resultLabel || 'Offline User Scenario Pack 仍需复核') + '</p><p>' + escapeHtml(card.noDataRetentionGuardSummary && card.noDataRetentionGuardSummary.userFacingSummary && card.noDataRetentionGuardSummary.userFacingSummary.resultLabel || 'No-Data-Retention Guard 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaAcceptanceReviewViewModelSummary && card.publicBetaAcceptanceReviewViewModelSummary.userFacingSummary && card.publicBetaAcceptanceReviewViewModelSummary.userFacingSummary.resultLabel || 'Public Beta Acceptance Review ViewModel 仍需复核') + '</p><p>Public Beta Offline Acceptance Evidence Center</p><p>Manual Scenario Review Board</p><p>Zero-Persistence Regression Gate</p><p>Offline Acceptance Evidence</p><p>Scenario Review</p><p>Zero Persistence</p><p>Manual Review Required</p><p>离线验收证据中心仅为只读展示，不生成证据文件</p><p>人工场景复核板仅为样例复核，不保存场景输入或复核结果</p><p>零持久化回归门确认不保存反馈、用户原文、场景输入、验收记录或证据文件</p><p>provider、联网、外部打开、付款、下单、出票、release、push、launch、反馈提交、上传、issue/task 创建仍保持关闭</p><p>' + escapeHtml(card.publicBetaOfflineAcceptanceEvidenceCenterSummary && card.publicBetaOfflineAcceptanceEvidenceCenterSummary.userFacingSummary && card.publicBetaOfflineAcceptanceEvidenceCenterSummary.userFacingSummary.resultLabel || 'Public Beta Offline Acceptance Evidence Center 仍需复核') + '</p><p>' + escapeHtml(card.manualScenarioReviewBoardSummary && card.manualScenarioReviewBoardSummary.userFacingSummary && card.manualScenarioReviewBoardSummary.userFacingSummary.resultLabel || 'Manual Scenario Review Board 仍需复核') + '</p><p>' + escapeHtml(card.zeroPersistenceRegressionGateSummary && card.zeroPersistenceRegressionGateSummary.userFacingSummary && card.zeroPersistenceRegressionGateSummary.userFacingSummary.resultLabel || 'Zero-Persistence Regression Gate 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaOfflineAcceptanceViewModelSummary && card.publicBetaOfflineAcceptanceViewModelSummary.userFacingSummary && card.publicBetaOfflineAcceptanceViewModelSummary.userFacingSummary.resultLabel || 'Public Beta Offline Acceptance ViewModel 仍需复核') + '</p><p>Public Beta Final Acceptance Lock</p><p>Offline Release Candidate Audit</p><p>Zero-Action Safety Console</p><p>Final Acceptance</p><p>Release Candidate Audit</p><p>Zero Action Safety</p><p>Manual Review Required</p><p>最终人工验收锁定仅为只读展示，不保存验收记录</p><p>离线 RC 审计不创建 release、不生成审计文件</p><p>零动作安全控制台确认没有任何真实动作执行入口</p><p>provider、联网、外部打开、付款、下单、出票、release、push、launch、反馈提交、上传、issue/task 创建仍保持关闭</p><p>' + escapeHtml(card.publicBetaFinalAcceptanceLockSummary && card.publicBetaFinalAcceptanceLockSummary.userFacingSummary && card.publicBetaFinalAcceptanceLockSummary.userFacingSummary.resultLabel || 'Public Beta Final Acceptance Lock 仍需复核') + '</p><p>' + escapeHtml(card.offlineReleaseCandidateAuditSummary && card.offlineReleaseCandidateAuditSummary.userFacingSummary && card.offlineReleaseCandidateAuditSummary.userFacingSummary.resultLabel || 'Offline Release Candidate Audit 仍需复核') + '</p><p>' + escapeHtml(card.zeroActionSafetyConsoleSummary && card.zeroActionSafetyConsoleSummary.userFacingSummary && card.zeroActionSafetyConsoleSummary.userFacingSummary.resultLabel || 'Zero-Action Safety Console 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaFinalAcceptanceViewModelSummary && card.publicBetaFinalAcceptanceViewModelSummary.userFacingSummary && card.publicBetaFinalAcceptanceViewModelSummary.userFacingSummary.resultLabel || 'Public Beta Final Acceptance ViewModel 仍需复核') + '</p><p>Public Beta Closure Evidence Archive</p><p>Manual Trial Exit Criteria</p><p>Offline Next-Step Planning Board</p><p>Closure Evidence</p><p>Exit Criteria</p><p>Next-Step Planning</p><p>Manual Review Required</p><p>闭环证据仅为只读归档视图，不写文件</p><p>退出标准不自动通过，不创建 release</p><p>下一步只能继续测试、优化文案、扩展离线场景、人工复核或阻断</p><p>仍不允许启用 provider、付款、下单或发布</p><p>' + escapeHtml(card.publicBetaClosureEvidenceArchiveSummary && card.publicBetaClosureEvidenceArchiveSummary.userFacingSummary && card.publicBetaClosureEvidenceArchiveSummary.userFacingSummary.resultLabel || 'Public Beta Closure Evidence Archive 仍需复核') + '</p><p>' + escapeHtml(card.manualTrialExitCriteriaSummary && card.manualTrialExitCriteriaSummary.userFacingSummary && card.manualTrialExitCriteriaSummary.userFacingSummary.resultLabel || 'Manual Trial Exit Criteria 仍需复核') + '</p><p>' + escapeHtml(card.offlineNextStepPlanningBoardSummary && card.offlineNextStepPlanningBoardSummary.userFacingSummary && card.offlineNextStepPlanningBoardSummary.userFacingSummary.resultLabel || 'Offline Next-Step Planning Board 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaNextStepViewModelSummary && card.publicBetaNextStepViewModelSummary.userFacingSummary && card.publicBetaNextStepViewModelSummary.userFacingSummary.resultLabel || 'Public Beta Next-Step ViewModel 仍需复核') + '</p><p>Public Beta Final Readiness Command Center</p><p>Offline Launch Blocker Matrix</p><p>Manual Next-Phase Dossier</p><p>Final Readiness</p><p>Launch Blockers</p><p>Next-Phase Dossier</p><p>Manual Review Required</p><p>当前仍是只读 Public Beta 候选</p><p>发布、provider、联网、付款、下单、出票全部保持阻断</p><p>下一阶段只能继续测试、优化文案、扩展离线场景、人工复核或阻断</p><p>不创建 release、不 push、不启用交易</p><p>' + escapeHtml(card.publicBetaFinalReadinessCommandCenterSummary && card.publicBetaFinalReadinessCommandCenterSummary.userFacingSummary && card.publicBetaFinalReadinessCommandCenterSummary.userFacingSummary.resultLabel || 'Public Beta Final Readiness Command Center 仍需复核') + '</p><p>' + escapeHtml(card.offlineLaunchBlockerMatrixSummary && card.offlineLaunchBlockerMatrixSummary.userFacingSummary && card.offlineLaunchBlockerMatrixSummary.userFacingSummary.resultLabel || 'Offline Launch Blocker Matrix 仍需复核') + '</p><p>' + escapeHtml(card.manualNextPhaseDossierSummary && card.manualNextPhaseDossierSummary.userFacingSummary && card.manualNextPhaseDossierSummary.userFacingSummary.resultLabel || 'Manual Next-Phase Dossier 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaFinalReadinessViewModelSummary && card.publicBetaFinalReadinessViewModelSummary.userFacingSummary && card.publicBetaFinalReadinessViewModelSummary.userFacingSummary.resultLabel || 'Public Beta Final Readiness ViewModel 仍需复核') + '</p><p>Public Beta Candidate Lock</p><p>Final Trial Handoff Console</p><p>No-Provider Production Boundary</p><p>Candidate Scope</p><p>Trial Handoff</p><p>Production Boundary</p><p>Manual Review Required</p><p>当前锁定的是只读 Public Beta 候选范围，不修改配置</p><p>最终试用交接仅为只读摘要，不生成文件</p><p>当前不是 production provider 版本</p><p>provider、联网、外部打开、付款、下单、出票、release、push 全部保持关闭</p><p>' + escapeHtml(card.publicBetaCandidateLockSummary && card.publicBetaCandidateLockSummary.userFacingSummary && card.publicBetaCandidateLockSummary.userFacingSummary.resultLabel || 'Public Beta Candidate Lock 仍需复核') + '</p><p>' + escapeHtml(card.finalTrialHandoffConsoleSummary && card.finalTrialHandoffConsoleSummary.userFacingSummary && card.finalTrialHandoffConsoleSummary.userFacingSummary.resultLabel || 'Final Trial Handoff Console 仍需复核') + '</p><p>' + escapeHtml(card.noProviderProductionBoundarySummary && card.noProviderProductionBoundarySummary.userFacingSummary && card.noProviderProductionBoundarySummary.userFacingSummary.resultLabel || 'No-Provider Production Boundary 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaCandidateViewModelSummary && card.publicBetaCandidateViewModelSummary.userFacingSummary && card.publicBetaCandidateViewModelSummary.userFacingSummary.resultLabel || 'Public Beta Candidate ViewModel 仍需复核') + '</p><p>Public Beta Candidate Evidence Review</p><p>Trial Operator Notes Panel</p><p>Offline Safety Delta Board</p><p>Candidate Evidence</p><p>Operator Notes</p><p>Safety Delta</p><p>Manual Review Required</p><p>候选证据仅为只读复核，不写文件</p><p>运营备注不保存、不上传、不创建任务</p><p>安全边界未扩大</p><p>provider、联网、外部打开、付款、下单、出票、release、push、launch 仍保持关闭</p><p>' + escapeHtml(card.publicBetaCandidateEvidenceReviewSummary && card.publicBetaCandidateEvidenceReviewSummary.userFacingSummary && card.publicBetaCandidateEvidenceReviewSummary.userFacingSummary.resultLabel || 'Public Beta Candidate Evidence Review 仍需复核') + '</p><p>' + escapeHtml(card.trialOperatorNotesPanelSummary && card.trialOperatorNotesPanelSummary.userFacingSummary && card.trialOperatorNotesPanelSummary.userFacingSummary.resultLabel || 'Trial Operator Notes Panel 仍需复核') + '</p><p>' + escapeHtml(card.offlineSafetyDeltaBoardSummary && card.offlineSafetyDeltaBoardSummary.userFacingSummary && card.offlineSafetyDeltaBoardSummary.userFacingSummary.resultLabel || 'Offline Safety Delta Board 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaCandidateReviewViewModelSummary && card.publicBetaCandidateReviewViewModelSummary.userFacingSummary && card.publicBetaCandidateReviewViewModelSummary.userFacingSummary.resultLabel || 'Public Beta Candidate Review ViewModel 仍需复核') + '</p><p>Public Beta Candidate QA Freeze</p><p>Trial Feedback Intake Mock</p><p>Offline Regression Evidence Board</p><p>QA Freeze</p><p>Feedback Intake</p><p>Regression Evidence</p><p>Manual Review Required</p><p>QA 冻结仅为只读范围，不修改配置</p><p>反馈入口仅为 Mock，不保存、不上传、不创建任务</p><p>回归证据仅为只读展示，不生成文件</p><p>provider、联网、外部打开、付款、下单、出票、release、push、launch、反馈提交、上传、issue/task 创建仍保持关闭</p><p>' + escapeHtml(card.publicBetaCandidateQaFreezeSummary && card.publicBetaCandidateQaFreezeSummary.userFacingSummary && card.publicBetaCandidateQaFreezeSummary.userFacingSummary.resultLabel || 'Public Beta Candidate QA Freeze 仍需复核') + '</p><p>' + escapeHtml(card.trialFeedbackIntakeMockSummary && card.trialFeedbackIntakeMockSummary.userFacingSummary && card.trialFeedbackIntakeMockSummary.userFacingSummary.resultLabel || 'Trial Feedback Intake Mock 仍需复核') + '</p><p>' + escapeHtml(card.offlineRegressionEvidenceBoardSummary && card.offlineRegressionEvidenceBoardSummary.userFacingSummary && card.offlineRegressionEvidenceBoardSummary.userFacingSummary.resultLabel || 'Offline Regression Evidence Board 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaQaFreezeViewModelSummary && card.publicBetaQaFreezeViewModelSummary.userFacingSummary && card.publicBetaQaFreezeViewModelSummary.userFacingSummary.resultLabel || 'Public Beta QA Freeze ViewModel 仍需复核') + '</p><p>manualReviewRequired:true</p><p>safeToProceedWithManualAcceptanceReview:' + escapeHtml(String(card.safeToProceedWithManualAcceptanceReview === true)) + '</p><p>safeToProceedWithManualOfflineAcceptanceReview:' + escapeHtml(String(card.safeToProceedWithManualOfflineAcceptanceReview === true)) + '</p><p>safeToProceedWithManualFinalAcceptanceReview:' + escapeHtml(String(card.safeToProceedWithManualFinalAcceptanceReview === true)) + '</p><p>safeToProceedWithManualAcceptanceSnapshotReview:' + escapeHtml(String(card.safeToProceedWithManualAcceptanceSnapshotReview === true)) + '</p><p>safeToProceedWithManualClosureReview:' + escapeHtml(String(card.safeToProceedWithManualClosureReview === true)) + '</p><p>safeToProceedWithManualNextStepReview:' + escapeHtml(String(card.safeToProceedWithManualNextStepReview === true)) + '</p><p>safeToProceedWithManualFinalReadinessReview:' + escapeHtml(String(card.safeToProceedWithManualFinalReadinessReview === true)) + '</p><p>safeToProceedWithManualCandidateReview:' + escapeHtml(String(card.safeToProceedWithManualCandidateReview === true)) + '</p><p>safeToProceedWithManualCandidateEvidenceReview:' + escapeHtml(String(card.safeToProceedWithManualCandidateEvidenceReview === true)) + '</p><p>safeToProceedWithManualQaFreezeReview:' + escapeHtml(String(card.safeToProceedWithManualQaFreezeReview === true)) + '</p><p>externalUrl:null</p><p>platformUrl:null</p><p>providerUrl:null</p><p>bookingUrl:null</p><p>checkoutUrl:null</p><p>paymentUrl:null</p><p>orderUrl:null</p><p>buyButtonEnabled:false</p><p>checkoutButtonEnabled:false</p><p>paymentButtonEnabled:false</p><p>feedbackSubmitEnabled:false</p><p>uploadEnabled:false</p><p>issueCreateEnabled:false</p><p>taskCreateEnabled:false</p></section>' : '';
    ...
    const providerTrustClosureHtml = card.providerTrustClosureViewModelSummary ? '<section class="commerce-global-shopping-provider-trust-closure-review" data-commerce-global-shopping-provider-trust-closure-review="true"><h5>Provider Trust Closure Review</h5><p>Provider Public Trust Closure Center</p><p>Offline Release Memory Snapshot</p><p>No-Provider-Execution Final Guard</p><p>User-Visible Safety Boundary Explainer</p><p>Public Trust Closure</p><p>Release Memory</p><p>No-Provider Guard</p><p>Safety Boundary</p><p>' + escapeHtml(card.providerPublicTrustClosureCenterSummary && card.providerPublicTrustClosureCenterSummary.userFacingSummary && card.providerPublicTrustClosureCenterSummary.userFacingSummary.resultLabel || 'Provider Public Trust Closure Center 仍需复核') + '</p><p>' + escapeHtml(card.offlineReleaseMemorySnapshotSummary && card.offlineReleaseMemorySnapshotSummary.userFacingSummary && card.offlineReleaseMemorySnapshotSummary.userFacingSummary.resultLabel || 'Offline Release Memory Snapshot 仍需复核') + '</p><p>' + escapeHtml(card.noProviderExecutionFinalGuardSummary && card.noProviderExecutionFinalGuardSummary.userFacingSummary && card.noProviderExecutionFinalGuardSummary.userFacingSummary.resultLabel || 'No-Provider-Execution Final Guard 仍需复核') + '</p><p>' + escapeHtml(card.userVisibleSafetyBoundaryExplainerSummary && card.userVisibleSafetyBoundaryExplainerSummary.userFacingSummary && card.userVisibleSafetyBoundaryExplainerSummary.userFacingSummary.resultLabel || 'User-Visible Safety Boundary Explainer 仍需复核') + '</p><p>Provider Public Trust Closure Center 已准备</p><p>Offline Release Memory Snapshot 已准备</p><p>No-Provider-Execution Final Guard 已准备</p><p>User-Visible Safety Boundary Explainer 已准备</p><p>Public Trust Closure 不生成真实公开声明</p><p>Release Memory 不持久化记忆快照</p><p>No-Provider Guard 不执行真实阻断、不打开平台</p><p>Safety Boundary 不承诺最低价、最终价或官方背书</p><p>Human trust closure review 仍需人工复核</p><p>当前只展示 provider trust closure review</p><p>不接真实 provider，不读取密钥，不联网，不激活 sandbox，不创建 release，不 push，不打开平台</p><button type="button" class="cmd-btn gray" data-commerce-global-shopping-public-trust-closure-show="true">查看 Public Trust Closure</button><button type="button" class="cmd-btn gray" data-commerce-global-shopping-release-memory-show="true">查看 Release Memory</button><button type="button" class="cmd-btn gray" data-commerce-global-shopping-no-provider-guard-show="true">查看 No-Provider Guard</button><button type="button" class="cmd-btn gray" data-commerce-global-shopping-safety-boundary-show="true">查看 Safety Boundary</button><div data-commerce-global-shopping-public-trust-closure-output="true"><p>Provider Public Trust Closure Center</p><p>' + escapeHtml(card.providerPublicTrustClosureCenterSummary && card.providerPublicTrustClosureCenterSummary.userFacingSummary && card.providerPublicTrustClosureCenterSummary.userFacingSummary.resultLabel || 'Provider Public Trust Closure Center 仍需复核') + '</p><p>Public Trust Closure 不生成真实公开声明</p></div><div data-commerce-global-shopping-release-memory-output="true"><p>Offline Release Memory Snapshot</p><p>' + escapeHtml(card.offlineReleaseMemorySnapshotSummary && card.offlineReleaseMemorySnapshotSummary.userFacingSummary && card.offlineReleaseMemorySnapshotSummary.userFacingSummary.resultLabel || 'Offline Release Memory Snapshot 仍需复核') + '</p><p>Release Memory 不持久化记忆快照</p></div><div data-commerce-global-shopping-no-provider-guard-output="true"><p>No-Provider-Execution Final Guard</p><p>' + escapeHtml(card.noProviderExecutionFinalGuardSummary && card.noProviderExecutionFinalGuardSummary.userFacingSummary && card.noProviderExecutionFinalGuardSummary.userFacingSummary.resultLabel || 'No-Provider-Execution Final Guard 仍需复核') + '</p><p>No-Provider Guard 不执行真实阻断、不打开平台</p></div><div data-commerce-global-shopping-safety-boundary-output="true"><p>User-Visible Safety Boundary Explainer</p><p>' + escapeHtml(card.userVisibleSafetyBoundaryExplainerSummary && card.userVisibleSafetyBoundaryExplainerSummary.userFacingSummary && card.userVisibleSafetyBoundaryExplainerSummary.userFacingSummary.resultLabel || 'User-Visible Safety Boundary Explainer 仍需复核') + '</p><p>Safety Boundary 不承诺最低价、最终价或官方背书</p></div></section>' : '';
    const providerPublicReleaseHtml = card.providerPublicReleaseViewModelSummary ? '<section class="commerce-global-shopping-provider-public-release-review" data-commerce-global-shopping-provider-public-release-review="true"><h5>Provider Public Release Review</h5><p>Provider Read-Only Public Release Center</p><p>Trust Closure Export Preview</p><p>Final No-Provider Boundary Receipt</p><p>Public Safety Statement Preview</p><p>Public Release</p><p>Export Preview</p><p>No-Provider Receipt</p><p>Safety Statement</p><p>' + escapeHtml(card.providerReadOnlyPublicReleaseCenterSummary && card.providerReadOnlyPublicReleaseCenterSummary.userFacingSummary && card.providerReadOnlyPublicReleaseCenterSummary.userFacingSummary.resultLabel || 'Provider Read-Only Public Release Center 仍需复核') + '</p><p>' + escapeHtml(card.trustClosureExportPreviewSummary && card.trustClosureExportPreviewSummary.userFacingSummary && card.trustClosureExportPreviewSummary.userFacingSummary.resultLabel || 'Trust Closure Export Preview 仍需复核') + '</p><p>' + escapeHtml(card.finalNoProviderBoundaryReceiptSummary && card.finalNoProviderBoundaryReceiptSummary.userFacingSummary && card.finalNoProviderBoundaryReceiptSummary.userFacingSummary.resultLabel || 'Final No-Provider Boundary Receipt 仍需复核') + '</p><p>' + escapeHtml(card.publicSafetyStatementPreviewSummary && card.publicSafetyStatementPreviewSummary.userFacingSummary && card.publicSafetyStatementPreviewSummary.userFacingSummary.resultLabel || 'Public Safety Statement Preview 仍需复核') + '</p><p>Provider Read-Only Public Release Center 已准备</p><p>Trust Closure Export Preview 已准备</p><p>Final No-Provider Boundary Receipt 已准备</p><p>Public Safety Statement Preview 已准备</p><p>Public Release 不创建真实公开发布</p><p>Export Preview 不生成真实导出文件</p><p>No-Provider Receipt 不生成真实回执、不打开平台</p><p>Safety Statement 不承诺最低价、最终价或官方背书</p><p>Human public release review 仍需人工复核</p><p>当前只展示 provider public release review</p><p>不接真实 provider，不读取密钥，不联网，不打开平台，不创建 release，不 push，不生成真实导出文件</p><button type="button" class="cmd-btn gray" data-commerce-global-shopping-public-release-show="true">查看 Public Release</button><button type="button" class="cmd-btn gray" data-commerce-global-shopping-export-preview-show="true">查看 Export Preview</button><button type="button" class="cmd-btn gray" data-commerce-global-shopping-no-provider-receipt-show="true">查看 No-Provider Receipt</button><button type="button" class="cmd-btn gray" data-commerce-global-shopping-safety-statement-show="true">查看 Safety Statement</button><div data-commerce-global-shopping-public-release-output="true"><p>Provider Read-Only Public Release Center</p><p>' + escapeHtml(card.providerReadOnlyPublicReleaseCenterSummary && card.providerReadOnlyPublicReleaseCenterSummary.userFacingSummary && card.providerReadOnlyPublicReleaseCenterSummary.userFacingSummary.resultLabel || 'Provider Read-Only Public Release Center 仍需复核') + '</p><p>Public Release 不创建真实公开发布</p></div><div data-commerce-global-shopping-export-preview-output="true"><p>Trust Closure Export Preview</p><p>' + escapeHtml(card.trustClosureExportPreviewSummary && card.trustClosureExportPreviewSummary.userFacingSummary && card.trustClosureExportPreviewSummary.userFacingSummary.resultLabel || 'Trust Closure Export Preview 仍需复核') + '</p><p>Export Preview 不生成真实导出文件</p></div><div data-commerce-global-shopping-no-provider-receipt-output="true"><p>Final No-Provider Boundary Receipt</p><p>' + escapeHtml(card.finalNoProviderBoundaryReceiptSummary && card.finalNoProviderBoundaryReceiptSummary.userFacingSummary && card.finalNoProviderBoundaryReceiptSummary.userFacingSummary.resultLabel || 'Final No-Provider Boundary Receipt 仍需复核') + '</p><p>No-Provider Receipt 不生成真实回执、不打开平台</p></div><div data-commerce-global-shopping-safety-statement-output="true"><p>Public Safety Statement Preview</p><p>' + escapeHtml(card.publicSafetyStatementPreviewSummary && card.publicSafetyStatementPreviewSummary.userFacingSummary && card.publicSafetyStatementPreviewSummary.userFacingSummary.resultLabel || 'Public Safety Statement Preview 仍需复核') + '</p><p>Safety Statement 不承诺最低价、最终价或官方背书</p></div></section>' : '';
    const providerLaunchReadinessFinalReviewHtml = card.providerLaunchReadinessFinalViewModelSummary ? '<section class="commerce-global-shopping-provider-launch-readiness-final-review" data-commerce-global-shopping-provider-launch-readiness-final-review="true"><h5>Provider Launch Readiness Final Review</h5><p>Public Release Evidence Console</p><p>No-Provider User Assurance Panel</p><p>Offline Launch Readiness Finalizer</p><p>User-Safe Public Claim Verifier</p><p>Release Evidence</p><p>User Assurance</p><p>Launch Finalizer</p><p>Claim Verifier</p><p>' + escapeHtml(card.publicReleaseEvidenceConsoleSummary && card.publicReleaseEvidenceConsoleSummary.userFacingSummary && card.publicReleaseEvidenceConsoleSummary.userFacingSummary.resultLabel || 'Public Release Evidence Console 仍需复核') + '</p><p>' + escapeHtml(card.noProviderUserAssurancePanelSummary && card.noProviderUserAssurancePanelSummary.userFacingSummary && card.noProviderUserAssurancePanelSummary.userFacingSummary.resultLabel || 'No-Provider User Assurance Panel 仍需复核') + '</p><p>' + escapeHtml(card.offlineLaunchReadinessFinalizerSummary && card.offlineLaunchReadinessFinalizerSummary.userFacingSummary && card.offlineLaunchReadinessFinalizerSummary.userFacingSummary.resultLabel || 'Offline Launch Readiness Finalizer 仍需复核') + '</p><p>' + escapeHtml(card.userSafePublicClaimVerifierSummary && card.userSafePublicClaimVerifierSummary.userFacingSummary && card.userSafePublicClaimVerifierSummary.userFacingSummary.resultLabel || 'User-Safe Public Claim Verifier 仍需复核') + '</p><p>Public Release Evidence Console 已准备</p><p>No-Provider User Assurance Panel 已准备</p><p>Offline Launch Readiness Finalizer 已准备</p><p>User-Safe Public Claim Verifier 已准备</p><p>Release Evidence 不生成真实证据文件</p><p>User Assurance 不生成真实用户保证书</p><p>Launch Finalizer 不执行真实 launch</p><p>Claim Verifier 不承诺最低价、最终价或官方背书</p><p>Human launch readiness final review 仍需人工复核</p><p>当前只展示 provider launch readiness final review</p><p>不接真实 provider，不读取密钥，不联网，不打开平台，不创建 release，不 push，不执行真实 launch</p><button type="button" class="cmd-btn gray" data-commerce-global-shopping-release-evidence-show="true">查看 Release Evidence</button><button type="button" class="cmd-btn gray" data-commerce-global-shopping-user-assurance-show="true">查看 User Assurance</button><button type="button" class="cmd-btn gray" data-commerce-global-shopping-launch-finalizer-show="true">查看 Launch Finalizer</button><button type="button" class="cmd-btn gray" data-commerce-global-shopping-claim-verifier-show="true">查看 Claim Verifier</button><div data-commerce-global-shopping-release-evidence-output="true"><p>Public Release Evidence Console</p><p>' + escapeHtml(card.publicReleaseEvidenceConsoleSummary && card.publicReleaseEvidenceConsoleSummary.userFacingSummary && card.publicReleaseEvidenceConsoleSummary.userFacingSummary.resultLabel || 'Public Release Evidence Console 仍需复核') + '</p><p>Release Evidence 不生成真实证据文件</p></div><div data-commerce-global-shopping-user-assurance-output="true"><p>No-Provider User Assurance Panel</p><p>' + escapeHtml(card.noProviderUserAssurancePanelSummary && card.noProviderUserAssurancePanelSummary.userFacingSummary && card.noProviderUserAssurancePanelSummary.userFacingSummary.resultLabel || 'No-Provider User Assurance Panel 仍需复核') + '</p><p>User Assurance 不生成真实用户保证书</p></div><div data-commerce-global-shopping-launch-finalizer-output="true"><p>Offline Launch Readiness Finalizer</p><p>' + escapeHtml(card.offlineLaunchReadinessFinalizerSummary && card.offlineLaunchReadinessFinalizerSummary.userFacingSummary && card.offlineLaunchReadinessFinalizerSummary.userFacingSummary.resultLabel || 'Offline Launch Readiness Finalizer 仍需复核') + '</p><p>Launch Finalizer 不执行真实 launch</p></div><div data-commerce-global-shopping-claim-verifier-output="true"><p>User-Safe Public Claim Verifier</p><p>' + escapeHtml(card.userSafePublicClaimVerifierSummary && card.userSafePublicClaimVerifierSummary.userFacingSummary && card.userSafePublicClaimVerifierSummary.userFacingSummary.resultLabel || 'User-Safe Public Claim Verifier 仍需复核') + '</p><p>Claim Verifier 不承诺最低价、最终价或官方背书</p></div></section>' : '';
    const publicBetaReadinessReviewHtml = card.publicBetaReadinessReviewViewModelSummary ? '<section class="commerce-global-shopping-public-beta-readiness-review" data-commerce-global-shopping-public-beta-readiness-review="true"><h5>Public Beta Readiness Snapshot</h5><p>Manual Feedback Review Queue Mock</p><p>Offline Issue Triage Board</p><p>Readiness Snapshot</p><p>Feedback Review Queue</p><p>Issue Triage</p><p>Manual Review Required</p><p>' + escapeHtml(card.publicBetaReadinessSnapshotSummary && card.publicBetaReadinessSnapshotSummary.userFacingSummary && card.publicBetaReadinessSnapshotSummary.userFacingSummary.resultLabel || 'Public Beta Readiness Snapshot 仍需复核') + '</p><p>' + escapeHtml(card.manualFeedbackReviewQueueMockSummary && card.manualFeedbackReviewQueueMockSummary.userFacingSummary && card.manualFeedbackReviewQueueMockSummary.userFacingSummary.resultLabel || 'Manual Feedback Review Queue Mock 仍需复核') + '</p><p>' + escapeHtml(card.offlineIssueTriageBoardSummary && card.offlineIssueTriageBoardSummary.userFacingSummary && card.offlineIssueTriageBoardSummary.userFacingSummary.resultLabel || 'Offline Issue Triage Board 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaReadinessReviewViewModelSummary && card.publicBetaReadinessReviewViewModelSummary.userFacingSummary && card.publicBetaReadinessReviewViewModelSummary.userFacingSummary.resultLabel || 'Public Beta Readiness Review ViewModel 仍需复核') + '</p><p>准备快照仅为只读展示，不生成文件</p><p>反馈复核队列仅为 Mock，不保存、不上传、不创建 issue/task</p><p>问题分级仅为离线展示，不创建真实任务</p><p>provider、联网、外部打开、付款、下单、出票、release、push、launch、反馈提交、上传、issue/task 创建仍保持关闭</p><p>publicBetaReadinessSnapshotStatus:' + escapeHtml(card.publicBetaReadinessSnapshotStatus || 'needs_review') + '</p><p>manualFeedbackReviewQueueStatus:' + escapeHtml(card.manualFeedbackReviewQueueStatus || 'needs_review') + '</p><p>offlineIssueTriageStatus:' + escapeHtml(card.offlineIssueTriageStatus || 'needs_review') + '</p><p>publicBetaReadinessReviewViewModelStatus:' + escapeHtml(card.publicBetaReadinessReviewViewModelStatus || 'needs_review') + '</p><p>safeToProceedWithManualReadinessReview:' + escapeHtml(String(card.safeToProceedWithManualReadinessReview === true)) + '</p><p>manualReviewRequired:true</p><p>externalUrl:null</p><p>platformUrl:null</p><p>providerUrl:null</p><p>bookingUrl:null</p><p>checkoutUrl:null</p><p>paymentUrl:null</p><p>orderUrl:null</p><p>buyButtonEnabled:false</p><p>checkoutButtonEnabled:false</p><p>paymentButtonEnabled:false</p><p>feedbackSubmitEnabled:false</p><p>uploadEnabled:false</p><p>issueCreateEnabled:false</p><p>taskCreateEnabled:false</p></section>' : '';
    const globalShoppingPublicBetaReviewHtml = card.globalShoppingPublicBetaViewModelSummary ? '<section class="commerce-global-shopping-public-beta-review" data-commerce-global-shopping-public-beta-review="true"><h5>全球购 Public Beta</h5><p>Global Shopping Public Beta Review</p><p>Public Beta User Journey</p><p>Safe Search Intent Matrix</p><p>User Boundary Panel</p><p>Public Beta Final Gate</p><p>RC Confidence Board</p><p>Locked Capabilities</p><p>User Boundary</p><p>Next Manual Review</p><p>Global Shopping Read-Only Public Beta Shell</p><p>Provider-Zero Runtime Lock</p><p>User Trust Launch Board</p><p>Public Beta Safety Copy Center</p><p>只读搜索计划</p><p>候选价整理</p><p>费用归一化步骤</p><p>官方价锚点步骤</p><p>用户边界确认</p><p>只读候选价</p><p>候选价证据</p><p>来源与时间</p><p>可信度</p><p>风险说明</p><p>官方价锚点</p><p>费用归一化</p><p>含税/不含税</p><p>含运费/不含运费</p><p>服务费说明</p><p>归一化价格仅用于辅助比较</p><p>不代表真实最终价</p><p>以平台实时页面为准</p><p>当前仍为只读候选证据</p><p>当前不提供付款、下单或出票能力</p><p>不保存账号、证件或支付信息</p><p>用户需在对应平台自行完成下单</p><p>' + escapeHtml(card.globalShoppingPublicBetaUserFacingCopyPolishSummary && card.globalShoppingPublicBetaUserFacingCopyPolishSummary.userFacingSummary && card.globalShoppingPublicBetaUserFacingCopyPolishSummary.userFacingSummary.resultLabel || '全球购 Public Beta 仍需复核') + '</p><p>' + escapeHtml(card.globalShoppingReadOnlyCandidateEvidenceUnifierSummary && card.globalShoppingReadOnlyCandidateEvidenceUnifierSummary.userFacingSummary && card.globalShoppingReadOnlyCandidateEvidenceUnifierSummary.userFacingSummary.resultLabel || '候选价证据仍需复核') + '</p><p>' + escapeHtml(card.globalShoppingFeeNormalizationViewSummary && card.globalShoppingFeeNormalizationViewSummary.userFacingSummary && card.globalShoppingFeeNormalizationViewSummary.userFacingSummary.resultLabel || '费用归一化仍需复核') + '</p><p>' + escapeHtml(card.globalShoppingOfficialAnchorComparisonViewSummary && card.globalShoppingOfficialAnchorComparisonViewSummary.userFacingSummary && card.globalShoppingOfficialAnchorComparisonViewSummary.userFacingSummary.resultLabel || '官方价锚点仍需复核') + '</p><p>' + escapeHtml(card.globalShoppingProviderZeroStatusPanelSummary && card.globalShoppingProviderZeroStatusPanelSummary.userFacingSummary && card.globalShoppingProviderZeroStatusPanelSummary.userFacingSummary.resultLabel || 'Provider-Zero Status Panel 仍需复核') + '</p><p>' + escapeHtml(card.userTrustLaunchBoardSummary && card.userTrustLaunchBoardSummary.userFacingSummary && card.userTrustLaunchBoardSummary.userFacingSummary.resultLabel || 'User Trust Launch Board 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaSafetyCopyCenterSummary && card.publicBetaSafetyCopyCenterSummary.userFacingSummary && card.publicBetaSafetyCopyCenterSummary.userFacingSummary.resultLabel || 'Public Beta Safety Copy Center 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaFinalGateSummary && card.publicBetaFinalGateSummary.userFacingSummary && card.publicBetaFinalGateSummary.userFacingSummary.resultLabel || 'Public Beta Final Gate 仍需复核') + '</p><p>' + escapeHtml(card.releaseCandidateConfidenceBoardSummary && card.releaseCandidateConfidenceBoardSummary.userFacingSummary && card.releaseCandidateConfidenceBoardSummary.userFacingSummary.resultLabel || 'RC Confidence Board 仍需复核') + '</p><p>' + escapeHtml(card.publicBetaFinalViewModelSummary && card.publicBetaFinalViewModelSummary.userFacingSummary && card.publicBetaFinalViewModelSummary.userFacingSummary.resultLabel || '下一步仍需人工复核') + '</p><p>Provider-Zero 已锁定</p><p>未联网</p><p>未读取密钥</p><p>未生成 endpoint</p><p>未打开外部平台</p><p>未启用付款</p><p>未创建订单</p><p>未出票</p><p>未保存 raw provider 数据</p><p>安全文案通过</p><p>候选价证据已准备</p><p>费用归一化已准备</p><p>官方价锚点已准备</p><p>用户边界清晰</p><p>下一步仍需人工复核</p><p>Provider-Zero：未接入真实供应商</p><p>请在对应平台自行确认价格并完成下单</p><p>Human public beta review 仍需人工复核</p><p>当前只展示全球购 Public Beta</p><p>不接真实 provider，不读取密钥，不联网，不打开平台，不创建 release，不 push，当前不提供付款、下单或出票能力</p><button type="button" class="cmd-btn gray" data-commerce-global-shopping-public-beta-show="true">查看 Public Beta</button><button type="button" class="cmd-btn gray" data-commerce-global-shopping-provider-zero-lock-show="true">查看 Provider-Zero 状态</button><button type="button" class="cmd-btn gray" data-commerce-global-shopping-user-trust-launch-show="true">查看用户确认说明</button><button type="button" class="cmd-btn gray" data-commerce-global-shopping-safety-copy-show="true">查看安全文案</button><div data-commerce-global-shopping-public-beta-output="true"><p>全球购 Public Beta</p><p>Public Beta Final Gate</p><p>RC Confidence Board</p><p>Locked Capabilities</p><p>User Boundary</p><p>Next Manual Review</p><p>' + escapeHtml(card.globalShoppingPublicBetaUserFacingCopyPolishSummary && card.globalShoppingPublicBetaUserFacingCopyPolishSummary.userFacingSummary && card.globalShoppingPublicBetaUserFacingCopyPolishSummary.userFacingSummary.resultLabel || '全球购 Public Beta 仍需复核') + '</p><p>只读候选价</p><p>候选价证据</p><p>来源与时间</p><p>可信度</p><p>风险说明</p><p>官方价锚点</p><p>与官方价对比</p><p>费用归一化</p><p>含税/不含税</p><p>含运费/不含运费</p><p>服务费说明</p><p>归一化价格仅用于辅助比较</p><p>不代表真实最终价</p><p>以平台实时页面为准</p><p>当前仍为只读候选证据</p><p>当前不提供付款、下单或出票能力</p><p>不保存账号、证件或支付信息</p><p>用户需在对应平台自行完成下单</p><p>Provider-Zero 已锁定</p><p>未联网</p><p>未读取密钥</p><p>未生成 endpoint</p><p>未打开外部平台</p><p>未启用付款</p><p>未创建订单</p><p>未出票</p><p>未保存 raw provider 数据</p><p>安全文案通过</p><p>候选价证据已准备</p><p>费用归一化已准备</p><p>官方价锚点已准备</p><p>用户边界清晰</p><p>下一步仍需人工复核</p></div><div data-commerce-global-shopping-provider-zero-lock-output="true"><p>Provider-Zero Status Panel</p><p>' + escapeHtml(card.globalShoppingProviderZeroStatusPanelSummary && card.globalShoppingProviderZeroStatusPanelSummary.userFacingSummary && card.globalShoppingProviderZeroStatusPanelSummary.userFacingSummary.resultLabel || 'Provider-Zero Status Panel 仍需复核') + '</p><p>Provider-Zero：未接入真实供应商</p><p>未读取密钥</p><p>未联网调用</p><p>未生成订单</p></div><div data-commerce-global-shopping-user-trust-launch-output="true"><p>User Trust Launch Board</p><p>' + escapeHtml(card.userTrustLaunchBoardSummary && card.userTrustLaunchBoardSummary.userFacingSummary && card.userTrustLaunchBoardSummary.userFacingSummary.resultLabel || 'User Trust Launch Board 仍需复核') + '</p><p>请在对应平台自行确认价格并完成下单</p><p>Weishan 可尽量带入搜索条件，但用户需在对应平台自行确认价格、登录、填写资料并完成下单</p></div><div data-commerce-global-shopping-safety-copy-output="true"><p>Public Beta Safety Copy Center</p><p>' + escapeHtml(card.publicBetaSafetyCopyCenterSummary && card.publicBetaSafetyCopyCenterSummary.userFacingSummary && card.publicBetaSafetyCopyCenterSummary.userFacingSummary.resultLabel || 'Public Beta Safety Copy Center 仍需复核') + '</p><p>平台实时页面为准</p><p>当前不提供付款、下单或出票能力</p></div></section>' : '';
    ...
    return `<section class="commerce-read-only-price-candidate-card" aria-label="只读候选价" data-commerce-read-only-price-candidate-card="true">
      ...
      ${providerTrustClosureHtml}
      ${providerPublicReleaseHtml}
      ${providerLaunchReadinessFinalReviewHtml}
      ${publicBetaQaHtml}
      ${publicBetaReadinessReviewHtml}
      ${globalShoppingPublicBetaReviewHtml}
      ${publicBetaOperatorReviewHtml}
      ...
      ${publicBetaOnboardingHtml}
      ${publicBetaRcHtml}
      ${publicBetaStabilityHandoffHtml}
      ${publicBetaManualQaHtml}
      ${publicBetaTrialOperationsHtml}
      ${publicBetaQaOperationsHtml}
