;(function () {
  ...
  const READ_ONLY_PRICE_CANDIDATE_CARD_VIEW_MODEL_VERSION = "2.1.66";
  ...
  function buildReadOnlyPriceCandidateCardViewModel(input) {
    ...
    const humanReviewChecklistSummary = typeof humanReviewApi.buildFlightWorkflowHumanReviewChecklist === "function" ? humanReviewApi.buildFlightWorkflowHumanReviewChecklist(Object.assign({ topCandidates:dryRunTopCandidates, selectedCandidate:selectedCandidate, sessionSummary:sessionSummary, routeSummary:normalized.origin + " → " + normalized.destination, departureDate:normalized.departureDate, auditReviewSummary:workflowAuditReviewSummary }, workflowMeta)) : null;
    const finalSafeHandoffPacketSummary = typeof finalPacketApi.buildFlightWorkflowFinalSafeHandoffPacket === "function" ? finalPacketApi.buildFlightWorkflowFinalSafeHandoffPacket(Object.assign({ topCandidates:dryRunTopCandidates, selectedCandidate:selectedCandidate, sessionSummary:sessionSummary, routeSummary:normalized.origin + " → " + normalized.destination, departureDate:normalized.departureDate, auditReviewSummary:workflowAuditReviewSummary, humanReviewChecklistSummary:humanReviewChecklistSummary }, workflowMeta)) : null;
    const handoffPacketPolicyDecision = typeof packetPolicyApi.evaluateFlightWorkflowHandoffPacketPolicy === "function" ? packetPolicyApi.evaluateFlightWorkflowHandoffPacketPolicy({ finalSafeHandoffPacketSummary:finalSafeHandoffPacketSummary }) : null;
