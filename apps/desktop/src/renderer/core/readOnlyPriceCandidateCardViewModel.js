;(function () {
  ...
  const READ_ONLY_PRICE_CANDIDATE_CARD_VIEW_MODEL_VERSION = "4.2.2";
  ...
  function buildReadOnlyPriceCandidateCardViewModel(input) {
    ...
    const offlineIssueTriageBoardStatus = text(offlineIssueTriageBoardSummary && offlineIssueTriageBoardSummary.status || "");
    ...
    return clone({
      ...
      offlineIssueTriageBoardStatus:offlineIssueTriageBoardStatus,
