;(function () {
  ...
  const READ_ONLY_PRICE_CANDIDATE_CARD_VIEW_MODEL_VERSION = "2.1.82";
  ...
  function buildReadOnlyPriceCandidateCardViewModel(input) {
    ...
    workflowMeta = Object.assign({}, workflowMeta, { rolloutControlSummary:rolloutControlSummary, cohortHealthSummary:cohortHealthSummary, pilotOpsSummary:pilotOpsSummary, nextCohortDecisionSummary:nextCohortDecisionSummary, pilotOpsViewModel:pilotOpsViewModel, pilotOpsStatus:pilotOpsStatus, nextCohortDecisionStatus:nextCohortDecisionStatus, pilotOpsPrimaryRisk:pilotOpsPrimaryRisk, rolloutControlViewModel:rolloutControlViewModel, rolloutDecisionStatus:rolloutDecisionStatus, cohortHealthStatus:cohortHealthStatus, rolloutNextStep:rolloutNextStep });
