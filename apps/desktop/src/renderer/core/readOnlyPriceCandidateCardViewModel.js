;(function () {
  ...
  const READ_ONLY_PRICE_CANDIDATE_CARD_VIEW_MODEL_VERSION = "2.1.93";
  ...
  function buildReadOnlyPriceCandidateCardViewModel(input) {
    ...
    const compactOperatorConsoleSummary = compactSummary(operatorConsoleSummary, ["status", "userFacingSummary", "globalShoppingProductGoalSummary", "jumpToPlatformBoundarySummary", "legalProviderFixtureSummary", "providerCredentialSafetySummary", "sandboxPriceFeedSummary", "providerFixtureViewModelSummary", "sameItemMatcherSummary", "duplicateCandidateMergerSummary", "coveredLowestCandidateBoardSummary", "externalDeepLinkSafetySummary", "searchParameterPrefillSummary", "jumpToPlatformHandoffPreviewSummary", "sandboxDeepLinkCandidateSummary", "platformAvailabilitySummary", "partnerLinkPolicySummary", "sandboxHandoffViewModelSummary", "sameItemMatcherStatus", "duplicateMergeStatus", "coveredLowestStatus", "legalProviderFixtureStatus", "providerCredentialSafetyStatus", "sandboxPriceFeedStatus", "externalDeepLinkSafetyStatus", "searchPrefillStatus", "handoffPreviewStatus", "sandboxDeepLinkStatus", "platformAvailabilityStatus", "partnerLinkPolicyStatus", "sandboxHandoffStatus", "safeToProceedWithReadOnlyPriceProviderSandbox", "safeToProceedWithDeepLinkSafetyGate", "safeToProceedWithSandboxDeepLinkCandidate", "safeToProceedWithPartnerFixtureAdapter"]);
