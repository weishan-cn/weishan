;(function () {
  ...
  const READ_ONLY_PRICE_CANDIDATE_CARD_VIEW_MODEL_VERSION = "2.1.79";
  ...
  function buildReadOnlyPriceCandidateCardViewModel(input) {
    ...
    workflowMeta = Object.assign({}, workflowMeta, { pilotInvitationGateSummary:pilotInvitationGateSummary, testerCohortEnrollmentConsoleSummary:testerCohortEnrollmentConsoleSummary, pilotInvitationViewModelSummary:pilotInvitationViewModelSummary, pilotInvitationStatus:pilotInvitationStatus, testerCohortStatus:testerCohortStatus, pilotInvitationNextStep:pilotInvitationNextStep });
    ...
    return clone({
      ...
      sandboxImportSummary: { supported:true, lastPreviewStatus:sandboxImportPreviewStatus, lastImportStatus:sandboxImportStatus, importedEvidenceAvailable:isSandboxImportEvidence === true, rawResponseStored:false, sanitized:true, redacted:true, showableAsRealPrice:false, canReplace:false, bookingUrl:null, checkoutUrl:null, paymentUrl:null, orderUrl:null, autoOpen:false, payment:false, order:false, identityUpload:false, dryRunStatus:dryRunStatus, providerRunMatrix:sandboxDryRunSummary && sandboxDryRunSummary.providerRunMatrix || null, runTimelineSummary:runTimelineSummary, sandboxDryRunSummary:sandboxDryRunSummary, dryRunTopCandidates:dryRunTopCandidates, runHistorySummary:runHistorySummary, quoteDeltaSummary:quoteDeltaSummary, replaySummary:replaySummary, sessionSummary:sessionSummary, sessionStatus:sessionStatus, sessionId:sessionId, auditExportPreview:auditExportPreview, auditExportReady:auditExportReady, sessionRecoverySummary:sessionRecoverySummary, reportCenterSummary:reportCenterSummary, userFacingEvidenceSummary:userFacingEvidenceSummary, safetyReportSummary:safetyReportSummary, evidenceSummaryWarnings:evidenceSummaryWarnings, selectedCandidateUserSummary:selectedCandidateUserSummary, decisionAssistantSummary:decisionAssistantSummary, candidateComparisonSummary:candidateComparisonSummary, recommendationExplanation:recommendationExplanation, decisionSafetyWarnings:decisionSafetyWarnings, candidateComparisonTable:candidateComparisonTable, providerConfirmationWarning:providerConfirmationWarning, auditReviewSummary:workflowAuditReviewSummary, safeSessionExportPreview:safeSessionExportPreview, riskBadgeSummary:riskBadgeSummary, humanReviewChecklistSummary:humanReviewChecklistSummary, finalSafeHandoffPacketSummary:finalSafeHandoffPacketSummary, handoffPacketPolicyDecision:handoffPacketPolicyDecision, finalReviewStatus:finalReviewStatus, finalReviewBadges:finalReviewBadges, safetyRegressionSummary:safetyRegressionSummary, operatorConsoleSummary:operatorConsoleSummary, operatorConsoleViewModel:operatorConsoleViewModel, releaseReadinessSummary:releaseReadinessSummary, userSafetyCopySummary:userSafetyCopySummary, forbiddenCapabilitySummary:forbiddenCapabilitySummary, userFacingBetaReadiness:userFacingBetaReadiness, copyValidationStatus:copyValidationStatus, betaExpansionGateSummary:betaExpansionGateSummary, publicPilotChecklistSummary:publicPilotChecklistSummary, pilotReadinessSummary:pilotReadinessSummary, safeForSmallPublicPilot:safeForSmallPublicPilot, pilotNextStep:pilotNextStep, pilotOnboardingSummary:pilotOnboardingSummary, readOnlyConsentSummary:readOnlyConsentSummary, pilotOnboardingViewModel:pilotOnboardingViewModel, pilotEntryStatus:pilotEntryStatus, canEnterReadOnlyPilot:canEnterReadOnlyPilot, pilotConsentRequired:pilotConsentRequired, pilotSupportSummary:pilotSupportSummary, issueIntakeSummary:issueIntakeSummary, supportFallbackSummary:supportFallbackSummary, pilotSupportStatus:pilotSupportStatus, supportNextStep:supportNextStep, issueReviewSummary:issueReviewSummary, supportTriageSummary:supportTriageSummary, pilotIssueReviewSummary:pilotIssueReviewSummary, pilotIssueReviewStatus:pilotIssueReviewStatus, issueAffectsPilotExpansion:issueAffectsPilotExpansion, issueRequiresInternalReview:issueRequiresInternalReview, issuePatternSummary:issuePatternSummary, supportReadinessSummary:supportReadinessSummary, issuePatternViewModelSummary:issuePatternViewModelSummary, issuePatternStatus:issuePatternStatus, supportReadinessStatus:supportReadinessStatus, supportReadyForPublicPilot:supportReadyForPublicPilot, repeatedIssueRisk:repeatedIssueRisk, handoffChecklistSummary:handoffChecklist, handoffReceiptSummary:handoffReceipt, manualPlatformCheckSummary:manualPlatformCheck, platformCheckDeltaSummary:platformCheckDeltaSummary, platformCheckDelta:platformCheckDelta, reconciliationSummary:reconciliationSummary, confidenceLabelSummary:confidenceLabelSummary, safeNextStepSummary:safeNextStepSummary, platformCheckOutcomeSummary:platformCheckOutcomeSummary, continuitySummary:continuitySummary, confirmationStateSummary:confirmationStateSummary, recoverySummary:recoverySummary, resumeCoachSummary:resumeCoachSummary, currentStage:workflowMeta.currentStage, workflowStageLabel:workflowMeta.workflowStageLabel, nextStepLabel:workflowMeta.nextStepLabel, canResumeWorkflow:workflowMeta.canResumeWorkflow, resumeActions:resumeActions, actionQueueSummary:actionQueueSummary, progressTimelineSummary:progressTimelineSummary, safeResumeCenterSummary:safeResumeCenterSummary, blockedActions:blockedActions, nextSafeAction:workflowMeta.nextSafeAction, platformCheckWarnings:platformCheckDeltaSummary && platformCheckDeltaSummary.warnings || ["平台最终为准"], actionExecutionResult:actionExecutionResult, actionPolicyDecision:actionPolicyDecision, eventLedgerSummary:eventLedgerSummary, lastActionId:lastActionId, lastActionStatus:lastActionStatus, lastActionMessage:lastActionMessage, reportCenterStatus:reportCenterStatus, lastRunId:lastRunId, compareStatus:compareStatus, replayStatus:replayStatus },
