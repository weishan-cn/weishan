;(function () {
  ...
  const READ_ONLY_PRICE_CANDIDATE_CARD_VIEW_MODEL_VERSION = "2.1.88";
  ...
  function assertReadOnlyPriceCandidateCardViewModelSafe(value) {
    ...
    const serial = JSON.stringify(card).replace(/(禁止|阻断|已阻断)全网最低承诺/g, "");
