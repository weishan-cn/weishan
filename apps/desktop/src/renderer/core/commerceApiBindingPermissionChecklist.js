;(function () {
  ...
  function buildApiBindingPermissionChecklistDisplay() {
    ...
    return clone({
      ...
      providerEndpointAllowlistGateLine: "provider endpoint allowlist 闸门已建立，只读 provider sandbox gate：已建立，等待只读 provider result schema gate，不能提交绑定确认",
