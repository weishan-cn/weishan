;(function () {
  ...
  const FLIGHT_WORKFLOW_BETA_EXPANSION_GATE_VERSION = "2.1.77";
  ...
  function evaluateFlightWorkflowBetaExpansionDecision(input) {
    ...
    else if (supportReadiness.status === "needs_review" || issuePattern.status === "needs_review") { status = "needs_review"; decisionId = "pause_expansion"; label = "需要暂停扩大测试"; message = "问题趋势或支持准备仍需复核，暂不扩大只读测试。"; }
