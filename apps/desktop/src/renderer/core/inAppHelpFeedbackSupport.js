;(function(){
  ...
  function buildHelpFeedbackViewModel(input){
    ...
    return clone({
      ...
      diagnosticDisclosureZh:"可选包含基本诊断信息：版本、平台、语言、当前模块、安全错误类别和构建类型。不包含搜索原文、邮件内容、已保存密钥、完整 URL、日志或截图。",
      diagnosticDisclosureEn:"Optionally include basic diagnostics: version, platform, language, current module, safe error class, and build type. This excludes raw queries, Mail content, saved keys, full URLs, logs, and screenshots.",
