;(function () {
  ...
  function buildApiBindingMockFormDisplay() {
    ...
    return clone({
      ...
      keyRedactionAndLogLeakRulesLine: "密钥脱敏与日志防泄露规则已建立，key 删除 / 轮换 / 过期机制草案已建立，但 provider endpoint allowlist 闸门已建立，等待只读 provider sandbox gate，表单仍不可用",
