(function(){
  const LOCAL_SAFETY_EVIDENCE_CONSOLE_VERSION = "2.2.0";

  const releaseEvidenceDraft = {
    appVersion:"2.2.0",
    expectedGitTag:"v2.2.0",
    expectedCommit:"local HEAD after v2.2.0 commit",
    releasePostcheckState:"local only",
    workingTreeState:"clean required",
    distAppVersion:"2.2.0",
    applicationsAppVersion:"2.2.0",
