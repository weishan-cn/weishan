(function(){
  const LOCAL_SAFETY_EVIDENCE_CONSOLE_VERSION = "2.1.16";

  const releaseEvidenceDraft = {
    appVersion:"2.1.16",
    expectedGitTag:"v2.1.16",
    expectedCommit:"local HEAD after v2.1.16 commit",
    releasePostcheckState:"local only",
    workingTreeState:"clean required",
    distAppVersion:"2.1.16",
    applicationsAppVersion:"2.1.16",
