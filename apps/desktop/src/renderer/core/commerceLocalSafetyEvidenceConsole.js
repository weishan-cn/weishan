(function(){
  const LOCAL_SAFETY_EVIDENCE_CONSOLE_VERSION = "2.1.75";

  const releaseEvidenceDraft = {
    appVersion:"2.1.75",
    expectedGitTag:"v2.1.75",
    expectedCommit:"local HEAD after v2.1.75 commit",
    releasePostcheckState:"local only",
    workingTreeState:"clean required",
    distAppVersion:"2.1.75",
    applicationsAppVersion:"2.1.75",
