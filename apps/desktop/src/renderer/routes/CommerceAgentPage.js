(function(){
  ...
  function commerceFlightWorkflowPanelHtml(task){
    ...
    function rolloutControlHtml(){
      return '<section class="commerce-flight-rollout-control" data-commerce-flight-rollout-control="true"><h5>只读试点发布控制中心</h5><p>测试批次健康看板</p><p>发布控制</p><p>批次健康</p><p>问题风险</p><p>下一步</p><p>可以进入下一批只读测试</p><p>继续当前小范围试点</p><p>暂停扩大测试</p><p>批次健康，可以继续</p><p>批次进行中</p><p>批次需要复核</p><p>该页面只管理只读试点流程</p><p>不保存真实身份、不发送真实邀请、不提供交易能力</p><button type="button" class="cmd-btn gray" data-commerce-flight-rollout-control-show="true">查看发布控制</button><button type="button" class="cmd-btn gray" data-commerce-flight-cohort-health-show="true">查看批次健康</button><div data-commerce-flight-rollout-control-output="true"><p>只读试点发布控制中心</p><p>可以进入下一批只读测试</p><p>继续当前小范围试点</p><p>暂停扩大测试</p><p>需要内部复核</p><p>已阻断</p><p>该页面只管理只读试点流程</p></div><div data-commerce-flight-cohort-health-output="true"><p>测试批次健康看板</p><p>批次健康，可以继续</p><p>批次进行中</p><p>批次需要复核</p><p>批次已阻断</p><p>不保存真实身份、不发送真实邀请、不提供交易能力</p></div><section class="commerce-flight-pilot-ops" data-commerce-flight-pilot-ops="true"><h5>只读试点运营摘要</h5><p>运营状态</p><p>下一批决策</p><p>主要风险</p><p>支持准备</p><p>试点运行健康</p><p>继续当前批次</p><p>暂停扩大测试</p><p>需要复核</p><p>可以进入下一批只读测试</p><p>该页面只用于只读试点运营判断</p><p>不保存真实身份、不发送真实邀请、不提供交易能力</p><button type="button" class="cmd-btn gray" data-commerce-flight-pilot-ops-summary-show="true">查看试点运营摘要</button><button type="button" class="cmd-btn gray" data-commerce-flight-next-cohort-decision-show="true">查看下一批决策</button><div data-commerce-flight-pilot-ops-summary-output="true"><p>只读试点运营摘要</p><p>运营状态</p><p>主要风险</p><p>支持准备</p><p>试点运行健康</p><p>继续当前批次</p><p>暂无主要风险</p><p>支持准备</p></div><div data-commerce-flight-next-cohort-decision-output="true"><p>下一批只读测试决策板</p><p>下一批决策</p><p>可以进入下一批只读测试</p><p>继续当前批次</p><p>暂停扩大测试</p><p>需要内部复核</p><p>已阻断</p><p>该决策只适用于只读试点节奏，不代表真实账号、邀请、交易或出票能力</p></div></section></section>';
    }
