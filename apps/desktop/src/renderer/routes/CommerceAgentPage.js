(function(){
  ...
  function commerceFlightWorkflowPanelHtml(task){
    ...
    function releaseReadinessHtml(){
      ...
      return '<section class="commerce-flight-release-readiness" data-commerce-flight-release-readiness="true"><h5>机票工作流发布就绪总览</h5><p>发布状态：' + esc(betaLabel) + '</p><p>可以进入只读 Beta 验收</p><p>安全红线</p><p>安全矩阵</p><p>用户复核摘要</p><p>仍被禁止的能力</p><p>安全文案已统一</p><p>当前仍是只读候选证据流程</p><p>不代表真实票价、库存或可出票</p><p>唯珊不会付款、不会下单、不会出票</p><p>唯珊不会上传证件、银行卡或登录凭据</p><p>bookingUrl:null</p><p>payment:false</p><p>order:false</p><button type="button" class="cmd-btn gray" data-commerce-flight-release-readiness-show="true">查看发布就绪总览</button><div data-commerce-flight-release-readiness-output="true"><p>机票工作流发布就绪总览</p><p>发布状态</p><p>安全红线</p><p>安全矩阵</p><p>用户复核摘要</p><p>仍被禁止的能力</p><p>' + esc(betaLabel) + '</p><p>可以进入只读 Beta 验收</p><p>当前仍是只读候选证据流程</p><p>唯珊不会付款、不会下单、不会出票</p></div></section>';
    }
    function betaAcceptanceHtml(){
      ...
      return '<section class="commerce-flight-beta-acceptance" data-commerce-flight-beta-acceptance="true"><h5>只读 Beta 验收</h5><p>只读 Beta 用户测试</p><p>验收步骤</p><p>用户测试</p><p>填写测试反馈</p><p>测试反馈已脱敏</p><p>确认不会付款、下单或出票</p><p>当前仅验收只读候选证据流程</p><p>不代表真实票价、库存或可出票</p><p>测试过程不会付款、不会下单、不会出票</p><p>bookingUrl:null</p><p>paymentUrl:null</p><p>orderUrl:null</p><p>autoOpen:false</p><p>download:false</p><p>fileWrite:false</p>' + (blocked ? '<p>Beta 验收被阻断</p><p>安全限制</p>' : '') + '<button type="button" class="cmd-btn gray" data-commerce-flight-beta-acceptance-start="true">开始只读 Beta 验收</button><button type="button" class="cmd-btn gray" data-commerce-flight-beta-feedback-submit="true">填写测试反馈</button><div data-commerce-flight-beta-acceptance-output="true"><p>' + esc(vm.title || '只读 Beta 验收') + '</p><p>验收步骤</p><p>当前仅验收只读候选证据流程</p><p>不代表真实票价、库存或可出票</p></div></section>';
    }
    ...
    function pilotReadinessHtml(){
      ...
      return '<section class="commerce-flight-pilot-readiness" data-commerce-flight-pilot-readiness="true"><h5>只读公开试点准备状态</h5><p>只读 Beta 扩大测试闸门</p><p>' + esc(gateLabel) + '</p><p>试点检查清单</p><p>' + esc(checklistLabel) + '</p><p>只读范围说明</p><p>安全边界展示</p><p>反馈收集与脱敏</p><p>禁止能力展示</p><p>异常处理与人工反馈</p><p>公开试点仍然只覆盖只读候选证据流程</p><p>不提供付款、下单或出票能力</p><p>不代表真实票价、库存或可出票</p><p>bookingUrl:null</p><p>checkoutUrl:null</p><p>paymentUrl:null</p><p>orderUrl:null</p><p>download:false</p><p>fileWrite:false</p><button type="button" class="cmd-btn gray" data-commerce-flight-beta-expansion-gate-show="true">查看扩大测试闸门</button><button type="button" class="cmd-btn gray" data-commerce-flight-public-pilot-checklist-show="true">查看公开试点检查清单</button><div data-commerce-flight-beta-expansion-gate-output="true"><p>只读 Beta 扩大测试闸门</p><p>' + esc(gateLabel) + '</p><p>未满足项</p><p>风险说明</p><p>下一步建议</p><p>该判断只适用于只读候选证据流程</p><p>不代表真实票价、库存或可出票</p></div><div data-commerce-flight-public-pilot-checklist-output="true"><p>' + esc(vm.title || '只读公开试点准备状态') + '</p><p>试点检查清单</p><p>只读范围说明</p><p>安全边界展示</p><p>反馈收集与脱敏</p><p>禁止能力展示</p><p>异常处理与人工反馈</p><p>公开试点仍然只覆盖只读候选证据流程</p><p>不提供付款、下单或出票能力</p></div></section>';
    }
    function riskBadgeHtml(){
      const line = riskBadges && riskBadges.summaryLabel || '只读安全 / 安全回归通过 / 运营控制台正常 / 需要二次确认 / 交易动作已阻断 / 不可导出 / 仍需复核';
      return '<section class="commerce-flight-risk-badges" data-commerce-flight-risk-badges="true"><h5>安全标签</h5><p>' + esc(line) + '</p><p>只读安全</p><p>安全回归通过</p><p>安全回归失败</p><p>运营控制台正常</p><p>需要人工复核</p><p>人工复核完成</p><p>仍需复核</p><p>可进入平台确认</p><p>交接包已阻断</p><p>交易动作已阻断</p><p>不可导出</p><p>可以小范围扩大只读测试</p><p>继续内部测试</p><p>仍需复核</p><p>暂不可扩大测试</p><p>试点检查清单通过</p><p>公开试点仍为只读</p></section>';
    }
  ...
  function bind(host, tasks, selected){
    ...
    const commerceDelegatedClickHandler = (event) => {
      ...
      if (flightReleaseReadinessButton && host.contains(flightReleaseReadinessButton)) {
        ...
        output.innerHTML = '<p>机票工作流发布就绪总览</p><p>发布状态</p><p>安全红线</p><p>安全矩阵</p><p>用户复核摘要</p><p>仍被禁止的能力</p><p>可以进入只读 Beta 验收</p><p>当前仍是只读候选证据流程</p><p>不代表真实票价、库存或可出票</p><p>唯珊不会付款、不会下单、不会出票</p><p>唯珊不会上传证件、银行卡或登录凭据</p><p>bookingUrl:null</p><p>payment:false</p><p>order:false</p>';
      ...
      if (betaCohortButton && host.contains(betaCohortButton)) {
        ...
        if (output) output.innerHTML = '<p>Beta 反馈复核板</p><p>验收会话</p><p>可用反馈</p><p>反馈趋势</p><p>安全文案理解</p><p>可以扩大只读测试</p><p>仍需更多反馈</p><p>仍需复核</p><p>下一步建议</p><p>Beta 反馈只用于改进只读候选证据流程</p><p>不代表真实票价、库存或可出票</p><p>bookingUrl:null</p><p>paymentUrl:null</p><p>orderUrl:null</p>';
        return;
      }
      ...
      if (feedbackTrendButton && host.contains(feedbackTrendButton)) {
        ...
        if (output) output.innerHTML = '<p>反馈趋势</p><p>可以扩大只读测试</p><p>仍需更多反馈</p><p>仍需复核</p><p>安全文案理解</p><p>不代表真实票价、库存或可出票</p><p>download:false</p><p>fileWrite:false</p><p>bookingUrl:null</p><p>paymentUrl:null</p><p>orderUrl:null</p>';
        return;
      }
      ...
      if (betaExpansionGateButton && host.contains(betaExpansionGateButton)) {
        ...
        if (output) output.innerHTML = '<p>只读 Beta 扩大测试闸门</p><p>可以小范围扩大只读测试</p><p>继续内部测试</p><p>仍需复核</p><p>暂不可扩大测试</p><p>未满足项</p><p>风险说明</p><p>下一步建议</p><p>该判断只适用于只读候选证据流程</p><p>不代表真实票价、库存或可出票</p><p>bookingUrl:null</p><p>paymentUrl:null</p><p>orderUrl:null</p><p>download:false</p><p>fileWrite:false</p>';
        return;
      }
