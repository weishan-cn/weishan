  ...
  function bind(host, tasks, selected){
    ...
    const commerceDelegatedClickHandler = (event) => {
      ...
      if (globalShoppingPublicBetaButton && host.contains(globalShoppingPublicBetaButton)) {
        ...
        output.innerHTML = '<p>全球购 Public Beta</p><p>全球购 Public Beta 已准备</p><p>只读候选价</p><p>候选价证据</p><p>来源与时间</p><p>可信度</p><p>风险说明</p><p>官方价锚点</p><p>与官方价对比</p><p>费用归一化</p><p>含税/不含税</p><p>含运费/不含运费</p><p>服务费说明</p><p>归一化价格仅用于辅助比较</p><p>不代表真实最终价</p><p>以平台实时页面为准</p><p>当前仍为只读候选证据</p><p>当前不提供付款、下单或出票能力</p><p>bookingUrl:null</p><p>payment:false</p><p>order:false</p><p>download:false</p><p>fileWrite:false</p>';
