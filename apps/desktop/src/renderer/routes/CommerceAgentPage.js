(function(){
  ...
  function commerceFlightWorkflowPanelHtml(task){
    ...
    function pilotSupportHtml(){
      return '<section class="commerce-flight-pilot-support" data-commerce-flight-pilot-support="true"><h5>只读试点问题反馈</h5><p>问题类型</p><p>建议处理</p><p>看不懂候选证据</p><p>平台页面与候选证据不一致</p><p>安全说明不清楚</p><p>只读范围确认无法完成</p><p>反馈填写异常</p><p>问题反馈已脱敏</p><p>问题反馈只用于改进只读候选证据流程</p><p>不代表客服工单、交易请求或出票请求</p><p>建议重新查看候选证据</p><p>建议记录平台核对结果</p><p>建议查看安全说明</p><p>建议重新确认只读范围</p><h5>只读试点问题复核</h5><p>问题分流面板</p><p>问题状态</p><p>分流建议</p><p>试点影响</p><p>问题可用于改进参考</p><p>需要内部复核</p><p>问题影响试点扩大</p><p>已有建议处理路径</p><p>问题复核只用于改进只读候选证据流程</p><p>不会提交客服工单或交易请求</p><h5>只读试点状态快照</h5><p>试点状态</p><p>支持处理手册</p><p>下一步</p><p>支持处理路径已准备</p><p>支持处理仍需复核</p><p>支持处理已阻断</p><p>只读试点状态快照</p><p>只读试点支持处理手册</p><p>只读试点视图模型</p><h5>试点问题趋势雷达</h5><p>试点支持准备闸门</p><p>问题数量</p><p>主要问题趋势</p><p>支持准备</p><p>暂无明显共性问题</p><p>发现需要关注的问题趋势</p><p>支持兜底准备就绪</p><p>继续小范围试点</p><p>需要复核后再扩大</p><p>问题趋势仅用于改进只读候选证据流程</p><p>不代表客服工单、交易请求或出票请求</p><p>bookingUrl:null</p><p>paymentUrl:null</p><p>orderUrl:null</p><p>download:false</p><p>fileWrite:false</p><button type="button" class="cmd-btn gray" data-commerce-flight-pilot-support-show="true">查看问题反馈</button><button type="button" class="cmd-btn gray" data-commerce-flight-issue-review-show="true">查看问题复核</button><button type="button" class="cmd-btn gray" data-commerce-flight-pilot-snapshot-show="true">查看状态快照</button><button type="button" class="cmd-btn gray" data-commerce-flight-support-playbook-show="true">查看支持手册</button><button type="button" class="cmd-btn gray" data-commerce-flight-pilot-snapshot-view-model-show="true">查看试点视图模型</button><button type="button" class="cmd-btn gray" data-commerce-flight-support-triage-show="true">查看问题分流</button><button type="button" class="cmd-btn gray" data-commerce-flight-issue-pattern-show="true">查看问题趋势</button><button type="button" class="cmd-btn gray" data-commerce-flight-support-readiness-show="true">查看支持准备</button><button type="button" class="cmd-btn gray" data-commerce-flight-issue-category="candidate_unclear">看不懂候选证据</button><button type="button" class="cmd-btn gray" data-commerce-flight-issue-category="platform_mismatch">平台页面与候选证据不一致</button><button type="button" class="cmd-btn gray" data-commerce-flight-issue-category="safety_copy_unclear">安全说明不清楚</button><button type="button" class="cmd-btn gray" data-commerce-flight-issue-category="consent_blocked">只读范围确认无法完成</button><div data-commerce-flight-pilot-support-output="true"><p>只读试点问题反馈</p><p>问题反馈已脱敏</p><p>建议重新查看候选证据</p></div><div data-commerce-flight-issue-review-output="true"><p>只读试点问题复核</p><p>问题状态</p><p>问题可用于改进参考</p><p>问题复核只用于改进只读候选证据流程</p></div><div data-commerce-flight-pilot-snapshot-output="true"><p>只读试点状态快照</p><p>试点状态</p><p>支持处理手册</p><p>下一步</p><p>支持处理路径已准备</p><p>支持处理仍需复核</p><p>支持处理已阻断</p></div><div data-commerce-flight-support-playbook-output="true"><p>只读试点支持处理手册</p><p>问题分流面板</p><p>支持处理路径已准备</p><p>支持处理仍需复核</p><p>支持处理已阻断</p></div><div data-commerce-flight-pilot-snapshot-view-model-output="true"><p>只读试点视图模型</p><p>试点状态</p><p>支持准备</p><p>问题趋势</p><p>下一步</p></div><div data-commerce-flight-support-triage-output="true"><p>问题分流面板</p><p>分流建议</p><p>已有建议处理路径</p><p>不会提交客服工单或交易请求</p></div><div data-commerce-flight-issue-pattern-output="true"><p>试点问题趋势雷达</p><p>问题数量</p><p>主要问题趋势</p><p>暂无明显共性问题</p><p>问题趋势仅用于改进只读候选证据流程</p></div><div data-commerce-flight-support-readiness-output="true"><p>试点支持准备闸门</p><p>支持准备</p><p>支持兜底准备就绪</p><p>不代表客服工单、交易请求或出票请求</p></div></section>';
    }
