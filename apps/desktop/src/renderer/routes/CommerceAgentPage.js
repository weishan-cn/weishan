(function(){
  ...
  function commerceCleanResultSurfaceHtml(task, opts){
    ...
    const userEvidenceSummaryHtml = '<section class="commerce-read-only-user-evidence-summary" data-commerce-read-only-user-evidence-summary="true"><h5>候选报价证据摘要</h5><p>只读候选价 · 平台最终为准</p><p>当前导入样本 / 沙盒运行中的候选价格</p><p>Top 3 候选报价</p><p>未锁价</p><p>不代表可出票</p><p>唯珊不会付款、不会下单、不会上传证件或银行卡</p></section>';
    const cards = surface.cards || [];
