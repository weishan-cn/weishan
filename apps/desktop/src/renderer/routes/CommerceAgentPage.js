  ...
  function bind(host, tasks, selected){
    ...
    const commerceDelegatedClickHandler = (event) => {
      ...
      if (globalShoppingPublicBetaButton && host.contains(globalShoppingPublicBetaButton)) {
        ...
        output.innerHTML = '<p>全球购 Public Beta</p><p>全球购 Public Beta 已准备</p><p>Public Beta User Journey</p><p>Safe Search Intent Matrix</p><p>User Boundary Panel</p><p>Category Result Simulator</p><p>Read-Only Comparison Board</p><p>Result Trust Badge</p><p>Public Beta Operator Console</p><p>Category Expansion Shell</p><p>Final Offline Beta Audit</p><p>Public Beta Acceptance Board</p><p>Manual Review Required</p><p>Public Beta Visual QA Console</p><p>Trial Scenario Checklist</p><p>No-Transaction Regression Guard</p><p>Visual Acceptance</p><p>Scenario Coverage</p><p>Transaction Boundary</p><p>Flight / Hotel / Product / Restricted 场景已覆盖</p><p>交易按钮保持关闭</p><p>未生成 booking / payment / order / checkout URL</p><p>未打开外部平台</p><p>仍需人工视觉验收</p><p>Flight / Hotel / Product 只读外壳已准备</p><p>Provider-Zero 状态通过</p><p>候选价证据通过</p><p>费用归一化通过</p><p>官方价锚点通过</p><p>安全文案通过</p><p>最终离线审计通过</p><p>仍需人工复核后再决定是否进入下一阶段</p><p>Flight 候选结果</p><p>Hotel 候选结果</p><p>Product 候选结果</p><p>只读对比</p><p>费用已归一化</p><p>已与官方价锚点对比</p><p>Provider-Zero</p><p>需要人工复核</p><p>不代表真实最低价</p><p>不代表最终成交价</p><p>只读搜索计划</p><p>候选价整理</p><p>费用归一化步骤</p><p>官方价锚点步骤</p><p>用户边界确认</p><p>只读候选价</p><p>候选价证据</p><p>来源与时间</p><p>可信度</p><p>风险说明</p><p>官方价锚点</p><p>与官方价对比</p><p>费用归一化</p><p>含税/不含税</p><p>含运费/不含运费</p><p>服务费说明</p><p>归一化价格仅用于辅助比较</p><p>以平台实时页面为准</p><p>当前仍为只读候选证据</p><p>当前不提供付款、下单或出票能力</p><p>不保存账号、证件或支付信息</p><p>用户需在对应平台自行完成下单</p><p>bookingUrl:null</p><p>payment:false</p><p>order:false</p><p>release:false</p><p>push:false</p><p>download:false</p><p>fileWrite:false</p>';
