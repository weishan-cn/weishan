(function(){
  ...
  function bind(host){
    ...
    Array.from(host.querySelectorAll("[data-commerce-copy-kind]")).forEach((button) => {
    ...
    Array.from(host.querySelectorAll("[data-commerce-template-kind]")).forEach((button) => {
      button.addEventListener("click", function(){
