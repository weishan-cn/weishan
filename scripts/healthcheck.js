...
function checkMarkers() {
  return [
    ...
    marker("apps/desktop/src/renderer/core/commerceLocationPolicy.js", /"off"[\s\S]*"not_requested"/, "marker:commerce gps default off", true),
    marker("apps/desktop/src/renderer/core/commerceLocationPolicy.js", /locationRequiredForAccuratePrice:true|location_required_for_accurate_landed_cost/, "marker:commerce location required for accurate landed cost", true),
    marker("apps/desktop/src/renderer/core/commerceSearch.js", /COMMERCE_LOCATION_REQUIRED|location_required/, "marker:commerce location blocks accurate price", true),
    marker("apps/desktop/src/renderer/core/commerceSearch.js", /canShowBookingButton:false|canShowCheckoutButton:false|locationHealth/, "marker:commerce location blocks redirect before permission", true),
    ...
    marker("apps/desktop/src/renderer/core/commerceLocationPolicy.js", /为了精准计算最低到手价并遵守当地法律|不会保存原始位置/, "marker:commerce location privacy notice", true),
    marker("apps/desktop/src/renderer/routes/SettingsPage.js", /定位权限|永远允许|使用 App 时允许|关闭/, "marker:commerce location settings options", true),
    ...
    marker("apps/desktop/src/renderer/core/commerceProductProviderSelection.js", /getProductProviderSelection|first_real_readonly_provider_candidate|selection_ready_not_connected/, "marker:commerce product provider selection", true),
