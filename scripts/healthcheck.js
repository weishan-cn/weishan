...
function checkPackageScripts() {
  ...
  return ["check", "dev:desktop", "healthcheck", "secrets:scan", "version:check", "test:api", "test:e2e", "test:e2e:smoke", "test:e2e:repair", "test:e2e:dispatch", "test:e2e:desktop-assistant", "test:e2e:cloud"].map((script) => {
