...
function checkMarkers() {
  return [
    ...
    marker("apps/desktop/src/renderer/routes/HomePage.js", /data-home-model-selector|homeModelSelect|模型选择/, "marker:home model selector", true),
    marker("apps/desktop/src/renderer/core/dispatchRouter.js", /buildLocalAnswer|chat\.answered|mock-safe 回答/, "marker:home chat answer mock safe", true),
    ...
    marker("apps/desktop/src/renderer/modules/command/commandApi.js", /chat\.answered|recordHomeDispatchAction/, "marker:chat answer history", true),
    marker("apps/desktop/src/renderer/core/dispatchRouter.js", /未调用真实模型|realExecution=false/, "marker:no real ai call in home chat", true),
