...
function checkMarkers() {
  return [
    ...
    marker("apps/desktop/src/renderer/core/commerceSearch.js", /priceA - priceB|slice\(0, 3\)|totalPrice/s, "marker:commerce cheapest result sorted by totalPrice", true),
    ...
    marker("apps/desktop/src/renderer/routes/CommerceAgentPage.js", /不自动支付/, "marker:commerce no auto payment", true),
    marker("apps/desktop/src/renderer/routes/CommerceAgentPage.js", /不保存证件或银行卡/, "marker:commerce no identity storage", true),
    ...
    marker("apps/desktop/src/renderer/routes/CommerceAgentPage.js", /最低价推荐|去预订|去购买|查看详情/, "marker:commerce provider result buttons", true),
