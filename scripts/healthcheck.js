...
function checkMarkers() {
  return [
    ...
    marker("apps/desktop/src/renderer/core/commerceSearch.js", /validateBookingUrl|parsed\.protocol === "https:"/, "marker:commerce booking url https only", true),
    ...
    marker("apps/desktop/src/renderer/routes/HomePage.js", /机票搜索源未配置，暂不能返回真实价格|conditionSummary/, "marker:commerce no ai hijack booking intent", true),
    ...
    marker("apps/desktop/src/renderer/routes/CommerceAgentPage.js", /搜索源未配置，无法返回真实价格|COMMERCE_PROVIDER_NOT_CONFIGURED/, "marker:commerce search source missing state", true),
    ...
    marker("apps/desktop/src/renderer/routes/HomePage.js", /全球采购计划已生成|data-commerce-home-summary/, "marker:commerce agent home summary", true),
    ...
    marker("apps/desktop/src/renderer/modules/command/commandApi.js", /commerceStatus|已写入全球采购任务列表/, "marker:commerce agent compact dispatch record", true),
