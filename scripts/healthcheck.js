...
function checkMarkers() {
  return [
    ...
    marker("apps/desktop/src/renderer/routes/HomePage.js", /结果摘要|commerce-result-summary-panel|草稿已补齐，等待确认/, "marker:result summary on home", true),
    marker("apps/desktop/src/renderer/routes/CommerceAgentPage.js", /结果摘要|commerce-result-summary-panel|草稿已补齐，等待确认/, "marker:result summary on detail", true),
    marker("docs/WEISHAN_GLOBAL_COMMERCE_STANDARD.md", /Result Summary|结果摘要|草稿已补齐，等待确认/, "marker:result summary standard", true),
    marker("tests/e2e/commerce-agent.spec.js", /v2\.0\.63[\s\S]*结果摘要[\s\S]*草稿已补齐，等待确认/, "marker:result summary e2e", true),
