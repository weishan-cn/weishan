...
function checkMarkers() {
  return [
    ...
    marker("tests/e2e/commerce-agent.spec.js", /not\.toContainText\("provider_sandbox_dry_run_required"\)|not\.toContainText\("dryRunStatus=not_run"\)/, "marker:provider sandbox dry run no raw field in user ui", true),
